  ...
  <header class="header" :class="{ 'scrolled': isScrolled }">
    <div class="container header-content">
      ...
      <nav class="nav">
        ...
        <div class="social-links" style="background-color: var(--panel-strong);">
...
.header {
  ...
  left: 0;
  right: 0;
  background-color: rgba(7, 16, 13, 0.74);
  backdrop-filter: blur(18px);
  z-index: 1000;
  transition: all 0.3s ease;
  border-bottom: 1px solid rgba(141, 255, 101, 0.1);
}

.header.scrolled {
  background-color: rgba(7, 16, 13, 0.94);
