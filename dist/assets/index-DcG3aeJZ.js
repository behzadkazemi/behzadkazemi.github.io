...
`)+`
`+h);const E=y+g+a,_=y+h+o,A=ku(r,r.VERTEX_SHADER,E),T=ku(r,r.FRAGMENT_SHADER,_);r.attachShader(M,A),r.attachShader(M,T),t.index0AttributeName!==void 0?r.bindAttribLocation(M,0,t.index0AttributeName):t.hasPositionAttribute===!0&&r.bindAttribLocation(M,0,"position"),r.linkProgram(M);function P(I){if(n.debug.checkShaderErrors){const k=r.getProgramInfoLog(M)||"",te=r.getShaderInfoLog(A)||"",se=r.getShaderInfoLog(T)||"",V=k.trim(),J=te.trim(),z=se.trim();let Y=!0,le=!0;if(r.getProgramParameter(M,r.LINK_STATUS)===!1)if(Y=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,M,A,T);else{const _e=Vu(r,A,"vertex"),ve=Vu(r,T,"fragment");at("WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(M,r.VALIDATE_STATUS)+`
...
Program Info Log: `+V+`
`+_e+`
`+ve)}else V!==""?qe("WebGLProgram: Program Info Log:",V):(J===""||z==="")&&(le=!1);le&&(I.diagnostics={runnable:Y,programLog:V,vertexShader:{log:J,prefix:g},fragmentShader:{log:z,prefix:h}})}r.deleteShader(A),r.deleteShader(T),v=new na(r,M),w=zx(r,M)}let v;this.getUniforms=function(){return v===void 0&&P(this),v};let w;this.getAttributes=function(){return w===void 0&&P(this),w};let N=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return N===!1&&(N=r.getProgramParameter(M,Cx)),N},this.destroy=function(){i.releaseStatesOfProgram(this),r.deleteProgram(M),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=Px++,this.cacheKey=e,this.usedTimes=1,this.program=M,this.vertexShader=A,this.fragmentShader=T,this}let tS=0;class nS{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e,t,i){const r=this._getShaderCacheForMaterial(e);return r.has(t)===!1&&(r.add(t),t.usedTimes++),r.has(i)===!1&&(r.add(i),i.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const i of t)i.usedTimes--,i.usedTimes===0&&this.shaderCache.delete(i.code);return this.materialCache.delete(e),this}getVertexShaderStage(e){return this._getShaderStage(e.vertexShader)}getFragmentShaderStage(e){return this._getShaderStage(e.fragmentShader)}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let i=t.get(e);return i===void 0&&(i=new Set,t.set(e,i)),i}_getShaderStage(e){const t=this.shaderCache;let i=t.get(e);return i===void 0&&(i=new iS(e),t.set(e,i)),i}}class iS{constructor(e){this.id=tS++,this.code=e,this.usedTimes=0}}function rS(n){return n===Zi||n===da||n===ha}function sS(n,e,t,i,r,s){const a=new yd,o=new nS,l=new Set,c=[],u=new Map,d=i.logarithmicDepthBuffer;let f=i.precision;const m={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function x(v){return l.add(v),v===0?"uv":`uv${v}`}function M(v,w,N,I,k,te){const se=I.fog,V=k.geometry,J=v.isMeshStandardMaterial||v.isMeshLambertMaterial||v.isMeshPhongMaterial?I.environment:null,z=v.isMeshStandardMaterial||v.isMeshLambertMaterial&&!v.envMap||v.isMeshPhongMaterial&&!v.envMap,Y=e.get(v.envMap||J,z),le=Y&&Y.mapping===La?Y.image.height:null,_e=m[v.type];v.precision!==null&&(f=i.getMaxPrecision(v.precision),f!==v.precision&&qe("WebGLProgram.getParameters:",v.precision,"not supported, using",f,"instead."));const ve=V.morphAttributes.position||V.morphAttributes.normal||V.morphAttributes.color,Ee=ve!==void 0?ve.length:0;let it=0;V.morphAttributes.position!==void 0&&(it=1),V.morphAttributes.normal!==void 0&&(it=2),V.morphAttributes.color!==void 0&&(it=3);let St,rt,ne,me;if(_e){const Ne=Fn[_e];St=Ne.vertexShader,rt=Ne.fragmentShader}else{St=v.vertexShader,rt=v.fragmentShader;const Ne=o.getVertexShaderStage(v),bt=o.getFragmentShaderStage(v);o.update(v,Ne,bt),ne=Ne.id,me=bt.id}const fe=n.getRenderTarget(),We=n.state.buffers.depth.getReversed(),Xe=k.isInstancedMesh===!0,Ve=k.isBatchedMesh===!0,C=!!v.map,D=!!v.matcap,W=!!Y,Q=!!v.aoMap,K=!!v.lightMap,ee=!!v.bumpMap&&v.wireframe===!1,de=!!v.normalMap,ce=!!v.displacementMap,oe=!!v.emissiveMap,j=!!v.metalnessMap,Ce=!!v.roughnessMap,R=v.anisotropy>0,Pe=v.clearcoat>0,be=v.dispersion>0,b=v.iridescence>0,p=v.sheen>0,L=v.transmission>0,B=R&&!!v.anisotropyMap,q=Pe&&!!v.clearcoatMap,ue=Pe&&!!v.clearcoatNormalMap,pe=Pe&&!!v.clearcoatRoughnessMap,Z=b&&!!v.iridescenceMap,ie=b&&!!v.iridescenceThicknessMap,he=p&&!!v.sheenColorMap,De=p&&!!v.sheenRoughnessMap,Se=!!v.specularMap,ge=!!v.specularColorMap,He=!!v.specularIntensityMap,Ge=L&&!!v.transmissionMap,Ze=L&&!!v.thicknessMap,F=!!v.gradientMap,xe=!!v.alphaMap,re=v.alphaTest>0,Me=!!v.alphaHash,we=!!v.extensions;let ae=Hn;v.toneMapped&&(fe===null||fe.isXRRenderTarget===!0)&&(ae=n.toneMapping);const Oe={shaderID:_e,shaderType:v.type,shaderName:v.name,vertexShader:St,fragmentShader:rt,defines:v.defines,customVertexShaderID:ne,customFragmentShaderID:me,isRawShaderMaterial:v.isRawShaderMaterial===!0,glslVersion:v.glslVersion,precision:f,batching:Ve,batchingColor:Ve&&k._colorsTexture!==null,instancing:Xe,instancingColor:Xe&&k.instanceColor!==null,instancingMorph:Xe&&k.morphTexture!==null,outputColorSpace:fe===null?n.outputColorSpace:fe.isXRRenderTarget===!0?fe.texture.colorSpace:et.workingColorSpace,alphaToCoverage:!!v.alphaToCoverage,map:C,matcap:D,envMap:W,envMapMode:W&&Y.mapping,envMapCubeUVHeight:le,aoMap:Q,lightMap:K,bumpMap:ee,normalMap:de,displacementMap:ce,emissiveMap:oe,normalMapObjectSpace:de&&v.normalMapType===Xm,normalMapTangentSpace:de&&v.normalMapType===iu,packedNormalMap:de&&v.normalMapType===iu&&rS(v.normalMap.format),metalnessMap:j,roughnessMap:Ce,anisotropy:R,anisotropyMap:B,clearcoat:Pe,clearcoatMap:q,clearcoatNormalMap:ue,clearcoatRoughnessMap:pe,dispersion:be,iridescence:b,iridescenceMap:Z,iridescenceThicknessMap:ie,sheen:p,sheenColorMap:he,sheenRoughnessMap:De,specularMap:Se,specularColorMap:ge,specularIntensityMap:He,transmission:L,transmissionMap:Ge,thicknessMap:Ze,gradientMap:F,opaque:v.transparent===!1&&v.blending===br&&v.alphaToCoverage===!1,alphaMap:xe,alphaTest:re,alphaHash:Me,combine:v.combine,mapUv:C&&x(v.map.channel),aoMapUv:Q&&x(v.aoMap.channel),lightMapUv:K&&x(v.lightMap.channel),bumpMapUv:ee&&x(v.bumpMap.channel),normalMapUv:de&&x(v.normalMap.channel),displacementMapUv:ce&&x(v.displacementMap.channel),emissiveMapUv:oe&&x(v.emissiveMap.channel),metalnessMapUv:j&&x(v.metalnessMap.channel),roughnessMapUv:Ce&&x(v.roughnessMap.channel),anisotropyMapUv:B&&x(v.anisotropyMap.channel),clearcoatMapUv:q&&x(v.clearcoatMap.channel),clearcoatNormalMapUv:ue&&x(v.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:pe&&x(v.clearcoatRoughnessMap.channel),iridescenceMapUv:Z&&x(v.iridescenceMap.channel),iridescenceThicknessMapUv:ie&&x(v.iridescenceThicknessMap.channel),sheenColorMapUv:he&&x(v.sheenColorMap.channel),sheenRoughnessMapUv:De&&x(v.sheenRoughnessMap.channel),specularMapUv:Se&&x(v.specularMap.channel),specularColorMapUv:ge&&x(v.specularColorMap.channel),specularIntensityMapUv:He&&x(v.specularIntensityMap.channel),transmissionMapUv:Ge&&x(v.transmissionMap.channel),thicknessMapUv:Ze&&x(v.thicknessMap.channel),alphaMapUv:xe&&x(v.alphaMap.channel),vertexTangents:!!V.attributes.tangent&&(de||R),vertexNormals:!!V.attributes.normal,vertexColors:v.vertexColors,vertexAlphas:v.vertexColors===!0&&!!V.attributes.color&&V.attributes.color.itemSize===4,pointsUvs:k.isPoints===!0&&!!V.attributes.uv&&(C||xe),fog:!!se,useFog:v.fog===!0,fogExp2:!!se&&se.isFogExp2,flatShading:v.wireframe===!1&&(v.flatShading===!0||V.attributes.normal===void 0&&de===!1&&(v.isMeshLambertMaterial||v.isMeshPhongMaterial||v.isMeshStandardMaterial||v.isMeshPhysicalMaterial)),sizeAttenuation:v.sizeAttenuation===!0,logarithmicDepthBuffer:d,reversedDepthBuffer:We,skinning:k.isSkinnedMesh===!0,hasPositionAttribute:V.attributes.position!==void 0,morphTargets:V.morphAttributes.position!==void 0,morphNormals:V.morphAttributes.normal!==void 0,morphColors:V.morphAttributes.color!==void 0,morphTargetsCount:Ee,morphTextureStride:it,numDirLights:w.directional.length,numPointLights:w.point.length,numSpotLights:w.spot.length,numSpotLightMaps:w.spotLightMap.length,numRectAreaLights:w.rectArea.length,numHemiLights:w.hemi.length,numDirLightShadows:w.directionalShadowMap.length,numPointLightShadows:w.pointShadowMap.length,numSpotLightShadows:w.spotShadowMap.length,numSpotLightShadowsWithMaps:w.numSpotLightShadowsWithMaps,numLightProbes:w.numLightProbes,numLightProbeGrids:te.length,numClippingPlanes:s.numPlanes,numClipIntersection:s.numIntersection,dithering:v.dithering,shadowMapEnabled:n.shadowMap.enabled&&N.length>0,shadowMapType:n.shadowMap.type,toneMapping:ae,decodeVideoTexture:C&&v.map.isVideoTexture===!0&&et.getTransfer(v.map.colorSpace)===ft,decodeVideoTextureEmissive:oe&&v.emissiveMap.isVideoTexture===!0&&et.getTransfer(v.emissiveMap.colorSpace)===ft,premultipliedAlpha:v.premultipliedAlpha,doubleSided:v.side===ri,flipSided:v.side===Qt,useDepthPacking:v.depthPacking>=0,depthPacking:v.depthPacking||0,index0AttributeName:v.index0AttributeName,extensionClipCullDistance:we&&v.extensions.clipCullDistance===!0&&t.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(we&&v.extensions.multiDraw===!0||Ve)&&t.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:t.has("KHR_parallel_shader_compile"),customProgramCacheKey:v.customProgramCacheKey()};return Oe.vertexUv1s=l.has(1),Oe.vertexUv2s=l.has(2),Oe.vertexUv3s=l.has(3),l.clear(),Oe}function g(v){const w=[];if(v.shaderID?w.push(v.shaderID):(w.push(v.customVertexShaderID),w.push(v.customFragmentShaderID)),v.defines!==void 0)for(const N in v.defines)w.push(N),w.push(v.defines[N]);return v.isRawShaderMaterial===!1&&(h(w,v),y(w,v),w.push(n.outputColorSpace)),w.push(v.customProgramCacheKey),w.join()}function h(v,w){v.push(w.precision),v.push(w.outputColorSpace),v.push(w.envMapMode),v.push(w.envMapCubeUVHeight),v.push(w.mapUv),v.push(w.alphaMapUv),v.push(w.lightMapUv),v.push(w.aoMapUv),v.push(w.bumpMapUv),v.push(w.normalMapUv),v.push(w.displacementMapUv),v.push(w.emissiveMapUv),v.push(w.metalnessMapUv),v.push(w.roughnessMapUv),v.push(w.anisotropyMapUv),v.push(w.clearcoatMapUv),v.push(w.clearcoatNormalMapUv),v.push(w.clearcoatRoughnessMapUv),v.push(w.iridescenceMapUv),v.push(w.iridescenceThicknessMapUv),v.push(w.sheenColorMapUv),v.push(w.sheenRoughnessMapUv),v.push(w.specularMapUv),v.push(w.specularColorMapUv),v.push(w.specularIntensityMapUv),v.push(w.transmissionMapUv),v.push(w.thicknessMapUv),v.push(w.combine),v.push(w.fogExp2),v.push(w.sizeAttenuation),v.push(w.morphTargetsCount),v.push(w.morphAttributeCount),v.push(w.numDirLights),v.push(w.numPointLights),v.push(w.numSpotLights),v.push(w.numSpotLightMaps),v.push(w.numHemiLights),v.push(w.numRectAreaLights),v.push(w.numDirLightShadows),v.push(w.numPointLightShadows),v.push(w.numSpotLightShadows),v.push(w.numSpotLightShadowsWithMaps),v.push(w.numLightProbes),v.push(w.shadowMapType),v.push(w.toneMapping),v.push(w.numClippingPlanes),v.push(w.numClipIntersection),v.push(w.depthPacking)}function y(v,w){a.disableAll(),w.instancing&&a.enable(0),w.instancingColor&&a.enable(1),w.instancingMorph&&a.enable(2),w.matcap&&a.enable(3),w.envMap&&a.enable(4),w.normalMapObjectSpace&&a.enable(5),w.normalMapTangentSpace&&a.enable(6),w.clearcoat&&a.enable(7),w.iridescence&&a.enable(8),w.alphaTest&&a.enable(9),w.vertexColors&&a.enable(10),w.vertexAlphas&&a.enable(11),w.vertexUv1s&&a.enable(12),w.vertexUv2s&&a.enable(13),w.vertexUv3s&&a.enable(14),w.vertexTangents&&a.enable(15),w.anisotropy&&a.enable(16),w.alphaHash&&a.enable(17),w.batching&&a.enable(18),w.dispersion&&a.enable(19),w.batchingColor&&a.enable(20),w.gradientMap&&a.enable(21),w.packedNormalMap&&a.enable(22),w.vertexNormals&&a.enable(23),v.push(a.mask),a.disableAll(),w.fog&&a.enable(0),w.useFog&&a.enable(1),w.flatShading&&a.enable(2),w.logarithmicDepthBuffer&&a.enable(3),w.reversedDepthBuffer&&a.enable(4),w.skinning&&a.enable(5),w.morphTargets&&a.enable(6),w.morphNormals&&a.enable(7),w.morphColors&&a.enable(8),w.premultipliedAlpha&&a.enable(9),w.shadowMapEnabled&&a.enable(10),w.doubleSided&&a.enable(11),w.flipSided&&a.enable(12),w.useDepthPacking&&a.enable(13),w.dithering&&a.enable(14),w.transmission&&a.enable(15),w.sheen&&a.enable(16),w.opaque&&a.enable(17),w.pointsUvs&&a.enable(18),w.decodeVideoTexture&&a.enable(19),w.decodeVideoTextureEmissive&&a.enable(20),w.alphaToCoverage&&a.enable(21),w.numLightProbeGrids>0&&a.enable(22),w.hasPositionAttribute&&a.enable(23),v.push(a.mask)}function E(v){const w=m[v.type];let N;if(w){const I=Fn[w];N=Cg.clone(I.uniforms)}else N=v.uniforms;return N}function _(v,w){let N=u.get(w);return N!==void 0?++N.usedTimes:(N=new eS(n,w,v,r),c.push(N),u.set(w,N)),N}function A(v){if(--v.usedTimes===0){const w=c.indexOf(v);c[w]=c[c.length-1],c.pop(),u.delete(v.cacheKey),v.destroy()}}function T(v){o.remove(v)}function P(){o.dispose()}return{getParameters:M,getProgramCacheKey:g,getUniforms:E,acquireProgram:_,releaseProgram:A,releaseShaderCache:T,programs:c,dispose:P}}function aS(){let n=new WeakMap;function e(a){return n.has(a)}function t(a){let o=n.get(a);return o===void 0&&(o={},n.set(a,o)),o}function i(a){n.delete(a)}function r(a,o,l){n.get(a)[o]=l}function s(){n=new WeakMap}return{has:e,get:t,remove:i,update:r,dispose:s}}function oS(n,e){return n.groupOrder!==e.groupOrder?n.groupOrder-e.groupOrder:n.renderOrder!==e.renderOrder?n.renderOrder-e.renderOrder:n.material.id!==e.material.id?n.material.id-e.material.id:n.materialVariant!==e.materialVariant?n.materialVariant-e.materialVariant:n.z!==e.z?n.z-e.z:n.id-e.id}function $u(n,e){return n.groupOrder!==e.groupOrder?n.groupOrder-e.groupOrder:n.renderOrder!==e.renderOrder?n.renderOrder-e.renderOrder:n.z!==e.z?e.z-n.z:n.id-e.id}function Yu(){const n=[];let e=0;const t=[],i=[],r=[];function s(){e=0,t.length=0,i.length=0,r.length=0}function a(f){let m=0;return f.isInstancedMesh&&(m+=2),f.isSkinnedMesh&&(m+=1),m}function o(f,m,x,M,g,h){let y=n[e];return y===void 0?(y={id:f.id,object:f,geometry:m,material:x,materialVariant:a(f),groupOrder:M,renderOrder:f.renderOrder,z:g,group:h},n[e]=y):(y.id=f.id,y.object=f,y.geometry=m,y.material=x,y.materialVariant=a(f),y.groupOrder=M,y.renderOrder=f.renderOrder,y.z=g,y.group=h),e++,y}function l(f,m,x,M,g,h){const y=o(f,m,x,M,g,h);x.transmission>0?i.push(y):x.transparent===!0?r.push(y):t.push(y)}function c(f,m,x,M,g,h){const y=o(f,m,x,M,g,h);x.transmission>0?i.unshift(y):x.transparent===!0?r.unshift(y):t.unshift(y)}function u(f,m,x){t.length>1&&t.sort(f||oS),i.length>1&&i.sort(m||$u),r.length>1&&r.sort(m||$u),x&&(t.reverse(),i.reverse(),r.reverse())}function d(){for(let f=e,m=n.length;f<m;f++){const x=n[f];if(x.id===null)break;x.id=null,x.object=null,x.geometry=null,x.material=null,x.group=null}}return{opaque:t,transmissive:i,transparent:r,init:s,push:l,unshift:c,finish:d,sort:u}}function lS(){let n=new WeakMap;function e(i,r){const s=n.get(i);let a;return s===void 0?(a=new Yu,n.set(i,[a])):r>=s.length?(a=new Yu,s.push(a)):a=s[r],a}function t(){n=new WeakMap}return{get:e,dispose:t}}function cS(){const n={};return{get:function(e){if(n[e.id]!==void 0)return n[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new H,color:new ut};break;case"SpotLight":t={position:new H,direction:new H,color:new ut,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new H,color:new ut,distance:0,decay:0};break;case"HemisphereLight":t={direction:new H,skyColor:new ut,groundColor:new ut};break;case"RectAreaLight":t={color:new ut,position:new H,halfWidth:new H,halfHeight:new H};break}return n[e.id]=t,t}}}function uS(){const n={};return{get:function(e){if(n[e.id]!==void 0)return n[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new nt};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new nt};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new nt,shadowCameraNear:1,shadowCameraFar:1e3};break}return n[e.id]=t,t}}}let fS=0;function dS(n,e){return(e.castShadow?2:0)-(n.castShadow?2:0)+(e.map?1:0)-(n.map?1:0)}function hS(n){const e=new cS,t=uS(),i={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)i.probe.push(new H);const r=new H,s=new Ct,a=new Ct;function o(c){let u=0,d=0,f=0;for(let w=0;w<9;w++)i.probe[w].set(0,0,0);let m=0,x=0,M=0,g=0,h=0,y=0,E=0,_=0,A=0,T=0,P=0;c.sort(dS);for(let w=0,N=c.length;w<N;w++){const I=c[w],k=I.color,te=I.intensity,se=I.distance;let V=null;if(I.shadow&&I.shadow.map&&(I.shadow.map.texture.format===Zi?V=I.shadow.map.texture:V=I.shadow.map.depthTexture||I.shadow.map.texture),I.isAmbientLight)u+=k.r*te,d+=k.g*te,f+=k.b*te;else if(I.isLightProbe){for(let J=0;J<9;J++)i.probe[J].addScaledVector(I.sh.coefficients[J],te);P++}else if(I.isDirectionalLight){const J=e.get(I);if(J.color.copy(I.color).multiplyScalar(I.intensity),I.castShadow){const z=I.shadow,Y=t.get(I);Y.shadowIntensity=z.intensity,Y.shadowBias=z.bias,Y.shadowNormalBias=z.normalBias,Y.shadowRadius=z.radius,Y.shadowMapSize=z.mapSize,i.directionalShadow[m]=Y,i.directionalShadowMap[m]=V,i.directionalShadowMatrix[m]=I.shadow.matrix,y++}i.directional[m]=J,m++}else if(I.isSpotLight){const J=e.get(I);J.position.setFromMatrixPosition(I.matrixWorld),J.color.copy(k).multiplyScalar(te),J.distance=se,J.coneCos=Math.cos(I.angle),J.penumbraCos=Math.cos(I.angle*(1-I.penumbra)),J.decay=I.decay,i.spot[M]=J;const z=I.shadow;if(I.map&&(i.spotLightMap[A]=I.map,A++,z.updateMatrices(I),I.castShadow&&T++),i.spotLightMatrix[M]=z.matrix,I.castShadow){const Y=t.get(I);Y.shadowIntensity=z.intensity,Y.shadowBias=z.bias,Y.shadowNormalBias=z.normalBias,Y.shadowRadius=z.radius,Y.shadowMapSize=z.mapSize,i.spotShadow[M]=Y,i.spotShadowMap[M]=V,_++}M++}else if(I.isRectAreaLight){const J=e.get(I);J.color.copy(k).multiplyScalar(te),J.halfWidth.set(I.width*.5,0,0),J.halfHeight.set(0,I.height*.5,0),i.rectArea[g]=J,g++}else if(I.isPointLight){const J=e.get(I);if(J.color.copy(I.color).multiplyScalar(I.intensity),J.distance=I.distance,J.decay=I.decay,I.castShadow){const z=I.shadow,Y=t.get(I);Y.shadowIntensity=z.intensity,Y.shadowBias=z.bias,Y.shadowNormalBias=z.normalBias,Y.shadowRadius=z.radius,Y.shadowMapSize=z.mapSize,Y.shadowCameraNear=z.camera.near,Y.shadowCameraFar=z.camera.far,i.pointShadow[x]=Y,i.pointShadowMap[x]=V,i.pointShadowMatrix[x]=I.shadow.matrix,E++}i.point[x]=J,x++}else if(I.isHemisphereLight){const J=e.get(I);J.skyColor.copy(I.color).multiplyScalar(te),J.groundColor.copy(I.groundColor).multiplyScalar(te),i.hemi[h]=J,h++}}g>0&&(n.has("OES_texture_float_linear")===!0?(i.rectAreaLTC1=ye.LTC_FLOAT_1,i.rectAreaLTC2=ye.LTC_FLOAT_2):(i.rectAreaLTC1=ye.LTC_HALF_1,i.rectAreaLTC2=ye.LTC_HALF_2)),i.ambient[0]=u,i.ambient[1]=d,i.ambient[2]=f;const v=i.hash;(v.directionalLength!==m||v.pointLength!==x||v.spotLength!==M||v.rectAreaLength!==g||v.hemiLength!==h||v.numDirectionalShadows!==y||v.numPointShadows!==E||v.numSpotShadows!==_||v.numSpotMaps!==A||v.numLightProbes!==P)&&(i.directional.length=m,i.spot.length=M,i.rectArea.length=g,i.point.length=x,i.hemi.length=h,i.directionalShadow.length=y,i.directionalShadowMap.length=y,i.pointShadow.length=E,i.pointShadowMap.length=E,i.spotShadow.length=_,i.spotShadowMap.length=_,i.directionalShadowMatrix.length=y,i.pointShadowMatrix.length=E,i.spotLightMatrix.length=_+A-T,i.spotLightMap.length=A,i.numSpotLightShadowsWithMaps=T,i.numLightProbes=P,v.directionalLength=m,v.pointLength=x,v.spotLength=M,v.rectAreaLength=g,v.hemiLength=h,v.numDirectionalShadows=y,v.numPointShadows=E,v.numSpotShadows=_,v.numSpotMaps=A,v.numLightProbes=P,i.version=fS++)}function l(c,u){let d=0,f=0,m=0,x=0,M=0;const g=u.matrixWorldInverse;for(let h=0,y=c.length;h<y;h++){const E=c[h];if(E.isDirectionalLight){const _=i.directional[d];_.direction.setFromMatrixPosition(E.matrixWorld),r.setFromMatrixPosition(E.target.matrixWorld),_.direction.sub(r),_.direction.transformDirection(g),d++}else if(E.isSpotLight){const _=i.spot[m];_.position.setFromMatrixPosition(E.matrixWorld),_.position.applyMatrix4(g),_.direction.setFromMatrixPosition(E.matrixWorld),r.setFromMatrixPosition(E.target.matrixWorld),_.direction.sub(r),_.direction.transformDirection(g),m++}else if(E.isRectAreaLight){const _=i.rectArea[x];_.position.setFromMatrixPosition(E.matrixWorld),_.position.applyMatrix4(g),a.identity(),s.copy(E.matrixWorld),s.premultiply(g),a.extractRotation(s),_.halfWidth.set(E.width*.5,0,0),_.halfHeight.set(0,E.height*.5,0),_.halfWidth.applyMatrix4(a),_.halfHeight.applyMatrix4(a),x++}else if(E.isPointLight){const _=i.point[f];_.position.setFromMatrixPosition(E.matrixWorld),_.position.applyMatrix4(g),f++}else if(E.isHemisphereLight){const _=i.hemi[M];_.direction.setFromMatrixPosition(E.matrixWorld),_.direction.transformDirection(g),M++}}}return{setup:o,setupView:l,state:i}}function Ku(n){const e=new hS(n),t=[],i=[],r=[];function s(f){d.camera=f,t.length=0,i.length=0,r.length=0}function a(f){t.push(f)}function o(f){i.push(f)}function l(f){r.push(f)}function c(){e.setup(t)}function u(f){e.setupView(t,f)}const d={lightsArray:t,shadowsArray:i,lightProbeGridArray:r,camera:null,lights:e,transmissionRenderTarget:{},textureUnits:0};return{init:s,state:d,setupLights:c,setupLightsView:u,pushLight:a,pushShadow:o,pushLightProbeGrid:l}}function pS(n){let e=new WeakMap;function t(r,s=0){const a=e.get(r);let o;return a===void 0?(o=new Ku(n),e.set(r,[o])):s>=a.length?(o=new Ku(n),a.push(o)):o=a[s],o}function i(){e=new WeakMap}return{get:t,dispose:i}}const mS=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,_S=[new H(1,0,0),new H(-1,0,0),new H(0,1,0),new H(0,-1,0),new H(0,0,1),new H(0,0,-1)],vS=[new H(0,-1,0),new H(0,-1,0),new H(0,0,1),new H(0,0,-1),new H(0,-1,0),new H(0,-1,0)],Zu=new Ct,Wr=new H,Do=new H;function xS(n,e,t){let i=new Rd;const r=new nt,s=new nt,a=new Et,o=new Lg,l=new Ug,c={},u=t.maxTextureSize,d={[Di]:Qt,[Qt]:Di,[ri]:ri},f=new Tn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new nt},radius:{value:4}},vertexShader:mS,fragmentShader:gS}),m=f.clone();m.defines.HORIZONTAL_PASS=1;const x=new $n;x.setAttribute("position",new Gn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const M=new qn(x,f),g=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Js;let h=this.type;this.render=function(T,P,v){if(g.enabled===!1||g.autoUpdate===!1&&g.needsUpdate===!1||T.length===0)return;this.type===bm&&(qe("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=Js);const w=n.getRenderTarget(),N=n.getActiveCubeFace(),I=n.getActiveMipmapLevel(),k=n.state;k.setBlending(li),k.buffers.depth.getReversed()===!0?k.buffers.color.setClear(0,0,0,0):k.buffers.color.setClear(1,1,1,1),k.buffers.depth.setTest(!0),k.setScissorTest(!1);const te=h!==this.type;te&&P.traverse(function(se){se.material&&(Array.isArray(se.material)?se.material.forEach(V=>V.needsUpdate=!0):se.material.needsUpdate=!0)});for(let se=0,V=T.length;se<V;se++){const J=T[se],z=J.shadow;if(z===void 0){qe("WebGLShadowMap:",J,"has no shadow.");continue}if(z.autoUpdate===!1&&z.needsUpdate===!1)continue;r.copy(z.mapSize);const Y=z.getFrameExtents();r.multiply(Y),s.copy(z.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/Y.x),r.x=s.x*Y.x,z.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/Y.y),r.y=s.y*Y.y,z.mapSize.y=s.y));const le=n.state.buffers.depth.getReversed();if(z.camera._reversedDepth=le,z.map===null||te===!0){if(z.map!==null&&(z.map.depthTexture!==null&&(z.map.depthTexture.dispose(),z.map.depthTexture=null),z.map.dispose()),this.type===Yr){if(J.isPointLight){qe("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}z.map=new Vn(r.x,r.y,{format:Zi,type:pi,minFilter:Ht,magFilter:Ht,generateMipmaps:!1}),z.map.texture.name=J.name+".shadowMap",z.map.depthTexture=new Cr(r.x,r.y,Bn),z.map.depthTexture.name=J.name+".shadowMapDepth",z.map.depthTexture.format=mi,z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=Nt,z.map.depthTexture.magFilter=Nt}else J.isPointLight?(z.map=new Fd(r.x),z.map.depthTexture=new wg(r.x,Xn)):(z.map=new Vn(r.x,r.y),z.map.depthTexture=new Cr(r.x,r.y,Xn)),z.map.depthTexture.name=J.name+".shadowMap",z.map.depthTexture.format=mi,this.type===Js?(z.map.depthTexture.compareFunction=le?rc:ic,z.map.depthTexture.minFilter=Ht,z.map.depthTexture.magFilter=Ht):(z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=Nt,z.map.depthTexture.magFilter=Nt);z.camera.updateProjectionMatrix()}const _e=z.map.isWebGLCubeRenderTarget?6:1;for(let ve=0;ve<_e;ve++){if(z.map.isWebGLCubeRenderTarget)n.setRenderTarget(z.map,ve),n.clear();else{ve===0&&(n.setRenderTarget(z.map),n.clear());const Ee=z.getViewport(ve);a.set(s.x*Ee.x,s.y*Ee.y,s.x*Ee.z,s.y*Ee.w),k.viewport(a)}if(J.isPointLight){const Ee=z.camera,it=z.matrix,St=J.distance||Ee.far;St!==Ee.far&&(Ee.far=St,Ee.updateProjectionMatrix()),Wr.setFromMatrixPosition(J.matrixWorld),Ee.position.copy(Wr),Do.copy(Ee.position),Do.add(_S[ve]),Ee.up.copy(vS[ve]),Ee.lookAt(Do),Ee.updateMatrixWorld(),it.makeTranslation(-Wr.x,-Wr.y,-Wr.z),Zu.multiplyMatrices(Ee.projectionMatrix,Ee.matrixWorldInverse),z._frustum.setFromProjectionMatrix(Zu,Ee.coordinateSystem,Ee.reversedDepth)}else z.updateMatrices(J);i=z.getFrustum(),_(P,v,z.camera,J,this.type)}z.isPointLightShadow!==!0&&this.type===Yr&&y(z,v),z.needsUpdate=!1}h=this.type,g.needsUpdate=!1,n.setRenderTarget(w,N,I)};function y(T,P){const v=e.update(M);f.defines.VSM_SAMPLES!==T.blurSamples&&(f.defines.VSM_SAMPLES=T.blurSamples,m.defines.VSM_SAMPLES=T.blurSamples,f.needsUpdate=!0,m.needsUpdate=!0),T.mapPass===null&&(T.mapPass=new Vn(r.x,r.y,{format:Zi,type:pi})),f.uniforms.shadow_pass.value=T.map.depthTexture,f.uniforms.resolution.value=T.mapSize,f.uniforms.radius.value=T.radius,n.setRenderTarget(T.mapPass),n.clear(),n.renderBufferDirect(P,null,v,f,M,null),m.uniforms.shadow_pass.value=T.mapPass.texture,m.uniforms.resolution.value=T.mapSize,m.uniforms.radius.value=T.radius,n.setRenderTarget(T.map),n.clear(),n.renderBufferDirect(P,null,v,m,M,null)}function E(T,P,v,w){let N=null;const I=v.isPointLight===!0?T.customDistanceMaterial:T.customDepthMaterial;if(I!==void 0)N=I;else if(N=v.isPointLight===!0?l:o,n.localClippingEnabled&&P.clipShadows===!0&&Array.isArray(P.clippingPlanes)&&P.clippingPlanes.length!==0||P.displacementMap&&P.displacementScale!==0||P.alphaMap&&P.alphaTest>0||P.map&&P.alphaTest>0||P.alphaToCoverage===!0){const k=N.uuid,te=P.uuid;let se=c[k];se===void 0&&(se={},c[k]=se);let V=se[te];V===void 0&&(V=N.clone(),se[te]=V,P.addEventListener("dispose",A)),N=V}if(N.visible=P.visible,N.wireframe=P.wireframe,w===Yr?N.side=P.shadowSide!==null?P.shadowSide:P.side:N.side=P.shadowSide!==null?P.shadowSide:d[P.side],N.alphaMap=P.alphaMap,N.alphaTest=P.alphaToCoverage===!0?.5:P.alphaTest,N.map=P.map,N.clipShadows=P.clipShadows,N.clippingPlanes=P.clippingPlanes,N.clipIntersection=P.clipIntersection,N.displacementMap=P.displacementMap,N.displacementScale=P.displacementScale,N.displacementBias=P.displacementBias,N.wireframeLinewidth=P.wireframeLinewidth,N.linewidth=P.linewidth,v.isPointLight===!0&&N.isMeshDistanceMaterial===!0){const k=n.properties.get(N);k.light=v}return N}function _(T,P,v,w,N){if(T.visible===!1)return;if(T.layers.test(P.layers)&&(T.isMesh||T.isLine||T.isPoints)&&(T.castShadow||T.receiveShadow&&N===Yr)&&(!T.frustumCulled||i.intersectsObject(T))){T.modelViewMatrix.multiplyMatrices(v.matrixWorldInverse,T.matrixWorld);const te=e.update(T),se=T.material;if(Array.isArray(se)){const V=te.groups;for(let J=0,z=V.length;J<z;J++){const Y=V[J],le=se[Y.materialIndex];if(le&&le.visible){const _e=E(T,le,w,N);T.onBeforeShadow(n,T,P,v,te,_e,Y),n.renderBufferDirect(v,null,te,_e,T,Y),T.onAfterShadow(n,T,P,v,te,_e,Y)}}}else if(se.visible){const V=E(T,se,w,N);T.onBeforeShadow(n,T,P,v,te,V,null),n.renderBufferDirect(v,null,te,V,T,null),T.onAfterShadow(n,T,P,v,te,V,null)}}const k=T.children;for(let te=0,se=k.length;te<se;te++)_(k[te],P,v,w,N)}function A(T){T.target.removeEventListener("dispose",A);for(const v in c){const w=c[v],N=T.target.uuid;N in w&&(w[N].dispose(),delete w[N])}}}function SS(n,e){function t(){let F=!1;const xe=new Et;let re=null;const Me=new Et(0,0,0,0);return{setMask:function(we){re!==we&&!F&&(n.colorMask(we,we,we,we),re=we)},setLocked:function(we){F=we},setClear:function(we,ae,Oe,Ne,bt){bt===!0&&(we*=Ne,ae*=Ne,Oe*=Ne),xe.set(we,ae,Oe,Ne),Me.equals(xe)===!1&&(n.clearColor(we,ae,Oe,Ne),Me.copy(xe))},reset:function(){F=!1,re=null,Me.set(-1,0,0,0)}}}function i(){let F=!1,xe=!1,re=null,Me=null,we=null;return{setReversed:function(ae){if(xe!==ae){const Oe=e.get("EXT_clip_control");ae?Oe.clipControlEXT(Oe.LOWER_LEFT_EXT,Oe.ZERO_TO_ONE_EXT):Oe.clipControlEXT(Oe.LOWER_LEFT_EXT,Oe.NEGATIVE_ONE_TO_ONE_EXT),xe=ae;const Ne=we;we=null,this.setClear(Ne)}},getReversed:function(){return xe},setTest:function(ae){ae?fe(n.DEPTH_TEST):We(n.DEPTH_TEST)},setMask:function(ae){re!==ae&&!F&&(n.depthMask(ae),re=ae)},setFunc:function(ae){if(xe&&(ae=tg[ae]),Me!==ae){switch(ae){case Wo:n.depthFunc(n.NEVER);break;case Xo:n.depthFunc(n.ALWAYS);break;case qo:n.depthFunc(n.LESS);break;case wr:n.depthFunc(n.LEQUAL);break;case $o:n.depthFunc(n.EQUAL);break;case Yo:n.depthFunc(n.GEQUAL);break;case Ko:n.depthFunc(n.GREATER);break;case Zo:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}Me=ae}},setLocked:function(ae){F=ae},setClear:function(ae){we!==ae&&(we=ae,xe&&(ae=1-ae),n.clearDepth(ae))},reset:function(){F=!1,re=null,Me=null,we=null,xe=!1}}}function r(){let F=!1,xe=null,re=null,Me=null,we=null,ae=null,Oe=null,Ne=null,bt=null;return{setTest:function(_t){F||(_t?fe(n.STENCIL_TEST):We(n.STENCIL_TEST))},setMask:function(_t){xe!==_t&&!F&&(n.stencilMask(_t),xe=_t)},setFunc:function(_t,wn,Rn){(re!==_t||Me!==wn||we!==Rn)&&(n.stencilFunc(_t,wn,Rn),re=_t,Me=wn,we=Rn)},setOp:function(_t,wn,Rn){(ae!==_t||Oe!==wn||Ne!==Rn)&&(n.stencilOp(_t,wn,Rn),ae=_t,Oe=wn,Ne=Rn)},setLocked:function(_t){F=_t},setClear:function(_t){bt!==_t&&(n.clearStencil(_t),bt=_t)},reset:function(){F=!1,xe=null,re=null,Me=null,we=null,ae=null,Oe=null,Ne=null,bt=null}}}const s=new t,a=new i,o=new r,l=new WeakMap,c=new WeakMap;let u={},d={},f={},m=new WeakMap,x=[],M=null,g=!1,h=null,y=null,E=null,_=null,A=null,T=null,P=null,v=new ut(0,0,0),w=0,N=!1,I=null,k=null,te=null,se=null,V=null;const J=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let z=!1,Y=0;const le=n.getParameter(n.VERSION);le.indexOf("WebGL")!==-1?(Y=parseFloat(/^WebGL (\d)/.exec(le)[1]),z=Y>=1):le.indexOf("OpenGL ES")!==-1&&(Y=parseFloat(/^OpenGL ES (\d)/.exec(le)[1]),z=Y>=2);let _e=null,ve={};const Ee=n.getParameter(n.SCISSOR_BOX),it=n.getParameter(n.VIEWPORT),St=new Et().fromArray(Ee),rt=new Et().fromArray(it);function ne(F,xe,re,Me){const we=new Uint8Array(4),ae=n.createTexture();n.bindTexture(F,ae),n.texParameteri(F,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(F,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Oe=0;Oe<re;Oe++)F===n.TEXTURE_3D||F===n.TEXTURE_2D_ARRAY?n.texImage3D(xe,0,n.RGBA,1,1,Me,0,n.RGBA,n.UNSIGNED_BYTE,we):n.texImage2D(xe+Oe,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,we);return ae}const me={};me[n.TEXTURE_2D]=ne(n.TEXTURE_2D,n.TEXTURE_2D,1),me[n.TEXTURE_CUBE_MAP]=ne(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),me[n.TEXTURE_2D_ARRAY]=ne(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),me[n.TEXTURE_3D]=ne(n.TEXTURE_3D,n.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),fe(n.DEPTH_TEST),a.setFunc(wr),ee(!1),de(jc),fe(n.CULL_FACE),Q(li);function fe(F){u[F]!==!0&&(n.enable(F),u[F]=!0)}function We(F){u[F]!==!1&&(n.disable(F),u[F]=!1)}function Xe(F,xe){return f[F]!==xe?(n.bindFramebuffer(F,xe),f[F]=xe,F===n.DRAW_FRAMEBUFFER&&(f[n.FRAMEBUFFER]=xe),F===n.FRAMEBUFFER&&(f[n.DRAW_FRAMEBUFFER]=xe),!0):!1}function Ve(F,xe){let re=x,Me=!1;if(F){re=m.get(xe),re===void 0&&(re=[],m.set(xe,re));const we=F.textures;if(re.length!==we.length||re[0]!==n.COLOR_ATTACHMENT0){for(let ae=0,Oe=we.length;ae<Oe;ae++)re[ae]=n.COLOR_ATTACHMENT0+ae;re.length=we.length,Me=!0}}else re[0]!==n.BACK&&(re[0]=n.BACK,Me=!0);Me&&n.drawBuffers(re)}function C(F){return M!==F?(n.useProgram(F),M=F,!0):!1}const D={[Hi]:n.FUNC_ADD,[Em]:n.FUNC_SUBTRACT,[Tm]:n.FUNC_REVERSE_SUBTRACT};D[Am]=n.MIN,D[wm]=n.MAX;const W={[Rm]:n.ZERO,[Cm]:n.ONE,[Pm]:n.SRC_COLOR,[Vo]:n.SRC_ALPHA,[Fm]:n.SRC_ALPHA_SATURATE,[Um]:n.DST_COLOR,[Im]:n.DST_ALPHA,[Dm]:n.ONE_MINUS_SRC_COLOR,[Go]:n.ONE_MINUS_SRC_ALPHA,[Nm]:n.ONE_MINUS_DST_COLOR,[Lm]:n.ONE_MINUS_DST_ALPHA,[Om]:n.CONSTANT_COLOR,[Bm]:n.ONE_MINUS_CONSTANT_COLOR,[zm]:n.CONSTANT_ALPHA,[km]:n.ONE_MINUS_CONSTANT_ALPHA};function Q(F,xe,re,Me,we,ae,Oe,Ne,bt,_t){if(F===li){g===!0&&(We(n.BLEND),g=!1);return}if(g===!1&&(fe(n.BLEND),g=!0),F!==ym){if(F!==h||_t!==N){if((y!==Hi||A!==Hi)&&(n.blendEquation(n.FUNC_ADD),y=Hi,A=Hi),_t)switch(F){case br:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case eu:n.blendFunc(n.ONE,n.ONE);break;case tu:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case nu:n.blendFuncSeparate(n.DST_COLOR,n.ONE_MINUS_SRC_ALPHA,n.ZERO,n.ONE);break;default:at("WebGLState: Invalid blending: ",F);break}else switch(F){case br:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case eu:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE,n.ONE,n.ONE);break;case tu:at("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case nu:at("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:at("WebGLState: Invalid blending: ",F);break}E=null,_=null,T=null,P=null,v.set(0,0,0),w=0,h=F,N=_t}return}we=we||xe,ae=ae||re,Oe=Oe||Me,(xe!==y||we!==A)&&(n.blendEquationSeparate(D[xe],D[we]),y=xe,A=we),(re!==E||Me!==_||ae!==T||Oe!==P)&&(n.blendFuncSeparate(W[re],W[Me],W[ae],W[Oe]),E=re,_=Me,T=ae,P=Oe),(Ne.equals(v)===!1||bt!==w)&&(n.blendColor(Ne.r,Ne.g,Ne.b,bt),v.copy(Ne),w=bt),h=F,N=!1}function K(F,xe){F.side===ri?We(n.CULL_FACE):fe(n.CULL_FACE);let re=F.side===Qt;xe&&(re=!re),ee(re),F.blending===br&&F.transparent===!1?Q(li):Q(F.blending,F.blendEquation,F.blendSrc,F.blendDst,F.blendEquationAlpha,F.blendSrcAlpha,F.blendDstAlpha,F.blendColor,F.blendAlpha,F.premultipliedAlpha),a.setFunc(F.depthFunc),a.setTest(F.depthTest),a.setMask(F.depthWrite),s.setMask(F.colorWrite);const Me=F.stencilWrite;o.setTest(Me),Me&&(o.setMask(F.stencilWriteMask),o.setFunc(F.stencilFunc,F.stencilRef,F.stencilFuncMask),o.setOp(F.stencilFail,F.stencilZFail,F.stencilZPass)),oe(F.polygonOffset,F.polygonOffsetFactor,F.polygonOffsetUnits),F.alphaToCoverage===!0?fe(n.SAMPLE_ALPHA_TO_COVERAGE):We(n.SAMPLE_ALPHA_TO_COVERAGE)}function ee(F){I!==F&&(F?n.frontFace(n.CW):n.frontFace(n.CCW),I=F)}function de(F){F!==Sm?(fe(n.CULL_FACE),F!==k&&(F===jc?n.cullFace(n.BACK):F===Mm?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):We(n.CULL_FACE),k=F}function ce(F){F!==te&&(z&&n.lineWidth(F),te=F)}function oe(F,xe,re){F?(fe(n.POLYGON_OFFSET_FILL),(se!==xe||V!==re)&&(se=xe,V=re,a.getReversed()&&(xe=-xe),n.polygonOffset(xe,re))):We(n.POLYGON_OFFSET_FILL)}function j(F){F?fe(n.SCISSOR_TEST):We(n.SCISSOR_TEST)}function Ce(F){F===void 0&&(F=n.TEXTURE0+J-1),_e!==F&&(n.activeTexture(F),_e=F)}function R(F,xe,re){re===void 0&&(_e===null?re=n.TEXTURE0+J-1:re=_e);let Me=ve[re];Me===void 0&&(Me={type:void 0,texture:void 0},ve[re]=Me),(Me.type!==F||Me.texture!==xe)&&(_e!==re&&(n.activeTexture(re),_e=re),n.bindTexture(F,xe||me[F]),Me.type=F,Me.texture=xe)}function Pe(){const F=ve[_e];F!==void 0&&F.type!==void 0&&(n.bindTexture(F.type,null),F.type=void 0,F.texture=void 0)}function be(){try{n.compressedTexImage2D(...arguments)}catch(F){at("WebGLState:",F)}}function b(){try{n.compressedTexImage3D(...arguments)}catch(F){at("WebGLState:",F)}}function p(){try{n.texSubImage2D(...arguments)}catch(F){at("WebGLState:",F)}}function L(){try{n.texSubImage3D(...arguments)}catch(F){at("WebGLState:",F)}}function B(){try{n.compressedTexSubImage2D(...arguments)}catch(F){at("WebGLState:",F)}}function q(){try{n.compressedTexSubImage3D(...arguments)}catch(F){at("WebGLState:",F)}}function ue(){try{n.texStorage2D(...arguments)}catch(F){at("WebGLState:",F)}}function pe(){try{n.texStorage3D(...arguments)}catch(F){at("WebGLState:",F)}}function Z(){try{n.texImage2D(...arguments)}catch(F){at("WebGLState:",F)}}function ie(){try{n.texImage3D(...arguments)}catch(F){at("WebGLState:",F)}}function he(F){return d[F]!==void 0?d[F]:n.getParameter(F)}function De(F,xe){d[F]!==xe&&(n.pixelStorei(F,xe),d[F]=xe)}function Se(F){St.equals(F)===!1&&(n.scissor(F.x,F.y,F.z,F.w),St.copy(F))}function ge(F){rt.equals(F)===!1&&(n.viewport(F.x,F.y,F.z,F.w),rt.copy(F))}function He(F,xe){let re=c.get(xe);re===void 0&&(re=new WeakMap,c.set(xe,re));let Me=re.get(F);Me===void 0&&(Me=n.getUniformBlockIndex(xe,F.name),re.set(F,Me))}function Ge(F,xe){const Me=c.get(xe).get(F);l.get(xe)!==Me&&(n.uniformBlockBinding(xe,Me,F.__bindingPointIndex),l.set(xe,Me))}function Ze(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),a.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),n.pixelStorei(n.PACK_ALIGNMENT,4),n.pixelStorei(n.UNPACK_ALIGNMENT,4),n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,!1),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,n.BROWSER_DEFAULT_WEBGL),n.pixelStorei(n.PACK_ROW_LENGTH,0),n.pixelStorei(n.PACK_SKIP_PIXELS,0),n.pixelStorei(n.PACK_SKIP_ROWS,0),n.pixelStorei(n.UNPACK_ROW_LENGTH,0),n.pixelStorei(n.UNPACK_IMAGE_HEIGHT,0),n.pixelStorei(n.UNPACK_SKIP_PIXELS,0),n.pixelStorei(n.UNPACK_SKIP_ROWS,0),n.pixelStorei(n.UNPACK_SKIP_IMAGES,0),u={},d={},_e=null,ve={},f={},m=new WeakMap,x=[],M=null,g=!1,h=null,y=null,E=null,_=null,A=null,T=null,P=null,v=new ut(0,0,0),w=0,N=!1,I=null,k=null,te=null,se=null,V=null,St.set(0,0,n.canvas.width,n.canvas.height),rt.set(0,0,n.canvas.width,n.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:fe,disable:We,bindFramebuffer:Xe,drawBuffers:Ve,useProgram:C,setBlending:Q,setMaterial:K,setFlipSided:ee,setCullFace:de,setLineWidth:ce,setPolygonOffset:oe,setScissorTest:j,activeTexture:Ce,bindTexture:R,unbindTexture:Pe,compressedTexImage2D:be,compressedTexImage3D:b,texImage2D:Z,texImage3D:ie,pixelStorei:De,getParameter:he,updateUBOMapping:He,uniformBlockBinding:Ge,texStorage2D:ue,texStorage3D:pe,texSubImage2D:p,texSubImage3D:L,compressedTexSubImage2D:B,compressedTexSubImage3D:q,scissor:Se,viewport:ge,reset:Ze}}function MS(n,e,t,i,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new nt,u=new WeakMap,d=new Set;let f;const m=new WeakMap;let x=!1;try{x=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function M(b,p){return x?new OffscreenCanvas(b,p):_a("canvas")}function g(b,p,L){let B=1;const q=be(b);if((q.width>L||q.height>L)&&(B=L/Math.max(q.width,q.height)),B<1)if(typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&b instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&b instanceof ImageBitmap||typeof VideoFrame<"u"&&b instanceof VideoFrame){const ue=Math.floor(B*q.width),pe=Math.floor(B*q.height);f===void 0&&(f=M(ue,pe));const Z=p?M(ue,pe):f;return Z.width=ue,Z.height=pe,Z.getContext("2d").drawImage(b,0,0,ue,pe),qe("WebGLRenderer: Texture has been resized from ("+q.width+"x"+q.height+") to ("+ue+"x"+pe+")."),Z}else return"data"in b&&qe("WebGLRenderer: Image in DataTexture is too big ("+q.width+"x"+q.height+")."),b;return b}function h(b){return b.generateMipmaps}function y(b){n.generateMipmap(b)}function E(b){return b.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:b.isWebGL3DRenderTarget?n.TEXTURE_3D:b.isWebGLArrayRenderTarget||b.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function _(b,p,L,B,q,ue=!1){if(b!==null){if(n[b]!==void 0)return n[b];qe("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+b+"'")}let pe;B&&(pe=e.get("EXT_texture_norm16"),pe||qe("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let Z=p;if(p===n.RED&&(L===n.FLOAT&&(Z=n.R32F),L===n.HALF_FLOAT&&(Z=n.R16F),L===n.UNSIGNED_BYTE&&(Z=n.R8),L===n.UNSIGNED_SHORT&&pe&&(Z=pe.R16_EXT),L===n.SHORT&&pe&&(Z=pe.R16_SNORM_EXT)),p===n.RED_INTEGER&&(L===n.UNSIGNED_BYTE&&(Z=n.R8UI),L===n.UNSIGNED_SHORT&&(Z=n.R16UI),L===n.UNSIGNED_INT&&(Z=n.R32UI),L===n.BYTE&&(Z=n.R8I),L===n.SHORT&&(Z=n.R16I),L===n.INT&&(Z=n.R32I)),p===n.RG&&(L===n.FLOAT&&(Z=n.RG32F),L===n.HALF_FLOAT&&(Z=n.RG16F),L===n.UNSIGNED_BYTE&&(Z=n.RG8),L===n.UNSIGNED_SHORT&&pe&&(Z=pe.RG16_EXT),L===n.SHORT&&pe&&(Z=pe.RG16_SNORM_EXT)),p===n.RG_INTEGER&&(L===n.UNSIGNED_BYTE&&(Z=n.RG8UI),L===n.UNSIGNED_SHORT&&(Z=n.RG16UI),L===n.UNSIGNED_INT&&(Z=n.RG32UI),L===n.BYTE&&(Z=n.RG8I),L===n.SHORT&&(Z=n.RG16I),L===n.INT&&(Z=n.RG32I)),p===n.RGB_INTEGER&&(L===n.UNSIGNED_BYTE&&(Z=n.RGB8UI),L===n.UNSIGNED_SHORT&&(Z=n.RGB16UI),L===n.UNSIGNED_INT&&(Z=n.RGB32UI),L===n.BYTE&&(Z=n.RGB8I),L===n.SHORT&&(Z=n.RGB16I),L===n.INT&&(Z=n.RGB32I)),p===n.RGBA_INTEGER&&(L===n.UNSIGNED_BYTE&&(Z=n.RGBA8UI),L===n.UNSIGNED_SHORT&&(Z=n.RGBA16UI),L===n.UNSIGNED_INT&&(Z=n.RGBA32UI),L===n.BYTE&&(Z=n.RGBA8I),L===n.SHORT&&(Z=n.RGBA16I),L===n.INT&&(Z=n.RGBA32I)),p===n.RGB&&(L===n.UNSIGNED_SHORT&&pe&&(Z=pe.RGB16_EXT),L===n.SHORT&&pe&&(Z=pe.RGB16_SNORM_EXT),L===n.UNSIGNED_INT_5_9_9_9_REV&&(Z=n.RGB9_E5),L===n.UNSIGNED_INT_10F_11F_11F_REV&&(Z=n.R11F_G11F_B10F)),p===n.RGBA){const ie=ue?ma:et.getTransfer(q);L===n.FLOAT&&(Z=n.RGBA32F),L===n.HALF_FLOAT&&(Z=n.RGBA16F),L===n.UNSIGNED_BYTE&&(Z=ie===ft?n.SRGB8_ALPHA8:n.RGBA8),L===n.UNSIGNED_SHORT&&pe&&(Z=pe.RGBA16_EXT),L===n.SHORT&&pe&&(Z=pe.RGBA16_SNORM_EXT),L===n.UNSIGNED_SHORT_4_4_4_4&&(Z=n.RGBA4),L===n.UNSIGNED_SHORT_5_5_5_1&&(Z=n.RGB5_A1)}return(Z===n.R16F||Z===n.R32F||Z===n.RG16F||Z===n.RG32F||Z===n.RGBA16F||Z===n.RGBA32F)&&e.get("EXT_color_buffer_float"),Z}function A(b,p){let L;return b?p===null||p===Xn||p===cs?L=n.DEPTH24_STENCIL8:p===Bn?L=n.DEPTH32F_STENCIL8:p===ls&&(L=n.DEPTH24_STENCIL8,qe("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):p===null||p===Xn||p===cs?L=n.DEPTH_COMPONENT24:p===Bn?L=n.DEPTH_COMPONENT32F:p===ls&&(L=n.DEPTH_COMPONENT16),L}function T(b,p){return h(b)===!0||b.isFramebufferTexture&&b.minFilter!==Nt&&b.minFilter!==Ht?Math.log2(Math.max(p.width,p.height))+1:b.mipmaps!==void 0&&b.mipmaps.length>0?b.mipmaps.length:b.isCompressedTexture&&Array.isArray(b.image)?p.mipmaps.length:1}function P(b){const p=b.target;p.removeEventListener("dispose",P),w(p),p.isVideoTexture&&u.delete(p),p.isHTMLTexture&&d.delete(p)}function v(b){const p=b.target;p.removeEventListener("dispose",v),I(p)}function w(b){const p=i.get(b);if(p.__webglInit===void 0)return;const L=b.source,B=m.get(L);if(B){const q=B[p.__cacheKey];q.usedTimes--,q.usedTimes===0&&N(b),Object.keys(B).length===0&&m.delete(L)}i.remove(b)}function N(b){const p=i.get(b);n.deleteTexture(p.__webglTexture);const L=b.source,B=m.get(L);delete B[p.__cacheKey],a.memory.textures--}function I(b){const p=i.get(b);if(b.depthTexture&&(b.depthTexture.dispose(),i.remove(b.depthTexture)),b.isWebGLCubeRenderTarget)for(let B=0;B<6;B++){if(Array.isArray(p.__webglFramebuffer[B]))for(let q=0;q<p.__webglFramebuffer[B].length;q++)n.deleteFramebuffer(p.__webglFramebuffer[B][q]);else n.deleteFramebuffer(p.__webglFramebuffer[B]);p.__webglDepthbuffer&&n.deleteRenderbuffer(p.__webglDepthbuffer[B])}else{if(Array.isArray(p.__webglFramebuffer))for(let B=0;B<p.__webglFramebuffer.length;B++)n.deleteFramebuffer(p.__webglFramebuffer[B]);else n.deleteFramebuffer(p.__webglFramebuffer);if(p.__webglDepthbuffer&&n.deleteRenderbuffer(p.__webglDepthbuffer),p.__webglMultisampledFramebuffer&&n.deleteFramebuffer(p.__webglMultisampledFramebuffer),p.__webglColorRenderbuffer)for(let B=0;B<p.__webglColorRenderbuffer.length;B++)p.__webglColorRenderbuffer[B]&&n.deleteRenderbuffer(p.__webglColorRenderbuffer[B]);p.__webglDepthRenderbuffer&&n.deleteRenderbuffer(p.__webglDepthRenderbuffer)}const L=b.textures;for(let B=0,q=L.length;B<q;B++){const ue=i.get(L[B]);ue.__webglTexture&&(n.deleteTexture(ue.__webglTexture),a.memory.textures--),i.remove(L[B])}i.remove(b)}let k=0;function te(){k=0}function se(){return k}function V(b){k=b}function J(){const b=k;return b>=r.maxTextures&&qe("WebGLTextures: Trying to use "+b+" texture units while this GPU supports only "+r.maxTextures),k+=1,b}function z(b){const p=[];return p.push(b.wrapS),p.push(b.wrapT),p.push(b.wrapR||0),p.push(b.magFilter),p.push(b.minFilter),p.push(b.anisotropy),p.push(b.internalFormat),p.push(b.format),p.push(b.type),p.push(b.generateMipmaps),p.push(b.premultiplyAlpha),p.push(b.flipY),p.push(b.unpackAlignment),p.push(b.colorSpace),p.join()}function Y(b,p){const L=i.get(b);if(b.isVideoTexture&&R(b),b.isRenderTargetTexture===!1&&b.isExternalTexture!==!0&&b.version>0&&L.__version!==b.version){const B=b.image;if(B===null)qe("WebGLRenderer: Texture marked for update but no image data found.");else if(B.complete===!1)qe("WebGLRenderer: Texture marked for update but image is incomplete");else{We(L,b,p);return}}else b.isExternalTexture&&(L.__webglTexture=b.sourceTexture?b.sourceTexture:null);t.bindTexture(n.TEXTURE_2D,L.__webglTexture,n.TEXTURE0+p)}function le(b,p){const L=i.get(b);if(b.isRenderTargetTexture===!1&&b.version>0&&L.__version!==b.version){We(L,b,p);return}else b.isExternalTexture&&(L.__webglTexture=b.sourceTexture?b.sourceTexture:null);t.bindTexture(n.TEXTURE_2D_ARRAY,L.__webglTexture,n.TEXTURE0+p)}function _e(b,p){const L=i.get(b);if(b.isRenderTargetTexture===!1&&b.version>0&&L.__version!==b.version){We(L,b,p);return}t.bindTexture(n.TEXTURE_3D,L.__webglTexture,n.TEXTURE0+p)}function ve(b,p){const L=i.get(b);if(b.isCubeDepthTexture!==!0&&b.version>0&&L.__version!==b.version){Xe(L,b,p);return}t.bindTexture(n.TEXTURE_CUBE_MAP,L.__webglTexture,n.TEXTURE0+p)}const Ee={[Jo]:n.REPEAT,[oi]:n.CLAMP_TO_EDGE,[Qo]:n.MIRRORED_REPEAT},it={[Nt]:n.NEAREST,[Gm]:n.NEAREST_MIPMAP_NEAREST,[Es]:n.NEAREST_MIPMAP_LINEAR,[Ht]:n.LINEAR,[eo]:n.LINEAR_MIPMAP_NEAREST,[Gi]:n.LINEAR_MIPMAP_LINEAR},St={[qm]:n.NEVER,[Jm]:n.ALWAYS,[$m]:n.LESS,[ic]:n.LEQUAL,[Ym]:n.EQUAL,[rc]:n.GEQUAL,[Km]:n.GREATER,[Zm]:n.NOTEQUAL};function rt(b,p){if(p.type===Bn&&e.has("OES_texture_float_linear")===!1&&(p.magFilter===Ht||p.magFilter===eo||p.magFilter===Es||p.magFilter===Gi||p.minFilter===Ht||p.minFilter===eo||p.minFilter===Es||p.minFilter===Gi)&&qe("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(b,n.TEXTURE_WRAP_S,Ee[p.wrapS]),n.texParameteri(b,n.TEXTURE_WRAP_T,Ee[p.wrapT]),(b===n.TEXTURE_3D||b===n.TEXTURE_2D_ARRAY)&&n.texParameteri(b,n.TEXTURE_WRAP_R,Ee[p.wrapR]),n.texParameteri(b,n.TEXTURE_MAG_FILTER,it[p.magFilter]),n.texParameteri(b,n.TEXTURE_MIN_FILTER,it[p.minFilter]),p.compareFunction&&(n.texParameteri(b,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(b,n.TEXTURE_COMPARE_FUNC,St[p.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(p.magFilter===Nt||p.minFilter!==Es&&p.minFilter!==Gi||p.type===Bn&&e.has("OES_texture_float_linear")===!1)return;if(p.anisotropy>1||i.get(p).__currentAnisotropy){const L=e.get("EXT_texture_filter_anisotropic");n.texParameterf(b,L.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(p.anisotropy,r.getMaxAnisotropy())),i.get(p).__currentAnisotropy=p.anisotropy}}}function ne(b,p){let L=!1;b.__webglInit===void 0&&(b.__webglInit=!0,p.addEventListener("dispose",P));const B=p.source;let q=m.get(B);q===void 0&&(q={},m.set(B,q));const ue=z(p);if(ue!==b.__cacheKey){q[ue]===void 0&&(q[ue]={texture:n.createTexture(),usedTimes:0},a.memory.textures++,L=!0),q[ue].usedTimes++;const pe=q[b.__cacheKey];pe!==void 0&&(q[b.__cacheKey].usedTimes--,pe.usedTimes===0&&N(p)),b.__cacheKey=ue,b.__webglTexture=q[ue].texture}return L}function me(b,p,L){return Math.floor(Math.floor(b/L)/p)}function fe(b,p,L,B){const ue=b.updateRanges;if(ue.length===0)t.texSubImage2D(n.TEXTURE_2D,0,0,0,p.width,p.height,L,B,p.data);else{ue.sort((De,Se)=>De.start-Se.start);let pe=0;for(let De=1;De<ue.length;De++){const Se=ue[pe],ge=ue[De],He=Se.start+Se.count,Ge=me(ge.start,p.width,4),Ze=me(Se.start,p.width,4);ge.start<=He+1&&Ge===Ze&&me(ge.start+ge.count-1,p.width,4)===Ge?Se.count=Math.max(Se.count,ge.start+ge.count-Se.start):(++pe,ue[pe]=ge)}ue.length=pe+1;const Z=t.getParameter(n.UNPACK_ROW_LENGTH),ie=t.getParameter(n.UNPACK_SKIP_PIXELS),he=t.getParameter(n.UNPACK_SKIP_ROWS);t.pixelStorei(n.UNPACK_ROW_LENGTH,p.width);for(let De=0,Se=ue.length;De<Se;De++){const ge=ue[De],He=Math.floor(ge.start/4),Ge=Math.ceil(ge.count/4),Ze=He%p.width,F=Math.floor(He/p.width),xe=Ge,re=1;t.pixelStorei(n.UNPACK_SKIP_PIXELS,Ze),t.pixelStorei(n.UNPACK_SKIP_ROWS,F),t.texSubImage2D(n.TEXTURE_2D,0,Ze,F,xe,re,L,B,p.data)}b.clearUpdateRanges(),t.pixelStorei(n.UNPACK_ROW_LENGTH,Z),t.pixelStorei(n.UNPACK_SKIP_PIXELS,ie),t.pixelStorei(n.UNPACK_SKIP_ROWS,he)}}function We(b,p,L){let B=n.TEXTURE_2D;(p.isDataArrayTexture||p.isCompressedArrayTexture)&&(B=n.TEXTURE_2D_ARRAY),p.isData3DTexture&&(B=n.TEXTURE_3D);const q=ne(b,p),ue=p.source;t.bindTexture(B,b.__webglTexture,n.TEXTURE0+L);const pe=i.get(ue);if(ue.version!==pe.__version||q===!0){if(t.activeTexture(n.TEXTURE0+L),(typeof ImageBitmap<"u"&&p.image instanceof ImageBitmap)===!1){const re=et.getPrimaries(et.workingColorSpace),Me=p.colorSpace===wi?null:et.getPrimaries(p.colorSpace),we=p.colorSpace===wi||re===Me?n.NONE:n.BROWSER_DEFAULT_WEBGL;t.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,p.flipY),t.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,p.premultiplyAlpha),t.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,we)}t.pixelStorei(n.UNPACK_ALIGNMENT,p.unpackAlignment);let ie=g(p.image,!1,r.maxTextureSize);ie=Pe(p,ie);const he=s.convert(p.format,p.colorSpace),De=s.convert(p.type);let Se=_(p.internalFormat,he,De,p.normalized,p.colorSpace,p.isVideoTexture);rt(B,p);let ge;const He=p.mipmaps,Ge=p.isVideoTexture!==!0,Ze=pe.__version===void 0||q===!0,F=ue.dataReady,xe=T(p,ie);if(p.isDepthTexture)Se=A(p.format===Wi,p.type),Ze&&(Ge?t.texStorage2D(n.TEXTURE_2D,1,Se,ie.width,ie.height):t.texImage2D(n.TEXTURE_2D,0,Se,ie.width,ie.height,0,he,De,null));else if(p.isDataTexture)if(He.length>0){Ge&&Ze&&t.texStorage2D(n.TEXTURE_2D,xe,Se,He[0].width,He[0].height);for(let re=0,Me=He.length;re<Me;re++)ge=He[re],Ge?F&&t.texSubImage2D(n.TEXTURE_2D,re,0,0,ge.width,ge.height,he,De,ge.data):t.texImage2D(n.TEXTURE_2D,re,Se,ge.width,ge.height,0,he,De,ge.data);p.generateMipmaps=!1}else Ge?(Ze&&t.texStorage2D(n.TEXTURE_2D,xe,Se,ie.width,ie.height),F&&fe(p,ie,he,De)):t.texImage2D(n.TEXTURE_2D,0,Se,ie.width,ie.height,0,he,De,ie.data);else if(p.isCompressedTexture)if(p.isCompressedArrayTexture){Ge&&Ze&&t.texStorage3D(n.TEXTURE_2D_ARRAY,xe,Se,He[0].width,He[0].height,ie.depth);for(let re=0,Me=He.length;re<Me;re++)if(ge=He[re],p.format!==xn)if(he!==null)if(Ge){if(F)if(p.layerUpdates.size>0){const we=wu(ge.width,ge.height,p.format,p.type);for(const ae of p.layerUpdates){const Oe=ge.data.subarray(ae*we/ge.data.BYTES_PER_ELEMENT,(ae+1)*we/ge.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,re,0,0,ae,ge.width,ge.height,1,he,Oe)}p.clearLayerUpdates()}else t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,re,0,0,0,ge.width,ge.height,ie.depth,he,ge.data)}else t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,re,Se,ge.width,ge.height,ie.depth,0,ge.data,0,0);else qe("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ge?F&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,re,0,0,0,ge.width,ge.height,ie.depth,he,De,ge.data):t.texImage3D(n.TEXTURE_2D_ARRAY,re,Se,ge.width,ge.height,ie.depth,0,he,De,ge.data)}else{Ge&&Ze&&t.texStorage2D(n.TEXTURE_2D,xe,Se,He[0].width,He[0].height);for(let re=0,Me=He.length;re<Me;re++)ge=He[re],p.format!==xn?he!==null?Ge?F&&t.compressedTexSubImage2D(n.TEXTURE_2D,re,0,0,ge.width,ge.height,he,ge.data):t.compressedTexImage2D(n.TEXTURE_2D,re,Se,ge.width,ge.height,0,ge.data):qe("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ge?F&&t.texSubImage2D(n.TEXTURE_2D,re,0,0,ge.width,ge.height,he,De,ge.data):t.texImage2D(n.TEXTURE_2D,re,Se,ge.width,ge.height,0,he,De,ge.data)}else if(p.isDataArrayTexture)if(Ge){if(Ze&&t.texStorage3D(n.TEXTURE_2D_ARRAY,xe,Se,ie.width,ie.height,ie.depth),F)if(p.layerUpdates.size>0){const re=wu(ie.width,ie.height,p.format,p.type);for(const Me of p.layerUpdates){const we=ie.data.subarray(Me*re/ie.data.BYTES_PER_ELEMENT,(Me+1)*re/ie.data.BYTES_PER_ELEMENT);t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,Me,ie.width,ie.height,1,he,De,we)}p.clearLayerUpdates()}else t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,ie.width,ie.height,ie.depth,he,De,ie.data)}else t.texImage3D(n.TEXTURE_2D_ARRAY,0,Se,ie.width,ie.height,ie.depth,0,he,De,ie.data);else if(p.isData3DTexture)Ge?(Ze&&t.texStorage3D(n.TEXTURE_3D,xe,Se,ie.width,ie.height,ie.depth),F&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,ie.width,ie.height,ie.depth,he,De,ie.data)):t.texImage3D(n.TEXTURE_3D,0,Se,ie.width,ie.height,ie.depth,0,he,De,ie.data);else if(p.isFramebufferTexture){if(Ze)if(Ge)t.texStorage2D(n.TEXTURE_2D,xe,Se,ie.width,ie.height);else{let re=ie.width,Me=ie.height;for(let we=0;we<xe;we++)t.texImage2D(n.TEXTURE_2D,we,Se,re,Me,0,he,De,null),re>>=1,Me>>=1}}else if(p.isHTMLTexture){if("texElementImage2D"in n){const re=n.canvas;if(re.hasAttribute("layoutsubtree")||re.setAttribute("layoutsubtree","true"),ie.parentNode!==re){re.appendChild(ie),d.add(p),re.onpaint=Me=>{const we=Me.changedElements;for(const ae of d)we.includes(ae.image)&&(ae.needsUpdate=!0)},re.requestPaint();return}if(n.texElementImage2D.length===3)n.texElementImage2D(n.TEXTURE_2D,n.RGBA8,ie);else{const we=n.RGBA,ae=n.RGBA,Oe=n.UNSIGNED_BYTE;n.texElementImage2D(n.TEXTURE_2D,0,we,ae,Oe,ie)}n.texParameteri(n.TEXTURE_2D,n.TEXTURE_MIN_FILTER,n.LINEAR),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_WRAP_S,n.CLAMP_TO_EDGE),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_WRAP_T,n.CLAMP_TO_EDGE)}}else if(He.length>0){if(Ge&&Ze){const re=be(He[0]);t.texStorage2D(n.TEXTURE_2D,xe,Se,re.width,re.height)}for(let re=0,Me=He.length;re<Me;re++)ge=He[re],Ge?F&&t.texSubImage2D(n.TEXTURE_2D,re,0,0,he,De,ge):t.texImage2D(n.TEXTURE_2D,re,Se,he,De,ge);p.generateMipmaps=!1}else if(Ge){if(Ze){const re=be(ie);t.texStorage2D(n.TEXTURE_2D,xe,Se,re.width,re.height)}F&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,he,De,ie)}else t.texImage2D(n.TEXTURE_2D,0,Se,he,De,ie);h(p)&&y(B),pe.__version=ue.version,p.onUpdate&&p.onUpdate(p)}b.__version=p.version}function Xe(b,p,L){if(p.image.length!==6)return;const B=ne(b,p),q=p.source;t.bindTexture(n.TEXTURE_CUBE_MAP,b.__webglTexture,n.TEXTURE0+L);const ue=i.get(q);if(q.version!==ue.__version||B===!0){t.activeTexture(n.TEXTURE0+L);const pe=et.getPrimaries(et.workingColorSpace),Z=p.colorSpace===wi?null:et.getPrimaries(p.colorSpace),ie=p.colorSpace===wi||pe===Z?n.NONE:n.BROWSER_DEFAULT_WEBGL;t.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,p.flipY),t.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,p.premultiplyAlpha),t.pixelStorei(n.UNPACK_ALIGNMENT,p.unpackAlignment),t.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,ie);const he=p.isCompressedTexture||p.image[0].isCompressedTexture,De=p.image[0]&&p.image[0].isDataTexture,Se=[];for(let ae=0;ae<6;ae++)!he&&!De?Se[ae]=g(p.image[ae],!0,r.maxCubemapSize):Se[ae]=De?p.image[ae].image:p.image[ae],Se[ae]=Pe(p,Se[ae]);const ge=Se[0],He=s.convert(p.format,p.colorSpace),Ge=s.convert(p.type),Ze=_(p.internalFormat,He,Ge,p.normalized,p.colorSpace),F=p.isVideoTexture!==!0,xe=ue.__version===void 0||B===!0,re=q.dataReady;let Me=T(p,ge);rt(n.TEXTURE_CUBE_MAP,p);let we;if(he){F&&xe&&t.texStorage2D(n.TEXTURE_CUBE_MAP,Me,Ze,ge.width,ge.height);for(let ae=0;ae<6;ae++){we=Se[ae].mipmaps;for(let Oe=0;Oe<we.length;Oe++){const Ne=we[Oe];p.format!==xn?He!==null?F?re&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Oe,0,0,Ne.width,Ne.height,He,Ne.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Oe,Ze,Ne.width,Ne.height,0,Ne.data):qe("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):F?re&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Oe,0,0,Ne.width,Ne.height,He,Ge,Ne.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Oe,Ze,Ne.width,Ne.height,0,He,Ge,Ne.data)}}}else{if(we=p.mipmaps,F&&xe){we.length>0&&Me++;const ae=be(Se[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,Me,Ze,ae.width,ae.height)}for(let ae=0;ae<6;ae++)if(De){F?re&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0,0,0,Se[ae].width,Se[ae].height,He,Ge,Se[ae].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0,Ze,Se[ae].width,Se[ae].height,0,He,Ge,Se[ae].data);for(let Oe=0;Oe<we.length;Oe++){const bt=we[Oe].image[ae].image;F?re&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Oe+1,0,0,bt.width,bt.height,He,Ge,bt.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Oe+1,Ze,bt.width,bt.height,0,He,Ge,bt.data)}}else{F?re&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0,0,0,He,Ge,Se[ae]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0,Ze,He,Ge,Se[ae]);for(let Oe=0;Oe<we.length;Oe++){const Ne=we[Oe];F?re&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Oe+1,0,0,He,Ge,Ne.image[ae]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Oe+1,Ze,He,Ge,Ne.image[ae])}}}h(p)&&y(n.TEXTURE_CUBE_MAP),ue.__version=q.version,p.onUpdate&&p.onUpdate(p)}b.__version=p.version}function Ve(b,p,L,B,q,ue){const pe=s.convert(L.format,L.colorSpace),Z=s.convert(L.type),ie=_(L.internalFormat,pe,Z,L.normalized,L.colorSpace),he=i.get(p),De=i.get(L);if(De.__renderTarget=p,!he.__hasExternalTextures){const Se=Math.max(1,p.width>>ue),ge=Math.max(1,p.height>>ue);q===n.TEXTURE_3D||q===n.TEXTURE_2D_ARRAY?t.texImage3D(q,ue,ie,Se,ge,p.depth,0,pe,Z,null):t.texImage2D(q,ue,ie,Se,ge,0,pe,Z,null)}t.bindFramebuffer(n.FRAMEBUFFER,b),Ce(p)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,B,q,De.__webglTexture,0,j(p)):(q===n.TEXTURE_2D||q>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&q<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,B,q,De.__webglTexture,ue),t.bindFramebuffer(n.FRAMEBUFFER,null)}function C(b,p,L){if(n.bindRenderbuffer(n.RENDERBUFFER,b),p.depthBuffer){const B=p.depthTexture,q=B&&B.isDepthTexture?B.type:null,ue=A(p.stencilBuffer,q),pe=p.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;Ce(p)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,j(p),ue,p.width,p.height):L?n.renderbufferStorageMultisample(n.RENDERBUFFER,j(p),ue,p.width,p.height):n.renderbufferStorage(n.RENDERBUFFER,ue,p.width,p.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,pe,n.RENDERBUFFER,b)}else{const B=p.textures;for(let q=0;q<B.length;q++){const ue=B[q],pe=s.convert(ue.format,ue.colorSpace),Z=s.convert(ue.type),ie=_(ue.internalFormat,pe,Z,ue.normalized,ue.colorSpace);Ce(p)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,j(p),ie,p.width,p.height):L?n.renderbufferStorageMultisample(n.RENDERBUFFER,j(p),ie,p.width,p.height):n.renderbufferStorage(n.RENDERBUFFER,ie,p.width,p.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function D(b,p,L){const B=p.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(n.FRAMEBUFFER,b),!(p.depthTexture&&p.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");const q=i.get(p.depthTexture);if(q.__renderTarget=p,(!q.__webglTexture||p.depthTexture.image.width!==p.width||p.depthTexture.image.height!==p.height)&&(p.depthTexture.image.width=p.width,p.depthTexture.image.height=p.height,p.depthTexture.needsUpdate=!0),B){if(q.__webglInit===void 0&&(q.__webglInit=!0,p.depthTexture.addEventListener("dispose",P)),q.__webglTexture===void 0){q.__webglTexture=n.createTexture(),t.bindTexture(n.TEXTURE_CUBE_MAP,q.__webglTexture),rt(n.TEXTURE_CUBE_MAP,p.depthTexture);const he=s.convert(p.depthTexture.format),De=s.convert(p.depthTexture.type);let Se;p.depthTexture.format===mi?Se=n.DEPTH_COMPONENT24:p.depthTexture.format===Wi&&(Se=n.DEPTH24_STENCIL8);for(let ge=0;ge<6;ge++)n.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ge,0,Se,p.width,p.height,0,he,De,null)}}else Y(p.depthTexture,0);const ue=q.__webglTexture,pe=j(p),Z=B?n.TEXTURE_CUBE_MAP_POSITIVE_X+L:n.TEXTURE_2D,ie=p.depthTexture.format===Wi?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;if(p.depthTexture.format===mi)Ce(p)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,ie,Z,ue,0,pe):n.framebufferTexture2D(n.FRAMEBUFFER,ie,Z,ue,0);else if(p.depthTexture.format===Wi)Ce(p)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,ie,Z,ue,0,pe):n.framebufferTexture2D(n.FRAMEBUFFER,ie,Z,ue,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function W(b){const p=i.get(b),L=b.isWebGLCubeRenderTarget===!0;if(p.__boundDepthTexture!==b.depthTexture){const B=b.depthTexture;if(p.__depthDisposeCallback&&p.__depthDisposeCallback(),B){const q=()=>{delete p.__boundDepthTexture,delete p.__depthDisposeCallback,B.removeEventListener("dispose",q)};B.addEventListener("dispose",q),p.__depthDisposeCallback=q}p.__boundDepthTexture=B}if(b.depthTexture&&!p.__autoAllocateDepthBuffer)if(L)for(let B=0;B<6;B++)D(p.__webglFramebuffer[B],b,B);else{const B=b.texture.mipmaps;B&&B.length>0?D(p.__webglFramebuffer[0],b,0):D(p.__webglFramebuffer,b,0)}else if(L){p.__webglDepthbuffer=[];for(let B=0;B<6;B++)if(t.bindFramebuffer(n.FRAMEBUFFER,p.__webglFramebuffer[B]),p.__webglDepthbuffer[B]===void 0)p.__webglDepthbuffer[B]=n.createRenderbuffer(),C(p.__webglDepthbuffer[B],b,!1);else{const q=b.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ue=p.__webglDepthbuffer[B];n.bindRenderbuffer(n.RENDERBUFFER,ue),n.framebufferRenderbuffer(n.FRAMEBUFFER,q,n.RENDERBUFFER,ue)}}else{const B=b.texture.mipmaps;if(B&&B.length>0?t.bindFramebuffer(n.FRAMEBUFFER,p.__webglFramebuffer[0]):t.bindFramebuffer(n.FRAMEBUFFER,p.__webglFramebuffer),p.__webglDepthbuffer===void 0)p.__webglDepthbuffer=n.createRenderbuffer(),C(p.__webglDepthbuffer,b,!1);else{const q=b.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ue=p.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,ue),n.framebufferRenderbuffer(n.FRAMEBUFFER,q,n.RENDERBUFFER,ue)}}t.bindFramebuffer(n.FRAMEBUFFER,null)}function Q(b,p,L){const B=i.get(b);p!==void 0&&Ve(B.__webglFramebuffer,b,b.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),L!==void 0&&W(b)}function K(b){const p=b.texture,L=i.get(b),B=i.get(p);b.addEventListener("dispose",v);const q=b.textures,ue=b.isWebGLCubeRenderTarget===!0,pe=q.length>1;if(pe||(B.__webglTexture===void 0&&(B.__webglTexture=n.createTexture()),B.__version=p.version,a.memory.textures++),ue){L.__webglFramebuffer=[];for(let Z=0;Z<6;Z++)if(p.mipmaps&&p.mipmaps.length>0){L.__webglFramebuffer[Z]=[];for(let ie=0;ie<p.mipmaps.length;ie++)L.__webglFramebuffer[Z][ie]=n.createFramebuffer()}else L.__webglFramebuffer[Z]=n.createFramebuffer()}else{if(p.mipmaps&&p.mipmaps.length>0){L.__webglFramebuffer=[];for(let Z=0;Z<p.mipmaps.length;Z++)L.__webglFramebuffer[Z]=n.createFramebuffer()}else L.__webglFramebuffer=n.createFramebuffer();if(pe)for(let Z=0,ie=q.length;Z<ie;Z++){const he=i.get(q[Z]);he.__webglTexture===void 0&&(he.__webglTexture=n.createTexture(),a.memory.textures++)}if(b.samples>0&&Ce(b)===!1){L.__webglMultisampledFramebuffer=n.createFramebuffer(),L.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,L.__webglMultisampledFramebuffer);for(let Z=0;Z<q.length;Z++){const ie=q[Z];L.__webglColorRenderbuffer[Z]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,L.__webglColorRenderbuffer[Z]);const he=s.convert(ie.format,ie.colorSpace),De=s.convert(ie.type),Se=_(ie.internalFormat,he,De,ie.normalized,ie.colorSpace,b.isXRRenderTarget===!0),ge=j(b);n.renderbufferStorageMultisample(n.RENDERBUFFER,ge,Se,b.width,b.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Z,n.RENDERBUFFER,L.__webglColorRenderbuffer[Z])}n.bindRenderbuffer(n.RENDERBUFFER,null),b.depthBuffer&&(L.__webglDepthRenderbuffer=n.createRenderbuffer(),C(L.__webglDepthRenderbuffer,b,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(ue){t.bindTexture(n.TEXTURE_CUBE_MAP,B.__webglTexture),rt(n.TEXTURE_CUBE_MAP,p);for(let Z=0;Z<6;Z++)if(p.mipmaps&&p.mipmaps.length>0)for(let ie=0;ie<p.mipmaps.length;ie++)Ve(L.__webglFramebuffer[Z][ie],b,p,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ie);else Ve(L.__webglFramebuffer[Z],b,p,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0);h(p)&&y(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(pe){for(let Z=0,ie=q.length;Z<ie;Z++){const he=q[Z],De=i.get(he);let Se=n.TEXTURE_2D;(b.isWebGL3DRenderTarget||b.isWebGLArrayRenderTarget)&&(Se=b.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(Se,De.__webglTexture),rt(Se,he),Ve(L.__webglFramebuffer,b,he,n.COLOR_ATTACHMENT0+Z,Se,0),h(he)&&y(Se)}t.unbindTexture()}else{let Z=n.TEXTURE_2D;if((b.isWebGL3DRenderTarget||b.isWebGLArrayRenderTarget)&&(Z=b.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(Z,B.__webglTexture),rt(Z,p),p.mipmaps&&p.mipmaps.length>0)for(let ie=0;ie<p.mipmaps.length;ie++)Ve(L.__webglFramebuffer[ie],b,p,n.COLOR_ATTACHMENT0,Z,ie);else Ve(L.__webglFramebuffer,b,p,n.COLOR_ATTACHMENT0,Z,0);h(p)&&y(Z),t.unbindTexture()}b.depthBuffer&&W(b)}function ee(b){const p=b.textures;for(let L=0,B=p.length;L<B;L++){const q=p[L];if(h(q)){const ue=E(b),pe=i.get(q).__webglTexture;t.bindTexture(ue,pe),y(ue),t.unbindTexture()}}}const de=[],ce=[];function oe(b){if(b.samples>0){if(Ce(b)===!1){const p=b.textures,L=b.width,B=b.height;let q=n.COLOR_BUFFER_BIT;const ue=b.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,pe=i.get(b),Z=p.length>1;if(Z)for(let he=0;he<p.length;he++)t.bindFramebuffer(n.FRAMEBUFFER,pe.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+he,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,pe.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+he,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,pe.__webglMultisampledFramebuffer);const ie=b.texture.mipmaps;ie&&ie.length>0?t.bindFramebuffer(n.DRAW_FRAMEBUFFER,pe.__webglFramebuffer[0]):t.bindFramebuffer(n.DRAW_FRAMEBUFFER,pe.__webglFramebuffer);for(let he=0;he<p.length;he++){if(b.resolveDepthBuffer&&(b.depthBuffer&&(q|=n.DEPTH_BUFFER_BIT),b.stencilBuffer&&b.resolveStencilBuffer&&(q|=n.STENCIL_BUFFER_BIT)),Z){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,pe.__webglColorRenderbuffer[he]);const De=i.get(p[he]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,De,0)}n.blitFramebuffer(0,0,L,B,0,0,L,B,q,n.NEAREST),l===!0&&(de.length=0,ce.length=0,de.push(n.COLOR_ATTACHMENT0+he),b.depthBuffer&&b.resolveDepthBuffer===!1&&(de.push(ue),ce.push(ue),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,ce)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,de))}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),Z)for(let he=0;he<p.length;he++){t.bindFramebuffer(n.FRAMEBUFFER,pe.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+he,n.RENDERBUFFER,pe.__webglColorRenderbuffer[he]);const De=i.get(p[he]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,pe.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+he,n.TEXTURE_2D,De,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,pe.__webglMultisampledFramebuffer)}else if(b.depthBuffer&&b.resolveDepthBuffer===!1&&l){const p=b.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[p])}}}function j(b){return Math.min(r.maxSamples,b.samples)}function Ce(b){const p=i.get(b);return b.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&p.__useRenderToTexture!==!1}function R(b){const p=a.render.frame;u.get(b)!==p&&(u.set(b,p),b.update())}function Pe(b,p){const L=b.colorSpace,B=b.format,q=b.type;return b.isCompressedTexture===!0||b.isVideoTexture===!0||L!==pa&&L!==wi&&(et.getTransfer(L)===ft?(B!==xn||q!==un)&&qe("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):at("WebGLTextures: Unsupported texture color space:",L)),p}function be(b){return typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement?(c.width=b.naturalWidth||b.width,c.height=b.naturalHeight||b.height):typeof VideoFrame<"u"&&b instanceof VideoFrame?(c.width=b.displayWidth,c.height=b.displayHeight):(c.width=b.width,c.height=b.height),c}this.allocateTextureUnit=J,this.resetTextureUnits=te,this.getTextureUnits=se,this.setTextureUnits=V,this.setTexture2D=Y,this.setTexture2DArray=le,this.setTexture3D=_e,this.setTextureCube=ve,this.rebindTextures=Q,this.setupRenderTarget=K,this.updateRenderTargetMipmap=ee,this.updateMultisampleRenderTarget=oe,this.setupDepthRenderbuffer=W,this.setupFrameBufferTexture=Ve,this.useMultisampledRTT=Ce,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function bS(n,e){function t(i,r=wi){let s;const a=et.getTransfer(r);if(i===un)return n.UNSIGNED_BYTE;if(i===Ql)return n.UNSIGNED_SHORT_4_4_4_4;if(i===jl)return n.UNSIGNED_SHORT_5_5_5_1;if(i===gd)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===_d)return n.UNSIGNED_INT_10F_11F_11F_REV;if(i===pd)return n.BYTE;if(i===md)return n.SHORT;if(i===ls)return n.UNSIGNED_SHORT;if(i===Jl)return n.INT;if(i===Xn)return n.UNSIGNED_INT;if(i===Bn)return n.FLOAT;if(i===pi)return n.HALF_FLOAT;if(i===vd)return n.ALPHA;if(i===xd)return n.RGB;if(i===xn)return n.RGBA;if(i===mi)return n.DEPTH_COMPONENT;if(i===Wi)return n.DEPTH_STENCIL;if(i===Sd)return n.RED;if(i===ec)return n.RED_INTEGER;if(i===Zi)return n.RG;if(i===tc)return n.RG_INTEGER;if(i===nc)return n.RGBA_INTEGER;if(i===Qs||i===js||i===ea||i===ta)if(a===ft)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===Qs)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===js)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===ea)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===ta)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===Qs)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===js)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===ea)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===ta)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===jo||i===el||i===tl||i===nl)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===jo)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===el)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===tl)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===nl)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===il||i===rl||i===sl||i===al||i===ol||i===da||i===ll)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===il||i===rl)return a===ft?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===sl)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(i===al)return s.COMPRESSED_R11_EAC;if(i===ol)return s.COMPRESSED_SIGNED_R11_EAC;if(i===da)return s.COMPRESSED_RG11_EAC;if(i===ll)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===cl||i===ul||i===fl||i===dl||i===hl||i===pl||i===ml||i===gl||i===_l||i===vl||i===xl||i===Sl||i===Ml||i===bl)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===cl)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===ul)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===fl)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===dl)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===hl)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===pl)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===ml)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===gl)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===_l)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===vl)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===xl)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Sl)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Ml)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===bl)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===yl||i===El||i===Tl)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===yl)return a===ft?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===El)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Tl)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===Al||i===wl||i===ha||i===Rl)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===Al)return s.COMPRESSED_RED_RGTC1_EXT;if(i===wl)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===ha)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Rl)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===cs?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:t}}const yS=`
void main() {
...
void main() {
...
}`;class TS{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const i=new Pd(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=i}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,i=new Tn({vertexShader:yS,fragmentShader:ES,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new qn(new Na(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class AS extends ji{constructor(e,t){super();const i=this;let r=null,s=1,a=null,o="local-floor",l=1,c=null,u=null,d=null,f=null,m=null,x=null;const M=typeof XRWebGLBinding<"u",g=new TS,h={},y=t.getContextAttributes();let E=null,_=null;const A=[],T=[],P=new nt;let v=null;const w=new cn;w.viewport=new Et;const N=new cn;N.viewport=new Et;const I=[w,N],k=new Fg;let te=null,se=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(ne){let me=A[ne];return me===void 0&&(me=new lo,A[ne]=me),me.getTargetRaySpace()},this.getControllerGrip=function(ne){let me=A[ne];return me===void 0&&(me=new lo,A[ne]=me),me.getGripSpace()},this.getHand=function(ne){let me=A[ne];return me===void 0&&(me=new lo,A[ne]=me),me.getHandSpace()};function V(ne){const me=T.indexOf(ne.inputSource);if(me===-1)return;const fe=A[me];fe!==void 0&&(fe.update(ne.inputSource,ne.frame,c||a),fe.dispatchEvent({type:ne.type,data:ne.inputSource}))}function J(){r.removeEventListener("select",V),r.removeEventListener("selectstart",V),r.removeEventListener("selectend",V),r.removeEventListener("squeeze",V),r.removeEventListener("squeezestart",V),r.removeEventListener("squeezeend",V),r.removeEventListener("end",J),r.removeEventListener("inputsourceschange",z);for(let ne=0;ne<A.length;ne++){const me=T[ne];me!==null&&(T[ne]=null,A[ne].disconnect(me))}te=null,se=null,g.reset();for(const ne in h)delete h[ne];e.setRenderTarget(E),m=null,f=null,d=null,r=null,_=null,rt.stop(),i.isPresenting=!1,e.setPixelRatio(v),e.setSize(P.width,P.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(ne){s=ne,i.isPresenting===!0&&qe("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(ne){o=ne,i.isPresenting===!0&&qe("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(ne){c=ne},this.getBaseLayer=function(){return f!==null?f:m},this.getBinding=function(){return d===null&&M&&(d=new XRWebGLBinding(r,t)),d},this.getFrame=function(){return x},this.getSession=function(){return r},this.setSession=async function(ne){if(r=ne,r!==null){if(E=e.getRenderTarget(),r.addEventListener("select",V),r.addEventListener("selectstart",V),r.addEventListener("selectend",V),r.addEventListener("squeeze",V),r.addEventListener("squeezestart",V),r.addEventListener("squeezeend",V),r.addEventListener("end",J),r.addEventListener("inputsourceschange",z),y.xrCompatible!==!0&&await t.makeXRCompatible(),v=e.getPixelRatio(),e.getSize(P),M&&"createProjectionLayer"in XRWebGLBinding.prototype){let fe=null,We=null,Xe=null;y.depth&&(Xe=y.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,fe=y.stencil?Wi:mi,We=y.stencil?cs:Xn);const Ve={colorFormat:t.RGBA8,depthFormat:Xe,scaleFactor:s};d=this.getBinding(),f=d.createProjectionLayer(Ve),r.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),_=new Vn(f.textureWidth,f.textureHeight,{format:xn,type:un,depthTexture:new Cr(f.textureWidth,f.textureHeight,We,void 0,void 0,void 0,void 0,void 0,void 0,fe),stencilBuffer:y.stencil,colorSpace:e.outputColorSpace,samples:y.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{const fe={antialias:y.antialias,alpha:!0,depth:y.depth,stencil:y.stencil,framebufferScaleFactor:s};m=new XRWebGLLayer(r,t,fe),r.updateRenderState({baseLayer:m}),e.setPixelRatio(1),e.setSize(m.framebufferWidth,m.framebufferHeight,!1),_=new Vn(m.framebufferWidth,m.framebufferHeight,{format:xn,type:un,colorSpace:e.outputColorSpace,stencilBuffer:y.stencil,resolveDepthBuffer:m.ignoreDepthValues===!1,resolveStencilBuffer:m.ignoreDepthValues===!1})}_.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await r.requestReferenceSpace(o),rt.setContext(r),rt.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return g.getDepthTexture()};function z(ne){for(let me=0;me<ne.removed.length;me++){const fe=ne.removed[me],We=T.indexOf(fe);We>=0&&(T[We]=null,A[We].disconnect(fe))}for(let me=0;me<ne.added.length;me++){const fe=ne.added[me];let We=T.indexOf(fe);if(We===-1){for(let Ve=0;Ve<A.length;Ve++)if(Ve>=T.length){T.push(fe),We=Ve;break}else if(T[Ve]===null){T[Ve]=fe,We=Ve;break}if(We===-1)break}const Xe=A[We];Xe&&Xe.connect(fe)}}const Y=new H,le=new H;function _e(ne,me,fe){Y.setFromMatrixPosition(me.matrixWorld),le.setFromMatrixPosition(fe.matrixWorld);const We=Y.distanceTo(le),Xe=me.projectionMatrix.elements,Ve=fe.projectionMatrix.elements,C=Xe[14]/(Xe[10]-1),D=Xe[14]/(Xe[10]+1),W=(Xe[9]+1)/Xe[5],Q=(Xe[9]-1)/Xe[5],K=(Xe[8]-1)/Xe[0],ee=(Ve[8]+1)/Ve[0],de=C*K,ce=C*ee,oe=We/(-K+ee),j=oe*-K;if(me.matrixWorld.decompose(ne.position,ne.quaternion,ne.scale),ne.translateX(j),ne.translateZ(oe),ne.matrixWorld.compose(ne.position,ne.quaternion,ne.scale),ne.matrixWorldInverse.copy(ne.matrixWorld).invert(),Xe[10]===-1)ne.projectionMatrix.copy(me.projectionMatrix),ne.projectionMatrixInverse.copy(me.projectionMatrixInverse);else{const Ce=C+oe,R=D+oe,Pe=de-j,be=ce+(We-j),b=W*D/R*Ce,p=Q*D/R*Ce;ne.projectionMatrix.makePerspective(Pe,be,b,p,Ce,R),ne.projectionMatrixInverse.copy(ne.projectionMatrix).invert()}}function ve(ne,me){me===null?ne.matrixWorld.copy(ne.matrix):ne.matrixWorld.multiplyMatrices(me.matrixWorld,ne.matrix),ne.matrixWorldInverse.copy(ne.matrixWorld).invert()}this.updateCamera=function(ne){if(r===null)return;let me=ne.near,fe=ne.far;g.texture!==null&&(g.depthNear>0&&(me=g.depthNear),g.depthFar>0&&(fe=g.depthFar)),k.near=N.near=w.near=me,k.far=N.far=w.far=fe,(te!==k.near||se!==k.far)&&(r.updateRenderState({depthNear:k.near,depthFar:k.far}),te=k.near,se=k.far),k.layers.mask=ne.layers.mask|6,w.layers.mask=k.layers.mask&-5,N.layers.mask=k.layers.mask&-3;const We=ne.parent,Xe=k.cameras;ve(k,We);for(let Ve=0;Ve<Xe.length;Ve++)ve(Xe[Ve],We);Xe.length===2?_e(k,w,N):k.projectionMatrix.copy(w.projectionMatrix),Ee(ne,k,We)};function Ee(ne,me,fe){fe===null?ne.matrix.copy(me.matrixWorld):(ne.matrix.copy(fe.matrixWorld),ne.matrix.invert(),ne.matrix.multiply(me.matrixWorld)),ne.matrix.decompose(ne.position,ne.quaternion,ne.scale),ne.updateMatrixWorld(!0),ne.projectionMatrix.copy(me.projectionMatrix),ne.projectionMatrixInverse.copy(me.projectionMatrixInverse),ne.isPerspectiveCamera&&(ne.fov=Cl*2*Math.atan(1/ne.projectionMatrix.elements[5]),ne.zoom=1)}this.getCamera=function(){return k},this.getFoveation=function(){if(!(f===null&&m===null))return l},this.setFoveation=function(ne){l=ne,f!==null&&(f.fixedFoveation=ne),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=ne)},this.hasDepthSensing=function(){return g.texture!==null},this.getDepthSensingMesh=function(){return g.getMesh(k)},this.getCameraTexture=function(ne){return h[ne]};let it=null;function St(ne,me){if(u=me.getViewerPose(c||a),x=me,u!==null){const fe=u.views;m!==null&&(e.setRenderTargetFramebuffer(_,m.framebuffer),e.setRenderTarget(_));let We=!1;fe.length!==k.cameras.length&&(k.cameras.length=0,We=!0);for(let D=0;D<fe.length;D++){const W=fe[D];let Q=null;if(m!==null)Q=m.getViewport(W);else{const ee=d.getViewSubImage(f,W);Q=ee.viewport,D===0&&(e.setRenderTargetTextures(_,ee.colorTexture,ee.depthStencilTexture),e.setRenderTarget(_))}let K=I[D];K===void 0&&(K=new cn,K.layers.enable(D),K.viewport=new Et,I[D]=K),K.matrix.fromArray(W.transform.matrix),K.matrix.decompose(K.position,K.quaternion,K.scale),K.projectionMatrix.fromArray(W.projectionMatrix),K.projectionMatrixInverse.copy(K.projectionMatrix).invert(),K.viewport.set(Q.x,Q.y,Q.width,Q.height),D===0&&(k.matrix.copy(K.matrix),k.matrix.decompose(k.position,k.quaternion,k.scale)),We===!0&&k.cameras.push(K)}const Xe=r.enabledFeatures;if(Xe&&Xe.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&M){d=i.getBinding();const D=d.getDepthInformation(fe[0]);D&&D.isValid&&D.texture&&g.init(D,r.renderState)}if(Xe&&Xe.includes("camera-access")&&M){e.state.unbindTexture(),d=i.getBinding();for(let D=0;D<fe.length;D++){const W=fe[D].camera;if(W){let Q=h[W];Q||(Q=new Pd,h[W]=Q);const K=d.getCameraImage(W);Q.sourceTexture=K}}}}for(let fe=0;fe<A.length;fe++){const We=T[fe],Xe=A[fe];We!==null&&Xe!==void 0&&Xe.update(We,me,c||a)}it&&it(ne,me),me.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:me}),x=null}const rt=new Ud;rt.setAnimationLoop(St),this.setAnimationLoop=function(ne){it=ne},this.dispose=function(){}}}const wS=new Ct,Hd=new Ye;Hd.set(-1,0,0,0,1,0,0,0,1);function RS(n,e){function t(g,h){g.matrixAutoUpdate===!0&&g.updateMatrix(),h.value.copy(g.matrix)}function i(g,h){h.color.getRGB(g.fogColor.value,Dd(n)),h.isFog?(g.fogNear.value=h.near,g.fogFar.value=h.far):h.isFogExp2&&(g.fogDensity.value=h.density)}function r(g,h,y,E,_){h.isNodeMaterial?h.uniformsNeedUpdate=!1:h.isMeshBasicMaterial?s(g,h):h.isMeshLambertMaterial?(s(g,h),h.envMap&&(g.envMapIntensity.value=h.envMapIntensity)):h.isMeshToonMaterial?(s(g,h),d(g,h)):h.isMeshPhongMaterial?(s(g,h),u(g,h),h.envMap&&(g.envMapIntensity.value=h.envMapIntensity)):h.isMeshStandardMaterial?(s(g,h),f(g,h),h.isMeshPhysicalMaterial&&m(g,h,_)):h.isMeshMatcapMaterial?(s(g,h),x(g,h)):h.isMeshDepthMaterial?s(g,h):h.isMeshDistanceMaterial?(s(g,h),M(g,h)):h.isMeshNormalMaterial?s(g,h):h.isLineBasicMaterial?(a(g,h),h.isLineDashedMaterial&&o(g,h)):h.isPointsMaterial?l(g,h,y,E):h.isSpriteMaterial?c(g,h):h.isShadowMaterial?(g.color.value.copy(h.color),g.opacity.value=h.opacity):h.isShaderMaterial&&(h.uniformsNeedUpdate=!1)}function s(g,h){g.opacity.value=h.opacity,h.color&&g.diffuse.value.copy(h.color),h.emissive&&g.emissive.value.copy(h.emissive).multiplyScalar(h.emissiveIntensity),h.map&&(g.map.value=h.map,t(h.map,g.mapTransform)),h.alphaMap&&(g.alphaMap.value=h.alphaMap,t(h.alphaMap,g.alphaMapTransform)),h.bumpMap&&(g.bumpMap.value=h.bumpMap,t(h.bumpMap,g.bumpMapTransform),g.bumpScale.value=h.bumpScale,h.side===Qt&&(g.bumpScale.value*=-1)),h.normalMap&&(g.normalMap.value=h.normalMap,t(h.normalMap,g.normalMapTransform),g.normalScale.value.copy(h.normalScale),h.side===Qt&&g.normalScale.value.negate()),h.displacementMap&&(g.displacementMap.value=h.displacementMap,t(h.displacementMap,g.displacementMapTransform),g.displacementScale.value=h.displacementScale,g.displacementBias.value=h.displacementBias),h.emissiveMap&&(g.emissiveMap.value=h.emissiveMap,t(h.emissiveMap,g.emissiveMapTransform)),h.specularMap&&(g.specularMap.value=h.specularMap,t(h.specularMap,g.specularMapTransform)),h.alphaTest>0&&(g.alphaTest.value=h.alphaTest);const y=e.get(h),E=y.envMap,_=y.envMapRotation;E&&(g.envMap.value=E,g.envMapRotation.value.setFromMatrix4(wS.makeRotationFromEuler(_)).transpose(),E.isCubeTexture&&E.isRenderTargetTexture===!1&&g.envMapRotation.value.premultiply(Hd),g.reflectivity.value=h.reflectivity,g.ior.value=h.ior,g.refractionRatio.value=h.refractionRatio),h.lightMap&&(g.lightMap.value=h.lightMap,g.lightMapIntensity.value=h.lightMapIntensity,t(h.lightMap,g.lightMapTransform)),h.aoMap&&(g.aoMap.value=h.aoMap,g.aoMapIntensity.value=h.aoMapIntensity,t(h.aoMap,g.aoMapTransform))}function a(g,h){g.diffuse.value.copy(h.color),g.opacity.value=h.opacity,h.map&&(g.map.value=h.map,t(h.map,g.mapTransform))}function o(g,h){g.dashSize.value=h.dashSize,g.totalSize.value=h.dashSize+h.gapSize,g.scale.value=h.scale}function l(g,h,y,E){g.diffuse.value.copy(h.color),g.opacity.value=h.opacity,g.size.value=h.size*y,g.scale.value=E*.5,h.map&&(g.map.value=h.map,t(h.map,g.uvTransform)),h.alphaMap&&(g.alphaMap.value=h.alphaMap,t(h.alphaMap,g.alphaMapTransform)),h.alphaTest>0&&(g.alphaTest.value=h.alphaTest)}function c(g,h){g.diffuse.value.copy(h.color),g.opacity.value=h.opacity,g.rotation.value=h.rotation,h.map&&(g.map.value=h.map,t(h.map,g.mapTransform)),h.alphaMap&&(g.alphaMap.value=h.alphaMap,t(h.alphaMap,g.alphaMapTransform)),h.alphaTest>0&&(g.alphaTest.value=h.alphaTest)}function u(g,h){g.specular.value.copy(h.specular),g.shininess.value=Math.max(h.shininess,1e-4)}function d(g,h){h.gradientMap&&(g.gradientMap.value=h.gradientMap)}function f(g,h){g.metalness.value=h.metalness,h.metalnessMap&&(g.metalnessMap.value=h.metalnessMap,t(h.metalnessMap,g.metalnessMapTransform)),g.roughness.value=h.roughness,h.roughnessMap&&(g.roughnessMap.value=h.roughnessMap,t(h.roughnessMap,g.roughnessMapTransform)),h.envMap&&(g.envMapIntensity.value=h.envMapIntensity)}function m(g,h,y){g.ior.value=h.ior,h.sheen>0&&(g.sheenColor.value.copy(h.sheenColor).multiplyScalar(h.sheen),g.sheenRoughness.value=h.sheenRoughness,h.sheenColorMap&&(g.sheenColorMap.value=h.sheenColorMap,t(h.sheenColorMap,g.sheenColorMapTransform)),h.sheenRoughnessMap&&(g.sheenRoughnessMap.value=h.sheenRoughnessMap,t(h.sheenRoughnessMap,g.sheenRoughnessMapTransform))),h.clearcoat>0&&(g.clearcoat.value=h.clearcoat,g.clearcoatRoughness.value=h.clearcoatRoughness,h.clearcoatMap&&(g.clearcoatMap.value=h.clearcoatMap,t(h.clearcoatMap,g.clearcoatMapTransform)),h.clearcoatRoughnessMap&&(g.clearcoatRoughnessMap.value=h.clearcoatRoughnessMap,t(h.clearcoatRoughnessMap,g.clearcoatRoughnessMapTransform)),h.clearcoatNormalMap&&(g.clearcoatNormalMap.value=h.clearcoatNormalMap,t(h.clearcoatNormalMap,g.clearcoatNormalMapTransform),g.clearcoatNormalScale.value.copy(h.clearcoatNormalScale),h.side===Qt&&g.clearcoatNormalScale.value.negate())),h.dispersion>0&&(g.dispersion.value=h.dispersion),h.iridescence>0&&(g.iridescence.value=h.iridescence,g.iridescenceIOR.value=h.iridescenceIOR,g.iridescenceThicknessMinimum.value=h.iridescenceThicknessRange[0],g.iridescenceThicknessMaximum.value=h.iridescenceThicknessRange[1],h.iridescenceMap&&(g.iridescenceMap.value=h.iridescenceMap,t(h.iridescenceMap,g.iridescenceMapTransform)),h.iridescenceThicknessMap&&(g.iridescenceThicknessMap.value=h.iridescenceThicknessMap,t(h.iridescenceThicknessMap,g.iridescenceThicknessMapTransform))),h.transmission>0&&(g.transmission.value=h.transmission,g.transmissionSamplerMap.value=y.texture,g.transmissionSamplerSize.value.set(y.width,y.height),h.transmissionMap&&(g.transmissionMap.value=h.transmissionMap,t(h.transmissionMap,g.transmissionMapTransform)),g.thickness.value=h.thickness,h.thicknessMap&&(g.thicknessMap.value=h.thicknessMap,t(h.thicknessMap,g.thicknessMapTransform)),g.attenuationDistance.value=h.attenuationDistance,g.attenuationColor.value.copy(h.attenuationColor)),h.anisotropy>0&&(g.anisotropyVector.value.set(h.anisotropy*Math.cos(h.anisotropyRotation),h.anisotropy*Math.sin(h.anisotropyRotation)),h.anisotropyMap&&(g.anisotropyMap.value=h.anisotropyMap,t(h.anisotropyMap,g.anisotropyMapTransform))),g.specularIntensity.value=h.specularIntensity,g.specularColor.value.copy(h.specularColor),h.specularColorMap&&(g.specularColorMap.value=h.specularColorMap,t(h.specularColorMap,g.specularColorMapTransform)),h.specularIntensityMap&&(g.specularIntensityMap.value=h.specularIntensityMap,t(h.specularIntensityMap,g.specularIntensityMapTransform))}function x(g,h){h.matcap&&(g.matcap.value=h.matcap)}function M(g,h){const y=e.get(h).light;g.referencePosition.value.setFromMatrixPosition(y.matrixWorld),g.nearDistance.value=y.shadow.camera.near,g.farDistance.value=y.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function CS(n,e,t,i){let r={},s={},a=[];const o=n.getParameter(n.MAX_UNIFORM_BUFFER_BINDINGS);function l(_,A){const T=A.program;i.uniformBlockBinding(_,T)}function c(_,A){let T=r[_.id];T===void 0&&(g(_),T=u(_),r[_.id]=T,_.addEventListener("dispose",y));const P=A.program;i.updateUBOMapping(_,P);const v=e.render.frame;s[_.id]!==v&&(f(_),s[_.id]=v)}function u(_){const A=d();_.__bindingPointIndex=A;const T=n.createBuffer(),P=_.__size,v=_.usage;return n.bindBuffer(n.UNIFORM_BUFFER,T),n.bufferData(n.UNIFORM_BUFFER,P,v),n.bindBuffer(n.UNIFORM_BUFFER,null),n.bindBufferBase(n.UNIFORM_BUFFER,A,T),T}function d(){for(let _=0;_<o;_++)if(a.indexOf(_)===-1)return a.push(_),_;return at("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(_){const A=r[_.id],T=_.uniforms,P=_.__cache;n.bindBuffer(n.UNIFORM_BUFFER,A);for(let v=0,w=T.length;v<w;v++){const N=T[v];if(Array.isArray(N))for(let I=0,k=N.length;I<k;I++)m(N[I],v,I,P);else m(N,v,0,P)}n.bindBuffer(n.UNIFORM_BUFFER,null)}function m(_,A,T,P){if(M(_,A,T,P)===!0){const v=_.__offset,w=_.value;if(Array.isArray(w)){let N=0;for(let I=0;I<w.length;I++){const k=w[I],te=h(k);x(k,_.__data,N),typeof k!="number"&&typeof k!="boolean"&&!k.isMatrix3&&!ArrayBuffer.isView(k)&&(N+=te.storage/Float32Array.BYTES_PER_ELEMENT)}}else x(w,_.__data,0);n.bufferSubData(n.UNIFORM_BUFFER,v,_.__data)}}function x(_,A,T){typeof _=="number"||typeof _=="boolean"?A[0]=_:_.isMatrix3?(A[0]=_.elements[0],A[1]=_.elements[1],A[2]=_.elements[2],A[3]=0,A[4]=_.elements[3],A[5]=_.elements[4],A[6]=_.elements[5],A[7]=0,A[8]=_.elements[6],A[9]=_.elements[7],A[10]=_.elements[8],A[11]=0):ArrayBuffer.isView(_)?A.set(new _.constructor(_.buffer,_.byteOffset,A.length)):_.toArray(A,T)}function M(_,A,T,P){const v=_.value,w=A+"_"+T;if(P[w]===void 0)return typeof v=="number"||typeof v=="boolean"?P[w]=v:ArrayBuffer.isView(v)?P[w]=v.slice():P[w]=v.clone(),!0;{const N=P[w];if(typeof v=="number"||typeof v=="boolean"){if(N!==v)return P[w]=v,!0}else{if(ArrayBuffer.isView(v))return!0;if(N.equals(v)===!1)return N.copy(v),!0}}return!1}function g(_){const A=_.uniforms;let T=0;const P=16;for(let w=0,N=A.length;w<N;w++){const I=Array.isArray(A[w])?A[w]:[A[w]];for(let k=0,te=I.length;k<te;k++){const se=I[k],V=Array.isArray(se.value)?se.value:[se.value];for(let J=0,z=V.length;J<z;J++){const Y=V[J],le=h(Y),_e=T%P,ve=_e%le.boundary,Ee=_e+ve;T+=ve,Ee!==0&&P-Ee<le.storage&&(T+=P-Ee),se.__data=new Float32Array(le.storage/Float32Array.BYTES_PER_ELEMENT),se.__offset=T,T+=le.storage}}}const v=T%P;return v>0&&(T+=P-v),_.__size=T,_.__cache={},this}function h(_){const A={boundary:0,storage:0};return typeof _=="number"||typeof _=="boolean"?(A.boundary=4,A.storage=4):_.isVector2?(A.boundary=8,A.storage=8):_.isVector3||_.isColor?(A.boundary=16,A.storage=12):_.isVector4?(A.boundary=16,A.storage=16):_.isMatrix3?(A.boundary=48,A.storage=48):_.isMatrix4?(A.boundary=64,A.storage=64):_.isTexture?qe("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(_)?(A.boundary=16,A.storage=_.byteLength):qe("WebGLRenderer: Unsupported uniform value type.",_),A}function y(_){const A=_.target;A.removeEventListener("dispose",y);const T=a.indexOf(A.__bindingPointIndex);a.splice(T,1),n.deleteBuffer(r[A.id]),delete r[A.id],delete s[A.id]}function E(){for(const _ in r)n.deleteBuffer(r[_]);a=[],r={},s={}}return{bind:l,update:c,dispose:E}}const PS=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let In=null;function DS(){return In===null&&(In=new yg(PS,16,16,Zi,pi),In.name="DFG_LUT",In.minFilter=Ht,In.magFilter=Ht,In.wrapS=oi,In.wrapT=oi,In.generateMipmaps=!1,In.needsUpdate=!0),In}class IS{constructor(e={}){const{canvas:t=jm(),context:i=null,depth:r=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:d=!1,reversedDepthBuffer:f=!1,outputBufferType:m=un}=e;this.isWebGLRenderer=!0;let x;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");x=i.getContextAttributes().alpha}else x=a;const M=m,g=new Set([nc,tc,ec]),h=new Set([un,Xn,ls,cs,Ql,jl]),y=new Uint32Array(4),E=new Int32Array(4),_=new H;let A=null,T=null;const P=[],v=[];let w=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Hn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const N=this;let I=!1,k=null,te=null,se=null,V=null;this._outputColorSpace=nn;let J=0,z=0,Y=null,le=-1,_e=null;const ve=new Et,Ee=new Et;let it=null;const St=new ut(0);let rt=0,ne=t.width,me=t.height,fe=1,We=null,Xe=null;const Ve=new Et(0,0,ne,me),C=new Et(0,0,ne,me);let D=!1;const W=new Rd;let Q=!1,K=!1;const ee=new Ct,de=new H,ce=new Et,oe={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let j=!1;function Ce(){return Y===null?fe:1}let R=i;function Pe(S,O){return t.getContext(S,O)}try{const S={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:d};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${Zl}`),t.addEventListener("webglcontextlost",bt,!1),t.addEventListener("webglcontextrestored",_t,!1),t.addEventListener("webglcontextcreationerror",wn,!1),R===null){const O="webgl2";if(R=Pe(O,S),R===null)throw Pe(O)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}}catch(S){throw at("WebGLRenderer: "+S.message),S}let be,b,p,L,B,q,ue,pe,Z,ie,he,De,Se,ge,He,Ge,Ze,F,xe,re,Me,we,ae;function Oe(){be=new Dv(R),be.init(),Me=new bS(R,be),b=new yv(R,be,e,Me),p=new SS(R,be),b.reversedDepthBuffer&&f&&p.buffers.depth.setReversed(!0),te=R.createFramebuffer(),se=R.createFramebuffer(),V=R.createFramebuffer(),L=new Uv(R),B=new aS,q=new MS(R,be,p,B,b,Me,L),ue=new Pv(N),pe=new Bg(R),we=new Mv(R,pe),Z=new Iv(R,pe,L,we),ie=new Fv(R,Z,pe,we,L),F=new Nv(R,b,q),He=new Ev(B),he=new sS(N,ue,be,b,we,He),De=new RS(N,B),Se=new lS,ge=new pS(be),Ze=new Sv(N,ue,p,ie,x,l),Ge=new xS(N,ie,b),ae=new CS(R,L,b,p),xe=new bv(R,be,L),re=new Lv(R,be,L),L.programs=he.programs,N.capabilities=b,N.extensions=be,N.properties=B,N.renderLists=Se,N.shadowMap=Ge,N.state=p,N.info=L}Oe(),M!==un&&(w=new Bv(M,t.width,t.height,o,r,s));const Ne=new AS(N,R);this.xr=Ne,this.getContext=function(){return R},this.getContextAttributes=function(){return R.getContextAttributes()},this.forceContextLoss=function(){const S=be.get("WEBGL_lose_context");S&&S.loseContext()},this.forceContextRestore=function(){const S=be.get("WEBGL_lose_context");S&&S.restoreContext()},this.getPixelRatio=function(){return fe},this.setPixelRatio=function(S){S!==void 0&&(fe=S,this.setSize(ne,me,!1))},this.getSize=function(S){return S.set(ne,me)},this.setSize=function(S,O,$=!0){if(Ne.isPresenting){qe("WebGLRenderer: Can't change size while VR device is presenting.");return}ne=S,me=O,t.width=Math.floor(S*fe),t.height=Math.floor(O*fe),$===!0&&(t.style.width=S+"px",t.style.height=O+"px"),w!==null&&w.setSize(t.width,t.height),this.setViewport(0,0,S,O)},this.getDrawingBufferSize=function(S){return S.set(ne*fe,me*fe).floor()},this.setDrawingBufferSize=function(S,O,$){ne=S,me=O,fe=$,t.width=Math.floor(S*$),t.height=Math.floor(O*$),this.setViewport(0,0,S,O)},this.setEffects=function(S){if(M===un){at("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(S){for(let O=0;O<S.length;O++)if(S[O].isOutputPass===!0){qe("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}w.setEffects(S||[])},this.getCurrentViewport=function(S){return S.copy(ve)},this.getViewport=function(S){return S.copy(Ve)},this.setViewport=function(S,O,$,G){S.isVector4?Ve.set(S.x,S.y,S.z,S.w):Ve.set(S,O,$,G),p.viewport(ve.copy(Ve).multiplyScalar(fe).round())},this.getScissor=function(S){return S.copy(C)},this.setScissor=function(S,O,$,G){S.isVector4?C.set(S.x,S.y,S.z,S.w):C.set(S,O,$,G),p.scissor(Ee.copy(C).multiplyScalar(fe).round())},this.getScissorTest=function(){return D},this.setScissorTest=function(S){p.setScissorTest(D=S)},this.setOpaqueSort=function(S){We=S},this.setTransparentSort=function(S){Xe=S},this.getClearColor=function(S){return S.copy(Ze.getClearColor())},this.setClearColor=function(){Ze.setClearColor(...arguments)},this.getClearAlpha=function(){return Ze.getClearAlpha()},this.setClearAlpha=function(){Ze.setClearAlpha(...arguments)},this.clear=function(S=!0,O=!0,$=!0){let G=0;if(S){let X=!1;if(Y!==null){const Ae=Y.texture.format;X=g.has(Ae)}if(X){const Ae=Y.texture.type,Ue=h.has(Ae),Te=Ze.getClearColor(),Fe=Ze.getClearAlpha(),Be=Te.r,Je=Te.g,je=Te.b;Ue?(y[0]=Be,y[1]=Je,y[2]=je,y[3]=Fe,R.clearBufferuiv(R.COLOR,0,y)):(E[0]=Be,E[1]=Je,E[2]=je,E[3]=Fe,R.clearBufferiv(R.COLOR,0,E))}else G|=R.COLOR_BUFFER_BIT}O&&(G|=R.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),$&&(G|=R.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),G!==0&&R.clear(G)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(S){S.setRenderer(this),k=S},this.dispose=function(){t.removeEventListener("webglcontextlost",bt,!1),t.removeEventListener("webglcontextrestored",_t,!1),t.removeEventListener("webglcontextcreationerror",wn,!1),Ze.dispose(),Se.dispose(),ge.dispose(),B.dispose(),ue.dispose(),ie.dispose(),we.dispose(),ae.dispose(),he.dispose(),Ne.dispose(),Ne.removeEventListener("sessionstart",mc),Ne.removeEventListener("sessionend",gc),Ii.stop()};function bt(S){S.preventDefault(),lu("WebGLRenderer: Context Lost."),I=!0}function _t(){lu("WebGLRenderer: Context Restored."),I=!1;const S=L.autoReset,O=Ge.enabled,$=Ge.autoUpdate,G=Ge.needsUpdate,X=Ge.type;Oe(),L.autoReset=S,Ge.enabled=O,Ge.autoUpdate=$,Ge.needsUpdate=G,Ge.type=X}function wn(S){at("WebGLRenderer: A WebGL context could not be created. Reason: ",S.statusMessage)}function Rn(S){const O=S.target;O.removeEventListener("dispose",Rn),Vd(O)}function Vd(S){Gd(S),B.remove(S)}function Gd(S){const O=B.get(S).programs;O!==void 0&&(O.forEach(function($){he.releaseProgram($)}),S.isShaderMaterial&&he.releaseShaderCache(S))}this.renderBufferDirect=function(S,O,$,G,X,Ae){O===null&&(O=oe);const Ue=X.isMesh&&X.matrixWorld.determinantAffine()<0,Te=qd(S,O,$,G,X);p.setMaterial(G,Ue);let Fe=$.index,Be=1;if(G.wireframe===!0){if(Fe=Z.getWireframeAttribute($),Fe===void 0)return;Be=2}const Je=$.drawRange,je=$.attributes.position;let ze=Je.start*Be,dt=(Je.start+Je.count)*Be;Ae!==null&&(ze=Math.max(ze,Ae.start*Be),dt=Math.min(dt,(Ae.start+Ae.count)*Be)),Fe!==null?(ze=Math.max(ze,0),dt=Math.min(dt,Fe.count)):je!=null&&(ze=Math.max(ze,0),dt=Math.min(dt,je.count));const At=dt-ze;if(At<0||At===1/0)return;we.setup(X,G,Te,$,Fe);let yt,pt=xe;if(Fe!==null&&(yt=pe.get(Fe),pt=re,pt.setIndex(yt)),X.isMesh)G.wireframe===!0?(p.setLineWidth(G.wireframeLinewidth*Ce()),pt.setMode(R.LINES)):pt.setMode(R.TRIANGLES);else if(X.isLine){let Ot=G.linewidth;Ot===void 0&&(Ot=1),p.setLineWidth(Ot*Ce()),X.isLineSegments?pt.setMode(R.LINES):X.isLineLoop?pt.setMode(R.LINE_LOOP):pt.setMode(R.LINE_STRIP)}else X.isPoints?pt.setMode(R.POINTS):X.isSprite&&pt.setMode(R.TRIANGLES);if(X.isBatchedMesh)if(be.get("WEBGL_multi_draw"))pt.renderMultiDraw(X._multiDrawStarts,X._multiDrawCounts,X._multiDrawCount);else{const Ot=X._multiDrawStarts,Ie=X._multiDrawCounts,jt=X._multiDrawCount,st=Fe?pe.get(Fe).bytesPerElement:1,on=B.get(G).currentProgram.getUniforms();for(let Cn=0;Cn<jt;Cn++)on.setValue(R,"_gl_DrawID",Cn),pt.render(Ot[Cn]/st,Ie[Cn])}else if(X.isInstancedMesh)pt.renderInstances(ze,At,X.count);else if($.isInstancedBufferGeometry){const Ot=$._maxInstanceCount!==void 0?$._maxInstanceCount:1/0,Ie=Math.min($.instanceCount,Ot);pt.renderInstances(ze,At,Ie)}else pt.render(ze,At)};function pc(S,O,$){S.transparent===!0&&S.side===ri&&S.forceSinglePass===!1?(S.side=Qt,S.needsUpdate=!0,_s(S,O,$),S.side=Di,S.needsUpdate=!0,_s(S,O,$),S.side=ri):_s(S,O,$)}this.compile=function(S,O,$=null){$===null&&($=S),T=ge.get($),T.init(O),v.push(T),$.traverseVisible(function(X){X.isLight&&X.layers.test(O.layers)&&(T.pushLight(X),X.castShadow&&T.pushShadow(X))}),S!==$&&S.traverseVisible(function(X){X.isLight&&X.layers.test(O.layers)&&(T.pushLight(X),X.castShadow&&T.pushShadow(X))}),T.setupLights();const G=new Set;return S.traverse(function(X){if(!(X.isMesh||X.isPoints||X.isLine||X.isSprite))return;const Ae=X.material;if(Ae)if(Array.isArray(Ae))for(let Ue=0;Ue<Ae.length;Ue++){const Te=Ae[Ue];pc(Te,$,X),G.add(Te)}else pc(Ae,$,X),G.add(Ae)}),T=v.pop(),G},this.compileAsync=function(S,O,$=null){const G=this.compile(S,O,$);return new Promise(X=>{function Ae(){if(G.forEach(function(Ue){B.get(Ue).currentProgram.isReady()&&G.delete(Ue)}),G.size===0){X(S);return}setTimeout(Ae,10)}be.get("KHR_parallel_shader_compile")!==null?Ae():setTimeout(Ae,10)})};let Ba=null;function Wd(S){Ba&&Ba(S)}function mc(){Ii.stop()}function gc(){Ii.start()}const Ii=new Ud;Ii.setAnimationLoop(Wd),typeof self<"u"&&Ii.setContext(self),this.setAnimationLoop=function(S){Ba=S,Ne.setAnimationLoop(S),S===null?Ii.stop():Ii.start()},Ne.addEventListener("sessionstart",mc),Ne.addEventListener("sessionend",gc),this.render=function(S,O){if(O!==void 0&&O.isCamera!==!0){at("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(I===!0)return;k!==null&&k.renderStart(S,O);const $=Ne.enabled===!0&&Ne.isPresenting===!0,G=w!==null&&(Y===null||$)&&w.begin(N,Y);if(S.matrixWorldAutoUpdate===!0&&S.updateMatrixWorld(),O.parent===null&&O.matrixWorldAutoUpdate===!0&&O.updateMatrixWorld(),Ne.enabled===!0&&Ne.isPresenting===!0&&(w===null||w.isCompositing()===!1)&&(Ne.cameraAutoUpdate===!0&&Ne.updateCamera(O),O=Ne.getCamera()),S.isScene===!0&&S.onBeforeRender(N,S,O,Y),T=ge.get(S,v.length),T.init(O),T.state.textureUnits=q.getTextureUnits(),v.push(T),ee.multiplyMatrices(O.projectionMatrix,O.matrixWorldInverse),W.setFromProjectionMatrix(ee,zn,O.reversedDepth),K=this.localClippingEnabled,Q=He.init(this.clippingPlanes,K),A=Se.get(S,P.length),A.init(),P.push(A),Ne.enabled===!0&&Ne.isPresenting===!0){const Ue=N.xr.getDepthSensingMesh();Ue!==null&&za(Ue,O,-1/0,N.sortObjects)}za(S,O,0,N.sortObjects),A.finish(),N.sortObjects===!0&&A.sort(We,Xe,O.reversedDepth),j=Ne.enabled===!1||Ne.isPresenting===!1||Ne.hasDepthSensing()===!1,j&&Ze.addToRenderList(A,S),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),Q===!0&&He.beginShadows();const X=T.state.shadowsArray;if(Ge.render(X,S,O),Q===!0&&He.endShadows(),(G&&w.hasRenderPass())===!1){const Ue=A.opaque,Te=A.transmissive;if(T.setupLights(),O.isArrayCamera){const Fe=O.cameras;if(Te.length>0)for(let Be=0,Je=Fe.length;Be<Je;Be++){const je=Fe[Be];vc(Ue,Te,S,je)}j&&Ze.render(S);for(let Be=0,Je=Fe.length;Be<Je;Be++){const je=Fe[Be];_c(A,S,je,je.viewport)}}else Te.length>0&&vc(Ue,Te,S,O),j&&Ze.render(S),_c(A,S,O)}Y!==null&&z===0&&(q.updateMultisampleRenderTarget(Y),q.updateRenderTargetMipmap(Y)),G&&w.end(N),S.isScene===!0&&S.onAfterRender(N,S,O),we.resetDefaultState(),le=-1,_e=null,v.pop(),v.length>0?(T=v[v.length-1],q.setTextureUnits(T.state.textureUnits),Q===!0&&He.setGlobalState(N.clippingPlanes,T.state.camera)):T=null,P.pop(),P.length>0?A=P[P.length-1]:A=null,k!==null&&k.renderEnd()};function za(S,O,$,G){if(S.visible===!1)return;if(S.layers.test(O.layers)){if(S.isGroup)$=S.renderOrder;else if(S.isLOD)S.autoUpdate===!0&&S.update(O);else if(S.isLightProbeGrid)T.pushLightProbeGrid(S);else if(S.isLight)T.pushLight(S),S.castShadow&&T.pushShadow(S);else if(S.isSprite){if(!S.frustumCulled||W.intersectsSprite(S)){G&&ce.setFromMatrixPosition(S.matrixWorld).applyMatrix4(ee);const Ue=ie.update(S),Te=S.material;Te.visible&&A.push(S,Ue,Te,$,ce.z,null)}}else if((S.isMesh||S.isLine||S.isPoints)&&(!S.frustumCulled||W.intersectsObject(S))){const Ue=ie.update(S),Te=S.material;if(G&&(S.boundingSphere!==void 0?(S.boundingSphere===null&&S.computeBoundingSphere(),ce.copy(S.boundingSphere.center)):(Ue.boundingSphere===null&&Ue.computeBoundingSphere(),ce.copy(Ue.boundingSphere.center)),ce.applyMatrix4(S.matrixWorld).applyMatrix4(ee)),Array.isArray(Te)){const Fe=Ue.groups;for(let Be=0,Je=Fe.length;Be<Je;Be++){const je=Fe[Be],ze=Te[je.materialIndex];ze&&ze.visible&&A.push(S,Ue,ze,$,ce.z,je)}}else Te.visible&&A.push(S,Ue,Te,$,ce.z,null)}}const Ae=S.children;for(let Ue=0,Te=Ae.length;Ue<Te;Ue++)za(Ae[Ue],O,$,G)}function _c(S,O,$,G){const{opaque:X,transmissive:Ae,transparent:Ue}=S;T.setupLightsView($),Q===!0&&He.setGlobalState(N.clippingPlanes,$),G&&p.viewport(ve.copy(G)),X.length>0&&gs(X,O,$),Ae.length>0&&gs(Ae,O,$),Ue.length>0&&gs(Ue,O,$),p.buffers.depth.setTest(!0),p.buffers.depth.setMask(!0),p.buffers.color.setMask(!0),p.setPolygonOffset(!1)}function vc(S,O,$,G){if(($.isScene===!0?$.overrideMaterial:null)!==null)return;if(T.state.transmissionRenderTarget[G.id]===void 0){const ze=be.has("EXT_color_buffer_half_float")||be.has("EXT_color_buffer_float");T.state.transmissionRenderTarget[G.id]=new Vn(1,1,{generateMipmaps:!0,type:ze?pi:un,minFilter:Gi,samples:Math.max(4,b.samples),stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:et.workingColorSpace})}const Ae=T.state.transmissionRenderTarget[G.id],Ue=G.viewport||ve;Ae.setSize(Ue.z*N.transmissionResolutionScale,Ue.w*N.transmissionResolutionScale);const Te=N.getRenderTarget(),Fe=N.getActiveCubeFace(),Be=N.getActiveMipmapLevel();N.setRenderTarget(Ae),N.getClearColor(St),rt=N.getClearAlpha(),rt<1&&N.setClearColor(16777215,.5),N.clear(),j&&Ze.render($);const Je=N.toneMapping;N.toneMapping=Hn;const je=G.viewport;if(G.viewport!==void 0&&(G.viewport=void 0),T.setupLightsView(G),Q===!0&&He.setGlobalState(N.clippingPlanes,G),gs(S,$,G),q.updateMultisampleRenderTarget(Ae),q.updateRenderTargetMipmap(Ae),be.has("WEBGL_multisampled_render_to_texture")===!1){let ze=!1;for(let dt=0,At=O.length;dt<At;dt++){const yt=O[dt],{object:pt,geometry:Ot,material:Ie,group:jt}=yt;if(Ie.side===ri&&pt.layers.test(G.layers)){const st=Ie.side;Ie.side=Qt,Ie.needsUpdate=!0,xc(pt,$,G,Ot,Ie,jt),Ie.side=st,Ie.needsUpdate=!0,ze=!0}}ze===!0&&(q.updateMultisampleRenderTarget(Ae),q.updateRenderTargetMipmap(Ae))}N.setRenderTarget(Te,Fe,Be),N.setClearColor(St,rt),je!==void 0&&(G.viewport=je),N.toneMapping=Je}function gs(S,O,$){const G=O.isScene===!0?O.overrideMaterial:null;for(let X=0,Ae=S.length;X<Ae;X++){const Ue=S[X],{object:Te,geometry:Fe,group:Be}=Ue;let Je=Ue.material;Je.allowOverride===!0&&G!==null&&(Je=G),Te.layers.test($.layers)&&xc(Te,O,$,Fe,Je,Be)}}function xc(S,O,$,G,X,Ae){S.onBeforeRender(N,O,$,G,X,Ae),S.modelViewMatrix.multiplyMatrices($.matrixWorldInverse,S.matrixWorld),S.normalMatrix.getNormalMatrix(S.modelViewMatrix),X.onBeforeRender(N,O,$,G,S,Ae),X.transparent===!0&&X.side===ri&&X.forceSinglePass===!1?(X.side=Qt,X.needsUpdate=!0,N.renderBufferDirect($,O,G,X,S,Ae),X.side=Di,X.needsUpdate=!0,N.renderBufferDirect($,O,G,X,S,Ae),X.side=ri):N.renderBufferDirect($,O,G,X,S,Ae),S.onAfterRender(N,O,$,G,X,Ae)}function _s(S,O,$){O.isScene!==!0&&(O=oe);const G=B.get(S),X=T.state.lights,Ae=T.state.shadowsArray,Ue=X.state.version,Te=he.getParameters(S,X.state,Ae,O,$,T.state.lightProbeGridArray),Fe=he.getProgramCacheKey(Te);let Be=G.programs;G.environment=S.isMeshStandardMaterial||S.isMeshLambertMaterial||S.isMeshPhongMaterial?O.environment:null,G.fog=O.fog;const Je=S.isMeshStandardMaterial||S.isMeshLambertMaterial&&!S.envMap||S.isMeshPhongMaterial&&!S.envMap;G.envMap=ue.get(S.envMap||G.environment,Je),G.envMapRotation=G.environment!==null&&S.envMap===null?O.environmentRotation:S.envMapRotation,Be===void 0&&(S.addEventListener("dispose",Rn),Be=new Map,G.programs=Be);let je=Be.get(Fe);if(je!==void 0){if(G.currentProgram===je&&G.lightsStateVersion===Ue)return Mc(S,Te),je}else Te.uniforms=he.getUniforms(S),k!==null&&S.isNodeMaterial&&k.build(S,$,Te),S.onBeforeCompile(Te,N),je=he.acquireProgram(Te,Fe),Be.set(Fe,je),G.uniforms=Te.uniforms;const ze=G.uniforms;return(!S.isShaderMaterial&&!S.isRawShaderMaterial||S.clipping===!0)&&(ze.clippingPlanes=He.uniform),Mc(S,Te),G.needsLights=Yd(S),G.lightsStateVersion=Ue,G.needsLights&&(ze.ambientLightColor.value=X.state.ambient,ze.lightProbe.value=X.state.probe,ze.directionalLights.value=X.state.directional,ze.directionalLightShadows.value=X.state.directionalShadow,ze.spotLights.value=X.state.spot,ze.spotLightShadows.value=X.state.spotShadow,ze.rectAreaLights.value=X.state.rectArea,ze.ltc_1.value=X.state.rectAreaLTC1,ze.ltc_2.value=X.state.rectAreaLTC2,ze.pointLights.value=X.state.point,ze.pointLightShadows.value=X.state.pointShadow,ze.hemisphereLights.value=X.state.hemi,ze.directionalShadowMatrix.value=X.state.directionalShadowMatrix,ze.spotLightMatrix.value=X.state.spotLightMatrix,ze.spotLightMap.value=X.state.spotLightMap,ze.pointShadowMatrix.value=X.state.pointShadowMatrix),G.lightProbeGrid=T.state.lightProbeGridArray.length>0,G.currentProgram=je,G.uniformsList=null,je}function Sc(S){if(S.uniformsList===null){const O=S.currentProgram.getUniforms();S.uniformsList=na.seqWithValue(O.seq,S.uniforms)}return S.uniformsList}function Mc(S,O){const $=B.get(S);$.outputColorSpace=O.outputColorSpace,$.batching=O.batching,$.batchingColor=O.batchingColor,$.instancing=O.instancing,$.instancingColor=O.instancingColor,$.instancingMorph=O.instancingMorph,$.skinning=O.skinning,$.morphTargets=O.morphTargets,$.morphNormals=O.morphNormals,$.morphColors=O.morphColors,$.morphTargetsCount=O.morphTargetsCount,$.numClippingPlanes=O.numClippingPlanes,$.numIntersection=O.numClipIntersection,$.vertexAlphas=O.vertexAlphas,$.vertexTangents=O.vertexTangents,$.toneMapping=O.toneMapping}function Xd(S,O){if(S.length===0)return null;if(S.length===1)return S[0].texture!==null?S[0]:null;_.setFromMatrixPosition(O.matrixWorld);for(let $=0,G=S.length;$<G;$++){const X=S[$];if(X.texture!==null&&X.boundingBox.containsPoint(_))return X}return null}function qd(S,O,$,G,X){O.isScene!==!0&&(O=oe),q.resetTextureUnits();const Ae=O.fog,Ue=G.isMeshStandardMaterial||G.isMeshLambertMaterial||G.isMeshPhongMaterial?O.environment:null,Te=Y===null?N.outputColorSpace:Y.isXRRenderTarget===!0?Y.texture.colorSpace:et.workingColorSpace,Fe=G.isMeshStandardMaterial||G.isMeshLambertMaterial&&!G.envMap||G.isMeshPhongMaterial&&!G.envMap,Be=ue.get(G.envMap||Ue,Fe),Je=G.vertexColors===!0&&!!$.attributes.color&&$.attributes.color.itemSize===4,je=!!$.attributes.tangent&&(!!G.normalMap||G.anisotropy>0),ze=!!$.morphAttributes.position,dt=!!$.morphAttributes.normal,At=!!$.morphAttributes.color;let yt=Hn;G.toneMapped&&(Y===null||Y.isXRRenderTarget===!0)&&(yt=N.toneMapping);const pt=$.morphAttributes.position||$.morphAttributes.normal||$.morphAttributes.color,Ot=pt!==void 0?pt.length:0,Ie=B.get(G),jt=T.state.lights;if(Q===!0&&(K===!0||S!==_e)){const vt=S===_e&&G.id===le;He.setState(G,S,vt)}let st=!1;G.version===Ie.__version?(Ie.needsLights&&Ie.lightsStateVersion!==jt.state.version||Ie.outputColorSpace!==Te||X.isBatchedMesh&&Ie.batching===!1||!X.isBatchedMesh&&Ie.batching===!0||X.isBatchedMesh&&Ie.batchingColor===!0&&X.colorTexture===null||X.isBatchedMesh&&Ie.batchingColor===!1&&X.colorTexture!==null||X.isInstancedMesh&&Ie.instancing===!1||!X.isInstancedMesh&&Ie.instancing===!0||X.isSkinnedMesh&&Ie.skinning===!1||!X.isSkinnedMesh&&Ie.skinning===!0||X.isInstancedMesh&&Ie.instancingColor===!0&&X.instanceColor===null||X.isInstancedMesh&&Ie.instancingColor===!1&&X.instanceColor!==null||X.isInstancedMesh&&Ie.instancingMorph===!0&&X.morphTexture===null||X.isInstancedMesh&&Ie.instancingMorph===!1&&X.morphTexture!==null||Ie.envMap!==Be||G.fog===!0&&Ie.fog!==Ae||Ie.numClippingPlanes!==void 0&&(Ie.numClippingPlanes!==He.numPlanes||Ie.numIntersection!==He.numIntersection)||Ie.vertexAlphas!==Je||Ie.vertexTangents!==je||Ie.morphTargets!==ze||Ie.morphNormals!==dt||Ie.morphColors!==At||Ie.toneMapping!==yt||Ie.morphTargetsCount!==Ot||!!Ie.lightProbeGrid!=T.state.lightProbeGridArray.length>0)&&(st=!0):(st=!0,Ie.__version=G.version);let on=Ie.currentProgram;st===!0&&(on=_s(G,O,X),k&&G.isNodeMaterial&&k.onUpdateProgram(G,on,Ie));let Cn=!1,_i=!1,er=!1;const mt=on.getUniforms(),wt=Ie.uniforms;if(p.useProgram(on.program)&&(Cn=!0,_i=!0,er=!0),G.id!==le&&(le=G.id,_i=!0),Ie.needsLights){const vt=Xd(T.state.lightProbeGridArray,X);Ie.lightProbeGrid!==vt&&(Ie.lightProbeGrid=vt,_i=!0)}if(Cn||_e!==S){p.buffers.depth.getReversed()&&S.reversedDepth!==!0&&(S._reversedDepth=!0,S.updateProjectionMatrix()),mt.setValue(R,"projectionMatrix",S.projectionMatrix),mt.setValue(R,"viewMatrix",S.matrixWorldInverse);const xi=mt.map.cameraPosition;xi!==void 0&&xi.setValue(R,de.setFromMatrixPosition(S.matrixWorld)),b.logarithmicDepthBuffer&&mt.setValue(R,"logDepthBufFC",2/(Math.log(S.far+1)/Math.LN2)),(G.isMeshPhongMaterial||G.isMeshToonMaterial||G.isMeshLambertMaterial||G.isMeshBasicMaterial||G.isMeshStandardMaterial||G.isShaderMaterial)&&mt.setValue(R,"isOrthographic",S.isOrthographicCamera===!0),_e!==S&&(_e=S,_i=!0,er=!0)}if(Ie.needsLights&&(jt.state.directionalShadowMap.length>0&&mt.setValue(R,"directionalShadowMap",jt.state.directionalShadowMap,q),jt.state.spotShadowMap.length>0&&mt.setValue(R,"spotShadowMap",jt.state.spotShadowMap,q),jt.state.pointShadowMap.length>0&&mt.setValue(R,"pointShadowMap",jt.state.pointShadowMap,q)),X.isSkinnedMesh){mt.setOptional(R,X,"bindMatrix"),mt.setOptional(R,X,"bindMatrixInverse");const vt=X.skeleton;vt&&(vt.boneTexture===null&&vt.computeBoneTexture(),mt.setValue(R,"boneTexture",vt.boneTexture,q))}X.isBatchedMesh&&(mt.setOptional(R,X,"batchingTexture"),mt.setValue(R,"batchingTexture",X._matricesTexture,q),mt.setOptional(R,X,"batchingIdTexture"),mt.setValue(R,"batchingIdTexture",X._indirectTexture,q),mt.setOptional(R,X,"batchingColorTexture"),X._colorsTexture!==null&&mt.setValue(R,"batchingColorTexture",X._colorsTexture,q));const vi=$.morphAttributes;if((vi.position!==void 0||vi.normal!==void 0||vi.color!==void 0)&&F.update(X,$,on),(_i||Ie.receiveShadow!==X.receiveShadow)&&(Ie.receiveShadow=X.receiveShadow,mt.setValue(R,"receiveShadow",X.receiveShadow)),(G.isMeshStandardMaterial||G.isMeshLambertMaterial||G.isMeshPhongMaterial)&&G.envMap===null&&O.environment!==null&&(wt.envMapIntensity.value=O.environmentIntensity),wt.dfgLUT!==void 0&&(wt.dfgLUT.value=DS()),_i){if(mt.setValue(R,"toneMappingExposure",N.toneMappingExposure),Ie.needsLights&&$d(wt,er),Ae&&G.fog===!0&&De.refreshFogUniforms(wt,Ae),De.refreshMaterialUniforms(wt,G,fe,me,T.state.transmissionRenderTarget[S.id]),Ie.needsLights&&Ie.lightProbeGrid){const vt=Ie.lightProbeGrid;wt.probesSH.value=vt.texture,wt.probesMin.value.copy(vt.boundingBox.min),wt.probesMax.value.copy(vt.boundingBox.max),wt.probesResolution.value.copy(vt.resolution)}na.upload(R,Sc(Ie),wt,q)}if(G.isShaderMaterial&&G.uniformsNeedUpdate===!0&&(na.upload(R,Sc(Ie),wt,q),G.uniformsNeedUpdate=!1),G.isSpriteMaterial&&mt.setValue(R,"center",X.center),mt.setValue(R,"modelViewMatrix",X.modelViewMatrix),mt.setValue(R,"normalMatrix",X.normalMatrix),mt.setValue(R,"modelMatrix",X.matrixWorld),G.uniformsGroups!==void 0){const vt=G.uniformsGroups;for(let xi=0,tr=vt.length;xi<tr;xi++){const bc=vt[xi];ae.update(bc,on),ae.bind(bc,on)}}return on}function $d(S,O){S.ambientLightColor.needsUpdate=O,S.lightProbe.needsUpdate=O,S.directionalLights.needsUpdate=O,S.directionalLightShadows.needsUpdate=O,S.pointLights.needsUpdate=O,S.pointLightShadows.needsUpdate=O,S.spotLights.needsUpdate=O,S.spotLightShadows.needsUpdate=O,S.rectAreaLights.needsUpdate=O,S.hemisphereLights.needsUpdate=O}function Yd(S){return S.isMeshLambertMaterial||S.isMeshToonMaterial||S.isMeshPhongMaterial||S.isMeshStandardMaterial||S.isShadowMaterial||S.isShaderMaterial&&S.lights===!0}this.getActiveCubeFace=function(){return J},this.getActiveMipmapLevel=function(){return z},this.getRenderTarget=function(){return Y},this.setRenderTargetTextures=function(S,O,$){const G=B.get(S);G.__autoAllocateDepthBuffer=S.resolveDepthBuffer===!1,G.__autoAllocateDepthBuffer===!1&&(G.__useRenderToTexture=!1),B.get(S.texture).__webglTexture=O,B.get(S.depthTexture).__webglTexture=G.__autoAllocateDepthBuffer?void 0:$,G.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(S,O){const $=B.get(S);$.__webglFramebuffer=O,$.__useDefaultFramebuffer=O===void 0},this.setRenderTarget=function(S,O=0,$=0){Y=S,J=O,z=$;let G=null,X=!1,Ae=!1;if(S){const Te=B.get(S);if(Te.__useDefaultFramebuffer!==void 0){p.bindFramebuffer(R.FRAMEBUFFER,Te.__webglFramebuffer),ve.copy(S.viewport),Ee.copy(S.scissor),it=S.scissorTest,p.viewport(ve),p.scissor(Ee),p.setScissorTest(it),le=-1;return}else if(Te.__webglFramebuffer===void 0)q.setupRenderTarget(S);else if(Te.__hasExternalTextures)q.rebindTextures(S,B.get(S.texture).__webglTexture,B.get(S.depthTexture).__webglTexture);else if(S.depthBuffer){const Je=S.depthTexture;if(Te.__boundDepthTexture!==Je){if(Je!==null&&B.has(Je)&&(S.width!==Je.image.width||S.height!==Je.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");q.setupDepthRenderbuffer(S)}}const Fe=S.texture;(Fe.isData3DTexture||Fe.isDataArrayTexture||Fe.isCompressedArrayTexture)&&(Ae=!0);const Be=B.get(S).__webglFramebuffer;S.isWebGLCubeRenderTarget?(Array.isArray(Be[O])?G=Be[O][$]:G=Be[O],X=!0):S.samples>0&&q.useMultisampledRTT(S)===!1?G=B.get(S).__webglMultisampledFramebuffer:Array.isArray(Be)?G=Be[$]:G=Be,ve.copy(S.viewport),Ee.copy(S.scissor),it=S.scissorTest}else ve.copy(Ve).multiplyScalar(fe).floor(),Ee.copy(C).multiplyScalar(fe).floor(),it=D;if($!==0&&(G=te),p.bindFramebuffer(R.FRAMEBUFFER,G)&&p.drawBuffers(S,G),p.viewport(ve),p.scissor(Ee),p.setScissorTest(it),X){const Te=B.get(S.texture);R.framebufferTexture2D(R.FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_CUBE_MAP_POSITIVE_X+O,Te.__webglTexture,$)}else if(Ae){const Te=O;for(let Fe=0;Fe<S.textures.length;Fe++){const Be=B.get(S.textures[Fe]);R.framebufferTextureLayer(R.FRAMEBUFFER,R.COLOR_ATTACHMENT0+Fe,Be.__webglTexture,$,Te)}}else if(S!==null&&$!==0){const Te=B.get(S.texture);R.framebufferTexture2D(R.FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_2D,Te.__webglTexture,$)}le=-1},this.readRenderTargetPixels=function(S,O,$,G,X,Ae,Ue,Te=0){if(!(S&&S.isWebGLRenderTarget)){at("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Fe=B.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&Ue!==void 0&&(Fe=Fe[Ue]),Fe){p.bindFramebuffer(R.FRAMEBUFFER,Fe);try{const Be=S.textures[Te],Je=Be.format,je=Be.type;if(S.textures.length>1&&R.readBuffer(R.COLOR_ATTACHMENT0+Te),!b.textureFormatReadable(Je)){at("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!b.textureTypeReadable(je)){at("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}O>=0&&O<=S.width-G&&$>=0&&$<=S.height-X&&R.readPixels(O,$,G,X,Me.convert(Je),Me.convert(je),Ae)}finally{const Be=Y!==null?B.get(Y).__webglFramebuffer:null;p.bindFramebuffer(R.FRAMEBUFFER,Be)}}},this.readRenderTargetPixelsAsync=async function(S,O,$,G,X,Ae,Ue,Te=0){if(!(S&&S.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Fe=B.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&Ue!==void 0&&(Fe=Fe[Ue]),Fe)if(O>=0&&O<=S.width-G&&$>=0&&$<=S.height-X){p.bindFramebuffer(R.FRAMEBUFFER,Fe);const Be=S.textures[Te],Je=Be.format,je=Be.type;if(S.textures.length>1&&R.readBuffer(R.COLOR_ATTACHMENT0+Te),!b.textureFormatReadable(Je))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!b.textureTypeReadable(je))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const ze=R.createBuffer();R.bindBuffer(R.PIXEL_PACK_BUFFER,ze),R.bufferData(R.PIXEL_PACK_BUFFER,Ae.byteLength,R.STREAM_READ),R.readPixels(O,$,G,X,Me.convert(Je),Me.convert(je),0);const dt=Y!==null?B.get(Y).__webglFramebuffer:null;p.bindFramebuffer(R.FRAMEBUFFER,dt);const At=R.fenceSync(R.SYNC_GPU_COMMANDS_COMPLETE,0);return R.flush(),await eg(R,At,4),R.bindBuffer(R.PIXEL_PACK_BUFFER,ze),R.getBufferSubData(R.PIXEL_PACK_BUFFER,0,Ae),R.deleteBuffer(ze),R.deleteSync(At),Ae}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(S,O=null,$=0){const G=Math.pow(2,-$),X=Math.floor(S.image.width*G),Ae=Math.floor(S.image.height*G),Ue=O!==null?O.x:0,Te=O!==null?O.y:0;q.setTexture2D(S,0),R.copyTexSubImage2D(R.TEXTURE_2D,$,0,0,Ue,Te,X,Ae),p.unbindTexture()},this.copyTextureToTexture=function(S,O,$=null,G=null,X=0,Ae=0){let Ue,Te,Fe,Be,Je,je,ze,dt,At;const yt=S.isCompressedTexture?S.mipmaps[Ae]:S.image;if($!==null)Ue=$.max.x-$.min.x,Te=$.max.y-$.min.y,Fe=$.isBox3?$.max.z-$.min.z:1,Be=$.min.x,Je=$.min.y,je=$.isBox3?$.min.z:0;else{const wt=Math.pow(2,-X);Ue=Math.floor(yt.width*wt),Te=Math.floor(yt.height*wt),S.isDataArrayTexture?Fe=yt.depth:S.isData3DTexture?Fe=Math.floor(yt.depth*wt):Fe=1,Be=0,Je=0,je=0}G!==null?(ze=G.x,dt=G.y,At=G.z):(ze=0,dt=0,At=0);const pt=Me.convert(O.format),Ot=Me.convert(O.type);let Ie;O.isData3DTexture?(q.setTexture3D(O,0),Ie=R.TEXTURE_3D):O.isDataArrayTexture||O.isCompressedArrayTexture?(q.setTexture2DArray(O,0),Ie=R.TEXTURE_2D_ARRAY):(q.setTexture2D(O,0),Ie=R.TEXTURE_2D),p.activeTexture(R.TEXTURE0),p.pixelStorei(R.UNPACK_FLIP_Y_WEBGL,O.flipY),p.pixelStorei(R.UNPACK_PREMULTIPLY_ALPHA_WEBGL,O.premultiplyAlpha),p.pixelStorei(R.UNPACK_ALIGNMENT,O.unpackAlignment);const jt=p.getParameter(R.UNPACK_ROW_LENGTH),st=p.getParameter(R.UNPACK_IMAGE_HEIGHT),on=p.getParameter(R.UNPACK_SKIP_PIXELS),Cn=p.getParameter(R.UNPACK_SKIP_ROWS),_i=p.getParameter(R.UNPACK_SKIP_IMAGES);p.pixelStorei(R.UNPACK_ROW_LENGTH,yt.width),p.pixelStorei(R.UNPACK_IMAGE_HEIGHT,yt.height),p.pixelStorei(R.UNPACK_SKIP_PIXELS,Be),p.pixelStorei(R.UNPACK_SKIP_ROWS,Je),p.pixelStorei(R.UNPACK_SKIP_IMAGES,je);const er=S.isDataArrayTexture||S.isData3DTexture,mt=O.isDataArrayTexture||O.isData3DTexture;if(S.isDepthTexture){const wt=B.get(S),vi=B.get(O),vt=B.get(wt.__renderTarget),xi=B.get(vi.__renderTarget);p.bindFramebuffer(R.READ_FRAMEBUFFER,vt.__webglFramebuffer),p.bindFramebuffer(R.DRAW_FRAMEBUFFER,xi.__webglFramebuffer);for(let tr=0;tr<Fe;tr++)er&&(R.framebufferTextureLayer(R.READ_FRAMEBUFFER,R.COLOR_ATTACHMENT0,B.get(S).__webglTexture,X,je+tr),R.framebufferTextureLayer(R.DRAW_FRAMEBUFFER,R.COLOR_ATTACHMENT0,B.get(O).__webglTexture,Ae,At+tr)),R.blitFramebuffer(Be,Je,Ue,Te,ze,dt,Ue,Te,R.DEPTH_BUFFER_BIT,R.NEAREST);p.bindFramebuffer(R.READ_FRAMEBUFFER,null),p.bindFramebuffer(R.DRAW_FRAMEBUFFER,null)}else if(X!==0||S.isRenderTargetTexture||B.has(S)){const wt=B.get(S),vi=B.get(O);p.bindFramebuffer(R.READ_FRAMEBUFFER,se),p.bindFramebuffer(R.DRAW_FRAMEBUFFER,V);for(let vt=0;vt<Fe;vt++)er?R.framebufferTextureLayer(R.READ_FRAMEBUFFER,R.COLOR_ATTACHMENT0,wt.__webglTexture,X,je+vt):R.framebufferTexture2D(R.READ_FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_2D,wt.__webglTexture,X),mt?R.framebufferTextureLayer(R.DRAW_FRAMEBUFFER,R.COLOR_ATTACHMENT0,vi.__webglTexture,Ae,At+vt):R.framebufferTexture2D(R.DRAW_FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_2D,vi.__webglTexture,Ae),X!==0?R.blitFramebuffer(Be,Je,Ue,Te,ze,dt,Ue,Te,R.COLOR_BUFFER_BIT,R.NEAREST):mt?R.copyTexSubImage3D(Ie,Ae,ze,dt,At+vt,Be,Je,Ue,Te):R.copyTexSubImage2D(Ie,Ae,ze,dt,Be,Je,Ue,Te);p.bindFramebuffer(R.READ_FRAMEBUFFER,null),p.bindFramebuffer(R.DRAW_FRAMEBUFFER,null)}else mt?S.isDataTexture||S.isData3DTexture?R.texSubImage3D(Ie,Ae,ze,dt,At,Ue,Te,Fe,pt,Ot,yt.data):O.isCompressedArrayTexture?R.compressedTexSubImage3D(Ie,Ae,ze,dt,At,Ue,Te,Fe,pt,yt.data):R.texSubImage3D(Ie,Ae,ze,dt,At,Ue,Te,Fe,pt,Ot,yt):S.isDataTexture?R.texSubImage2D(R.TEXTURE_2D,Ae,ze,dt,Ue,Te,pt,Ot,yt.data):S.isCompressedTexture?R.compressedTexSubImage2D(R.TEXTURE_2D,Ae,ze,dt,yt.width,yt.height,pt,yt.data):R.texSubImage2D(R.TEXTURE_2D,Ae,ze,dt,Ue,Te,pt,Ot,yt);p.pixelStorei(R.UNPACK_ROW_LENGTH,jt),p.pixelStorei(R.UNPACK_IMAGE_HEIGHT,st),p.pixelStorei(R.UNPACK_SKIP_PIXELS,on),p.pixelStorei(R.UNPACK_SKIP_ROWS,Cn),p.pixelStorei(R.UNPACK_SKIP_IMAGES,_i),Ae===0&&O.generateMipmaps&&R.generateMipmap(Ie),p.unbindTexture()},this.initRenderTarget=function(S){B.get(S).__webglFramebuffer===void 0&&q.setupRenderTarget(S)},this.initTexture=function(S){S.isCubeTexture?q.setTextureCube(S,0):S.isData3DTexture?q.setTexture3D(S,0):S.isDataArrayTexture||S.isCompressedArrayTexture?q.setTexture2DArray(S,0):q.setTexture2D(S,0),p.unbindTexture()},this.resetState=function(){J=0,z=0,Y=null,p.reset(),we.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return zn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=et._getDrawingBufferColorSpace(e),t.unpackColorSpace=et._getUnpackColorSpace()}}const LS={class:"hero",id:"hero"},US={class:"container"},NS={class:"hero-visual fade-in-down"},FS=An({__name:"Hero",setup(n){const e=ot(null);let t=null,i=0,r=null;return Ra(()=>{if(!e.value)return;const s=new gg,a=new cn(42,1,.1,100);a.position.z=5.8,t=new IS({alpha:!0,antialias:!0}),t.setPixelRatio(Math.min(window.devicePixelRatio,2)),t.outputColorSpace=nn,e.value.appendChild(t.domElement);const o={uTime:{value:0},uPointer:{value:new nt(0,0)}},l=new lc(1.55,64),c=new Tn({uniforms:o,vertexShader:`
      uniform float uTime;
    ...
    `}),u=new qn(l,c);s.add(u);const d=()=>{if(!e.value||!t)return;const{clientWidth:x,clientHeight:M}=e.value;a.aspect=x/M,a.updateProjectionMatrix(),t.setSize(x,M,!1)},f=x=>{if(!e.value)return;const M=e.value.getBoundingClientRect();o.uPointer.value.set(((x.clientX-M.left)/M.width-.5)*2,-((x.clientY-M.top)/M.height-.5)*2)},m=x=>{o.uTime.value=x*.001,u.rotation.y=x*12e-5,u.rotation.x=Math.sin(x*25e-5)*.12,t==null||t.render(s,a),i=requestAnimationFrame(m)};d(),window.addEventListener("resize",d),e.value.addEventListener("pointermove",f),i=requestAnimationFrame(m),r=()=>{var x;cancelAnimationFrame(i),window.removeEventListener("resize",d),(x=e.value)==null||x.removeEventListener("pointermove",f),l.dispose(),c.dispose(),t==null||t.dispose(),t==null||t.domElement.remove(),t=null}}),Lf(()=>r==null?void 0:r()),(s,a)=>(Re(),Le("section",LS,[U("div",US,[a[1]||(a[1]=Ir('<div class="hero-content fade-in-up" data-v-50e234d5><h1 data-v-50e234d5>Hi, I&#39;m Behzad Kazemi</h1><p class="subtitle" data-v-50e234d5>Frontend Developer | Software Engineer</p><p class="description" data-v-50e234d5> I build beautiful and functional web applications using modern technologies like Vue.js, React, and TypeScript. Based in Berlin 🇩🇪, I&#39;m passionate about creating seamless user experiences and clean code. </p><div class="hero-buttons" data-v-50e234d5><a href="#contact" class="btn-primary" data-v-50e234d5>Get In Touch</a><a href="https://github.com/behzadkazemi" target="_blank" rel="noopener noreferrer" class="btn-secondary" data-v-50e234d5> View My Work </a></div></div>',1)),U("div",NS,[U("div",{ref_key:"sceneHost",ref:e,class:"liquid-scene","aria-hidden":"true"},null,512),a[0]||(a[0]=U("div",{class:"scene-caption"},"Creative systems / Berlin",-1))])])]))}}),OS=an(FS,[["__scopeId","data-v-50e234d5"]]),BS={},zS={class:"about",id:"about"};function kS(n,e){return Re(),Le("section",zS,[...e[0]||(e[0]=[Ir('<div class="container" data-v-0ace5747><div class="section-title" data-v-0ace5747><h2 data-v-0ace5747>About Me</h2></div><div class="about-content grid grid-2" data-v-0ace5747><div class="about-text fade-in-up" data-v-0ace5747><p data-v-0ace5747> I&#39;m a Software Engineer with a Master&#39;s degree in IT, based in Berlin with a passion for building elegant digital solutions. Beyond coding, I&#39;m also a professional badminton player and a passionate santoor musician, which keeps me creative and focused. </p><p data-v-0ace5747> At <strong data-v-0ace5747>a&amp;o Hostels</strong>, I&#39;m working as a Frontend Developer, creating responsive and intuitive web interfaces. Previously, I contributed to innovative projects at <strong data-v-0ace5747>Avodaq</strong> and gained diverse experience at <strong data-v-0ace5747>Teleperformance</strong>. </p><p data-v-0ace5747> I thrive in collaborative environments, constantly learning new technologies and pushing the boundaries of what&#39;s possible with modern web technologies. My goal is to create meaningful digital experiences that make a difference. </p><div class="quick-facts" data-v-0ace5747><div class="fact" data-v-0ace5747><span class="fact-label" data-v-0ace5747>Location</span><span class="fact-value" data-v-0ace5747>Berlin, Germany 🇩🇪</span></div><div class="fact" data-v-0ace5747><span class="fact-label" data-v-0ace5747>Current Role</span><span class="fact-value" data-v-0ace5747>Frontend Developer at a&amp;o Hostels</span></div><div class="fact" data-v-0ace5747><span class="fact-label" data-v-0ace5747>Education</span><span class="fact-value" data-v-0ace5747>Master&#39;s in IT</span></div><div class="fact" data-v-0ace5747><span class="fact-label" data-v-0ace5747>Interests</span><span class="fact-value" data-v-0ace5747>Web Dev, Badminton, Music 🎵</span></div></div></div><div class="about-stats fade-in-up" data-v-0ace5747><div class="stat-card" data-v-0ace5747><div class="stat-number" data-v-0ace5747>5+</div><div class="stat-label" data-v-0ace5747>Years of Experience</div><p data-v-0ace5747>Building modern web applications with cutting-edge technologies</p></div><div class="stat-card" data-v-0ace5747><div class="stat-number" data-v-0ace5747>10+</div><div class="stat-label" data-v-0ace5747>Projects Completed</div><p data-v-0ace5747>From startups to established companies, diverse and impactful work</p></div><div class="stat-card" data-v-0ace5747><div class="stat-number" data-v-0ace5747>500+</div><div class="stat-label" data-v-0ace5747>Professional Network</div><p data-v-0ace5747>Connected with talented professionals and tech enthusiasts</p></div></div></div></div>',1)])])}const HS=an(BS,[["render",kS],["__scopeId","data-v-0ace5747"]]),VS={class:"skills",id:"skills"},GS={class:"container"},WS={class:"skills-grid"},XS={class:"category-title"},qS={class:"skills-list"},$S=An({__name:"Skills",setup(n){const e=ot([{name:"Frontend Frameworks",skills:["Vue.js","React","AngularJS","Vite","Next.js"]},{name:"Languages",skills:["JavaScript","TypeScript","HTML5","CSS3","Python"]},{name:"Styling",skills:["Tailwind CSS","SCSS/SASS","CSS Modules","Styled Components","Bootstrap"]},{name:"Tools & Platforms",skills:["Git","GitHub","npm","Yarn","Docker","Linux"]},{name:"Development",skills:["REST APIs","Web Components","Responsive Design","Performance Optimization","Testing"]},{name:"Other Skills",skills:["Problem Solving","Team Collaboration","Communication","Learning Mindset","Agile/Scrum"]}]);return(t,i)=>(Re(),Le("section",VS,[U("div",GS,[i[0]||(i[0]=U("div",{class:"section-title"},[U("h2",null,"Skills & Technologies")],-1)),U("div",WS,[(Re(!0),Le(Mt,null,qt(e.value,(r,s)=>(Re(),Le("div",{class:"skill-category fade-in-up",key:s,style:Dr({animationDelay:`${s*.1}s`})},[U("h3",XS,ke(r.name),1),U("div",qS,[(Re(!0),Le(Mt,null,qt(r.skills,a=>(Re(),Le("span",{class:"skill-badge",key:a},ke(a),1))),128))])],4))),128))])])]))}}),YS=an($S,[["__scopeId","data-v-936a22af"]]),KS={class:"experience",id:"experience"},ZS={class:"container"},JS={class:"timeline"},QS={class:"timeline-content"},jS={class:"job-header"},eM={class:"job-title"},tM={class:"company"},nM={class:"job-period"},iM={class:"period"},rM={class:"duration"},sM={class:"job-location"},aM={class:"job-description"},oM={class:"job-tags"},lM=An({__name:"Experience",setup(n){const e=ot([{title:"Frontend Developer",company:"a&o Hostels",period:"Oct 2025 – Present",duration:"11 months",location:"Berlin, Deutschland",type:"Hybrid",description:["Develop responsive and user-friendly frontend interfaces for the a&o Hostels web platform","Collaborate with cross-functional teams to translate design requirements into functional code","Optimize application performance and ensure compatibility across browsers and devices"],technologies:["Vue.js","TypeScript","CSS3","REST APIs"]},{title:"Software Developer (Frontend)",company:"Avodaq AG",period:"Jan 2024 – Sept 2025",duration:"1 year 9 months",location:"Berlin, Deutschland",type:"Remote",description:["Developed and innovated an internal portal for customers, enhancing functionality and usability","Built responsive components using modern frontend technologies","Improved application performance and user experience through optimization techniques","Participated in code reviews and maintained high code quality standards"],technologies:["React","TypeScript","JavaScript","SCSS","API Integration"]},{title:"Web Content Developer",company:"Teleperformance",period:"Dec 2022 – Jan 2024",duration:"1 year 2 months",location:"Berlin, Deutschland",type:"On-site",description:["Supported team in analyzing data and web content","Gained foundational experience in web development and content management","First professional role in Germany, building strong technical foundation"],technologies:["HTML","CSS","JavaScript","Web Analysis"]}]);return(t,i)=>(Re(),Le("section",KS,[U("div",ZS,[i[1]||(i[1]=U("div",{class:"section-title"},[U("h2",null,"Work Experience")],-1)),U("div",JS,[(Re(!0),Le(Mt,null,qt(e.value,(r,s)=>(Re(),Le("div",{class:"timeline-item fade-in-up",key:s,style:Dr({animationDelay:`${s*.15}s`})},[i[0]||(i[0]=U("div",{class:"timeline-marker"},null,-1)),U("div",QS,[U("div",jS,[U("div",eM,[U("h3",null,ke(r.title),1),U("p",tM,ke(r.company),1)]),U("div",nM,[U("span",iM,ke(r.period),1),U("span",rM,ke(r.duration),1)])]),U("p",sM,"📍 "+ke(r.location)+" · "+ke(r.type),1),U("div",aM,[(Re(!0),Le(Mt,null,qt(r.description,(a,o)=>(Re(),Le("p",{key:o},ke(a),1))),128))]),U("div",oM,[(Re(!0),Le(Mt,null,qt(r.technologies,a=>(Re(),Le("span",{class:"tag",key:a},ke(a),1))),128))])])],4))),128))])])]))}}),cM=an(lM,[["__scopeId","data-v-ef1012e9"]]),uM={class:"projects",id:"projects"},fM={class:"container"},dM={class:"projects-grid"},hM={class:"project-image"},pM={class:"image-placeholder"},mM={class:"project-content"},gM={class:"project-description"},_M={class:"project-tech"},vM={class:"project-links"},xM=["href"],SM=["href","target","rel"],MM=An({__name:"Projects",setup(n){const e=i=>/^https?:\/\//.test(i),t=ot([{title:"BMI Calculator",description:"Interactive Body Mass Index calculator. Enter weight and height to get your BMI and category, then use the live demo without leaving this site.",icon:"⚖️",technologies:["React","TypeScript","Tailwind CSS","Vite"],github:"https://github.com/behzadkazemi/BMI-Calculator",live:"/bmi-calculator/"},{title:"Weather App",description:"A weather application for checking current conditions and forecasts through a focused, responsive interface.",icon:"☁️",technologies:["JavaScript","Weather API","CSS3"],github:"https://github.com/behzadkazemi/WeatherApp",live:"/weather-app/"},{title:"Ito-Ito Code Challenge",description:"A coding challenge project demonstrating practical frontend problem-solving and interactive user interface work.",icon:"🧩",technologies:["JavaScript","HTML5","CSS3"],github:"https://github.com/behzadkazemi/behzad-itoito-code-challengee",live:"/ito-ito-challenge/"},{title:"Color Challenge",description:"An interactive color-based challenge built around quick decisions, visual feedback, and playful browser interactions.",icon:"🎨",technologies:["JavaScript","HTML5","CSS3"],github:"https://github.com/behzadkazemi/Color-Challenge",live:"https://behzadkazemi.github.io/Color-Challenge/"},{title:"Income Tracker",description:"A practical browser tool for recording income and keeping personal financial information organized.",icon:"📈",technologies:["JavaScript","HTML5","CSS3"],github:"https://github.com/behzadkazemi/IncomeTracker",live:"https://behzadkazemi.github.io/IncomeTracker/"},{title:"Queen Burger",description:"A restaurant website concept with an engaging menu experience and responsive presentation for burger lovers.",icon:"🍔",technologies:["JavaScript","HTML5","CSS3"],github:"https://github.com/behzadkazemi/queenBurger",live:"https://behzadkazemi.github.io/queenBurger/"},{title:"Berlin Budget Secrets",description:"A city-focused project exploring useful budget ideas and accessible information for life in Berlin.",icon:"🏙️",technologies:["JavaScript","HTML5","CSS3"],github:"https://github.com/behzadkazemi/BerlinBudgetSecrets",live:"https://behzadkazemi.github.io/BerlinBudgetSecrets/"},{title:"MultiLanguage Form",description:"A multilingual form experience designed to make data entry clearer and more accessible across languages.",icon:"🌍",technologies:["JavaScript","HTML5","CSS3"],github:"https://github.com/behzadkazemi/MultiLanguage-From",live:"https://behzadkazemi.github.io/MultiLanguage-From/"},{title:"To-Do List",description:"A simple task management application for adding, organizing, and completing everyday tasks.",icon:"✅",technologies:["JavaScript","HTML5","CSS3"],github:"https://github.com/behzadkazemi/to-do-list",live:"https://behzadkazemi.github.io/to-do-list/"},{title:"Game of Thrones",description:"A themed project inspired by Game of Thrones, showcasing content presentation and interactive frontend work.",icon:"🐉",technologies:["JavaScript","HTML5","CSS3"],github:"https://github.com/behzadkazemi/GOT",live:"/game-of-thrones/"},{title:"Harry Potter",description:"A themed Harry Potter project demonstrating creative interface design and responsive web presentation.",icon:"⚡",technologies:["JavaScript","HTML5","CSS3"],github:"https://github.com/behzadkazemi/HarryPotter",live:"/harry-potter/"},{title:"Ext JS Training",description:"Training work exploring Ext JS components, layouts, and application patterns.",icon:"🛠️",technologies:["Ext JS","JavaScript","HTML5"],github:"https://github.com/behzadkazemi/ExtJsTraining",live:"https://behzadkazemi.github.io/ExtJsTraining/"},{title:"Question Answering Tool",description:"A question-and-answer interface focused on presenting information through a clear and direct workflow.",icon:"❓",technologies:["JavaScript","HTML5","CSS3"],github:"https://github.com/behzadkazemi/Question-Answering-Tool",live:"https://behzadkazemi.github.io/Question-Answering-Tool/"},{title:"Random Movie Adviser",description:"A lightweight movie discovery tool that suggests a random film for the next viewing session.",icon:"🎬",technologies:["JavaScript","HTML5","CSS3"],github:"https://github.com/behzadkazemi/Random-movie-adviser",live:"/random-movie-adviser/"},{title:"IMDb Top 250",description:"A movie browsing project presenting titles from IMDb's highly rated Top 250 collection.",icon:"🏆",technologies:["JavaScript","HTML5","CSS3"],github:"https://github.com/behzadkazemi/imdb-top-250",live:"/imdb-top-250/"},{title:"Personal Portfolio",description:"A modern, responsive portfolio website built with Vue 3 and TypeScript. Showcases projects, skills, and experience with a smooth, animated user interface.",icon:"💼",technologies:["Vue 3","TypeScript","Vite","CSS3"],github:"https://github.com/behzadkazemi/behzadkazemi.github.io",live:"https://behzadkazemi.github.io"},{title:"a&o Hostels Portal",description:"Internal customer portal featuring responsive design and enhanced functionality. Built with modern web technologies to improve user experience and performance.",icon:"🏨",technologies:["Vue.js","TypeScript","REST API","SCSS"],github:"",live:""},{title:"Avodaq Internal Portal",description:"Innovative internal portal for a software development company, featuring complex data visualization and real-time updates. Optimized for performance and usability.",icon:"⚙️",technologies:["React","TypeScript","Redux","API Integration"],github:"",live:""},{title:"Web Development Projects",description:"Collection of web projects demonstrating proficiency in HTML5, CSS3, and JavaScript. Includes responsive design implementations and interactive features.",icon:"🌐",technologies:["HTML5","CSS3","JavaScript","Responsive Design"],github:"https://github.com/behzadkazemi",live:""}]);return(i,r)=>(Re(),Le("section",uM,[U("div",fM,[r[2]||(r[2]=U("div",{class:"section-title"},[U("h2",null,"Featured Projects")],-1)),U("div",dM,[(Re(!0),Le(Mt,null,qt(t.value,(s,a)=>(Re(),Le("div",{class:"project-card fade-in-up",key:a,style:Dr({animationDelay:`${a*.15}s`})},[U("div",hM,[U("div",pM,ke(s.icon),1)]),U("div",mM,[U("h3",null,ke(s.title),1),U("p",gM,ke(s.description),1),U("div",_M,[(Re(!0),Le(Mt,null,qt(s.technologies,o=>(Re(),Le("span",{class:"tech-badge",key:o},ke(o),1))),128))]),U("div",vM,[s.github?(Re(),Le("a",{key:0,href:s.github,target:"_blank",rel:"noopener noreferrer",class:"project-link"},[...r[0]||(r[0]=[U("svg",{class:"icon",viewBox:"0 0 24 24",fill:"currentColor"},[U("path",{d:"M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"})],-1),dn(" Code ",-1)])],8,xM)):Jt("",!0),s.live?(Re(),Le("a",{key:1,href:s.live,target:e(s.live)?"_blank":void 0,rel:e(s.live)?"noopener noreferrer":void 0,class:"project-link live"},[...r[1]||(r[1]=[U("svg",{class:"icon",viewBox:"0 0 24 24",fill:"currentColor"},[U("path",{d:"M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"})],-1),dn(" Live ",-1)])],8,SM)):Jt("",!0)])])],4))),128))]),r[3]||(r[3]=U("div",{class:"more-projects"},[U("p",null,[dn("Interested in more? Check out my "),U("a",{href:"https://github.com/behzadkazemi",target:"_blank",rel:"noopener noreferrer"},"GitHub profile"),dn(" for additional projects.")])],-1))])]))}}),bM=an(MM,[["__scopeId","data-v-35324244"]]),yM={class:"contact",id:"contact"},EM={class:"container"},TM={class:"contact-content"},AM={class:"contact-form fade-in-up"},wM={class:"form-group"},RM={class:"form-group"},CM={class:"form-group"},PM={class:"form-group"},DM=An({__name:"Contact",setup(n){const e=ot({name:"",email:"",subject:"",message:""}),t=ot(null),i=async()=>{try{console.log("Form submitted:",e.value),t.value={type:"success",message:"Message sent successfully! I'll get back to you soon."},e.value={name:"",email:"",subject:"",message:""},setTimeout(()=>{t.value=null},5e3)}catch{t.value={type:"error",message:"Failed to send message. Please try again or email me directly."}}};return(r,s)=>(Re(),Le("section",yM,[U("div",EM,[s[10]||(s[10]=U("div",{class:"section-title"},[U("h2",null,"Get In Touch")],-1)),U("div",TM,[s[9]||(s[9]=Ir('<div class="contact-text fade-in-up" data-v-efac7281><p data-v-efac7281> I&#39;m always interested in hearing about new opportunities and collaborative projects. Whether you&#39;d like to discuss a potential project, have a question, or just want to say hello, feel free to reach out! </p><p data-v-efac7281> I&#39;ll do my best to respond as quickly as possible. </p><div class="contact-methods" style="background-color:rgba(13, 29, 22, 0.86);" data-v-efac7281><div class="contact-method" data-v-efac7281><div class="method-icon" data-v-efac7281>✉️</div><div class="method-info" data-v-efac7281><h4 data-v-efac7281>Email</h4><a href="mailto:bkazemi1994@gmail.com" data-v-efac7281>bkazemi1994@gmail.com</a></div></div><div class="contact-method" data-v-efac7281><div class="method-icon" data-v-efac7281>💼</div><div class="method-info" data-v-efac7281><h4 data-v-efac7281>LinkedIn</h4><a href="https://linkedin.com/in/behzadkazemi" target="_blank" rel="noopener noreferrer" data-v-efac7281>linkedin.com/in/behzadkazemi</a></div></div><div class="contact-method" data-v-efac7281><div class="method-icon" data-v-efac7281>💻</div><div class="method-info" data-v-efac7281><h4 data-v-efac7281>GitHub</h4><a href="https://github.com/behzadkazemi" target="_blank" rel="noopener noreferrer" data-v-efac7281>github.com/behzadkazemi</a></div></div><div class="contact-method" data-v-efac7281><div class="method-icon" data-v-efac7281>📍</div><div class="method-info" data-v-efac7281><h4 data-v-efac7281>Location</h4><p data-v-efac7281>Berlin, Germany 🇩🇪</p></div></div></div></div>',1)),U("div",AM,[U("form",{onSubmit:Ia(i,["prevent"])},[U("div",wM,[s[4]||(s[4]=U("label",{for:"name"},"Name",-1)),ai(U("input",{type:"text",id:"name","onUpdate:modelValue":s[0]||(s[0]=a=>e.value.name=a),required:"",placeholder:"Your name"},null,512),[[Ri,e.value.name]])]),U("div",RM,[s[5]||(s[5]=U("label",{for:"email"},"Email",-1)),ai(U("input",{type:"email",id:"email","onUpdate:modelValue":s[1]||(s[1]=a=>e.value.email=a),required:"",placeholder:"your@email.com"},null,512),[[Ri,e.value.email]])]),U("div",CM,[s[6]||(s[6]=U("label",{for:"subject"},"Subject",-1)),ai(U("input",{type:"text",id:"subject","onUpdate:modelValue":s[2]||(s[2]=a=>e.value.subject=a),required:"",placeholder:"Subject of your message"},null,512),[[Ri,e.value.subject]])]),U("div",PM,[s[7]||(s[7]=U("label",{for:"message"},"Message",-1)),ai(U("textarea",{id:"message","onUpdate:modelValue":s[3]||(s[3]=a=>e.value.message=a),required:"",placeholder:"Your message...",rows:"6"},null,512),[[Ri,e.value.message]])]),s[8]||(s[8]=U("button",{type:"submit",class:"btn-primary",style:{"background-color":"rgba(17, 39, 28, 0.9)"}},"Send Message",-1)),t.value?(Re(),Le("p",{key:0,class:Mn(["form-status",t.value.type])},ke(t.value.message),3)):Jt("",!0)],32)])])])]))}}),IM=an(DM,[["__scopeId","data-v-efac7281"]]),LM={},UM={class:"footer"};function NM(n,e){return Re(),Le("footer",UM,[...e[0]||(e[0]=[Ir('<div class="container footer-content" data-v-5d5b0fbf><div class="footer-section" data-v-5d5b0fbf><h3 data-v-5d5b0fbf>Behzad Kazemi</h3><p data-v-5d5b0fbf>Frontend Developer &amp; Software Engineer based in Berlin</p></div><div class="footer-section" data-v-5d5b0fbf><h4 data-v-5d5b0fbf>Quick Links</h4><ul data-v-5d5b0fbf><li data-v-5d5b0fbf><a href="#about" data-v-5d5b0fbf>About</a></li><li data-v-5d5b0fbf><a href="#skills" data-v-5d5b0fbf>Skills</a></li><li data-v-5d5b0fbf><a href="#experience" data-v-5d5b0fbf>Experience</a></li><li data-v-5d5b0fbf><a href="#projects" data-v-5d5b0fbf>Projects</a></li><li data-v-5d5b0fbf><a href="#contact" data-v-5d5b0fbf>Contact</a></li></ul></div><div class="footer-section" data-v-5d5b0fbf><h4 data-v-5d5b0fbf>Social</h4><div class="social-links" data-v-5d5b0fbf><a href="https://github.com/behzadkazemi" target="_blank" rel="noopener noreferrer" title="GitHub" data-v-5d5b0fbf><svg class="icon" viewBox="0 0 24 24" fill="currentColor" data-v-5d5b0fbf><path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z" data-v-5d5b0fbf></path></svg></a><a href="https://linkedin.com/in/behzadkazemi" target="_blank" rel="noopener noreferrer" title="LinkedIn" data-v-5d5b0fbf><svg class="icon" viewBox="0 0 24 24" fill="currentColor" data-v-5d5b0fbf><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.225 0z" data-v-5d5b0fbf></path></svg></a></div></div></div><div class="footer-bottom" data-v-5d5b0fbf><p data-v-5d5b0fbf>© 2026 Behzad Kazemi. All rights reserved. Built with Vue 3 + TypeScript.</p></div>',2)])])}const FM=an(LM,[["render",NM],["__scopeId","data-v-5d5b0fbf"]]),OM={class:"bmi-page"},BM={class:"container"},zM={class:"bmi-card fade-in-up"},kM={key:0,class:"error"},HM={class:"result-value"},VM={class:"result-status"},GM=An({__name:"BmiCalculator",setup(n){const e=ot(""),t=ot(""),i=ot(null),r=ot(""),s=ot(""),a=Yi(()=>r.value.toLowerCase().replace(/\s+/g,"-")),o=()=>{const c=parseFloat(e.value),u=parseFloat(t.value);if(!Number.isFinite(c)||!Number.isFinite(u)||c<=0||u<=0){s.value="Please enter a valid weight and height.",i.value=null,r.value="";return}const d=u/100,f=c/(d*d);s.value="",i.value=f,f<18.5?r.value="Underweight":f<24.9?r.value="Normal weight":f<29.9?r.value="Overweight":r.value="Obesity"},l=()=>{e.value="",t.value="",i.value=null,r.value="",s.value=""};return(c,u)=>(Re(),Le("section",OM,[U("div",BM,[u[10]||(u[10]=U("a",{class:"back-link",href:"/"},"← Back to portfolio",-1)),U("div",zM,[u[6]||(u[6]=U("p",{class:"eyebrow"},"Project demo",-1)),u[7]||(u[7]=U("h1",null,"BMI Calculator",-1)),u[8]||(u[8]=U("p",{class:"intro"},[dn(" Enter your weight and height to calculate Body Mass Index, using the same formula as my "),U("a",{href:"https://github.com/behzadkazemi/BMI-Calculator",target:"_blank",rel:"noopener noreferrer"},"BMI-Calculator"),dn(" repository. ")],-1)),U("form",{class:"bmi-form",onSubmit:Ia(o,["prevent"])},[U("label",null,[u[2]||(u[2]=dn(" Weight (kg) ",-1)),ai(U("input",{"onUpdate:modelValue":u[0]||(u[0]=d=>e.value=d),type:"number",min:"1",max:"400",step:"0.1",inputmode:"decimal",placeholder:"e.g. 70",required:""},null,512),[[Ri,e.value]])]),U("label",null,[u[3]||(u[3]=dn(" Height (cm) ",-1)),ai(U("input",{"onUpdate:modelValue":u[1]||(u[1]=d=>t.value=d),type:"number",min:"50",max:"250",step:"0.1",inputmode:"decimal",placeholder:"e.g. 175",required:""},null,512),[[Ri,t.value]])]),s.value?(Re(),Le("p",kM,ke(s.value),1)):Jt("",!0),U("div",{class:"actions"},[u[4]||(u[4]=U("button",{type:"submit",class:"btn-primary"},"Calculate BMI",-1)),U("button",{type:"button",class:"btn-secondary",onClick:l},"Reset")])],32),i.value!==null?(Re(),Le("div",{key:0,class:Mn(["result",a.value])},[u[5]||(u[5]=U("p",{class:"result-label"},"Your BMI is",-1)),U("p",HM,ke(i.value.toFixed(1)),1),U("p",VM,ke(r.value),1)],2)):Jt("",!0),u[9]||(u[9]=Ir('<ul class="legend" data-v-6625fd8e><li data-v-6625fd8e><span class="dot underweight" data-v-6625fd8e></span> Underweight: below 18.5</li><li data-v-6625fd8e><span class="dot normal" data-v-6625fd8e></span> Normal weight: 18.5 – 24.8</li><li data-v-6625fd8e><span class="dot overweight" data-v-6625fd8e></span> Overweight: 24.9 – 29.8</li><li data-v-6625fd8e><span class="dot obesity" data-v-6625fd8e></span> Obesity: 29.9 and above</li></ul><p class="disclaimer" data-v-6625fd8e> BMI is a screening estimate, not a medical diagnosis. Talk to a healthcare professional for personal advice. </p>',2))])])]))}}),WM=an(GM,[["__scopeId","data-v-6625fd8e"]]),XM={class:"weather-page"},qM={class:"weather-shell"},$M={class:"weather-card","aria-live":"polite"},YM={class:"search-row"},KM=["disabled"],ZM={key:0,class:"message error"},JM={key:1,class:"message"},QM={key:2,class:"weather-result"},jM={class:"date"},eb={class:"weather-icon","aria-hidden":"true"},tb={class:"temperature"},nb={class:"condition"},ib={class:"details"},rb=An({__name:"WeatherDemo",setup(n){const e=ot("Berlin"),t=ot(null),i=ot(""),r=ot(!1),s=Yi(()=>new Intl.DateTimeFormat("en-US",{month:"long",day:"numeric",year:"numeric"}).format(new Date)),a=Yi(()=>{var u,d;const c=(d=(u=t.value)==null?void 0:u.weather[0])==null?void 0:d.main;return c==="Clear"?"☀️":c==="Rain"?"🌧️":c==="Snow"?"❄️":c==="Haze"?"🌫️":"☁️"}),o=async()=>{var u;const c=e.value.trim();if(c){r.value=!0,i.value="";try{const d=await fetch(`https://geocoding-api.open-meteo.com/v1/search?name=${encodeURIComponent(c)}&count=1&language=en&format=json`),f=await d.json();if(!d.ok||!((u=f.results)!=null&&u.length))throw new Error("City not found. Try another city.");const m=f.results[0],x=await fetch(`https://api.open-meteo.com/v1/forecast?latitude=${m.latitude}&longitude=${m.longitude}&current=temperature_2m,relative_humidity_2m,apparent_temperature,weather_code&timezone=auto`),M=await x.json();if(!x.ok)throw new Error("Weather data is unavailable right now.");t.value={name:m.name,country:m.country_code,main:{temp:M.current.temperature_2m,feels_like:M.current.apparent_temperature,humidity:M.current.relative_humidity_2m},weather:[{main:l(M.current.weather_code)}]}}catch(d){t.value=null,i.value=d instanceof Error?d.message:"Unable to load weather right now."}finally{r.value=!1}}};Ra(o);const l=c=>c===0?"Clear":c<=3?"Clouds":c<=67||c>=80&&c<=82?"Rain":c<=77||c>=85?"Snow":"Haze";return(c,u)=>(Re(),Le("main",XM,[U("div",qM,[u[5]||(u[5]=U("a",{class:"back-link",href:"/"},"← Back to portfolio",-1)),U("section",$M,[u[2]||(u[2]=U("p",{class:"eyebrow"},"Project demo",-1)),u[3]||(u[3]=U("h1",null,"Weather App",-1)),u[4]||(u[4]=U("p",{class:"intro"},[dn(" Search for a city to see its current weather, just like the original "),U("a",{href:"https://github.com/behzadkazemi/WeatherApp",target:"_blank",rel:"noopener noreferrer"},"React project"),dn(". ")],-1)),U("form",{class:"search-form",onSubmit:Ia(o,["prevent"])},[u[1]||(u[1]=U("label",{for:"city"},"City",-1)),U("div",YM,[ai(U("input",{id:"city","onUpdate:modelValue":u[0]||(u[0]=d=>e.value=d),type:"search",placeholder:"Enter city name",required:""},null,512),[[Ri,e.value]]),U("button",{type:"submit",disabled:r.value},ke(r.value?"Searching...":"Search"),9,KM)])],32),i.value?(Re(),Le("p",ZM,ke(i.value),1)):r.value?(Re(),Le("p",JM,"Loading weather for "+ke(e.value)+"...",1)):Jt("",!0),t.value?(Re(),Le("div",QM,[U("p",jM,ke(s.value),1),U("h2",null,ke(t.value.name)+", "+ke(t.value.country),1),U("div",eb,ke(a.value),1),U("p",tb,ke(Math.round(t.value.main.temp))+"°C",1),U("p",nb,ke(t.value.weather[0].main),1),U("div",ib,[U("span",null,"Feels like "+ke(Math.round(t.value.main.feels_like))+"°C",1),U("span",null,"Humidity "+ke(t.value.main.humidity)+"%",1)])])):Jt("",!0)])])]))}}),sb=an(rb,[["__scopeId","data-v-04551de3"]]),ab={class:"ito-page"},ob={class:"ito-shell"},lb={class:"workspace"},cb={class:"patterns-panel"},ub={class:"panel-heading"},fb={key:0,class:"empty-state"},db={class:"slot-label"},hb=["innerHTML"],pb=["viewBox"],mb=["x1","y1","x2","y2"],gb=["x1","y1","x2","y2"],_b=["cx","cy"],vb={key:2,class:"error-message"},xb={key:3,class:"hint"},Sb={class:"lines-panel"},Mb={class:"panel-heading compact"},bb={class:"line-count"},yb={class:"controls"},Eb=["disabled"],Tb=["disabled"],Ab={key:0,class:"line-list"},wb={key:1,class:"no-lines"},Rb=An({__name:"ItoItoDemo",setup(n){const e=ot(null),t=ot(null),i=ot([]),r=ot([]),s=ot(null),a=ot(null),o=ot(""),l=ot({width:1e3,height:600}),c=Yi(()=>!s.value||!a.value?null:{start:s.value,end:a.value}),u=async y=>{const E=y.target,_=Array.from(E.files||[]);if(_.length!==2){o.value="Please select exactly two SVG files.";return}i.value=await Promise.all(_.map(async A=>({name:A.name,content:await A.text()}))),r.value=[],s.value=null,a.value=null,o.value="",await yf(),d()},d=()=>{if(!t.value)return;const y=t.value.getBoundingClientRect();l.value={width:y.width,height:y.height}},f=y=>{if(!t.value)return null;const E=t.value.getBoundingClientRect();return{x:y.clientX-E.left,y:y.clientY-E.top}},m=y=>{const E=f(y);if(E){if(!s.value){s.value=E,a.value=E;return}r.value.push({start:s.value,end:E,color:y.button===2?"blue":"red"}),s.value=null,a.value=null}},x=y=>{s.value&&(a.value=f(y))},M=()=>{s.value=null,a.value=null},g=()=>r.value.pop(),h=()=>{r.value=[],M()};return(y,E)=>(Re(),Le("main",ab,[U("div",ob,[E[8]||(E[8]=U("a",{class:"back-link",href:"/"},"← Back to portfolio",-1)),E[9]||(E[9]=U("section",{class:"ito-header"},[U("div",null,[U("p",{class:"eyebrow"},"Project demo"),U("h1",null,"SVG Pattern Connector"),U("p",null,"Upload two SVG patterns, then connect matching points with colored lines.")]),U("a",{class:"source-link",href:"https://github.com/behzadkazemi/behzad-itoito-code-challengee",target:"_blank",rel:"noopener noreferrer"},"View React source")],-1)),U("section",lb,[U("div",cb,[U("div",ub,[E[3]||(E[3]=U("div",null,[U("p",{class:"eyebrow"},"Pattern workspace"),U("h2",null,"Two SVG files")],-1)),U("button",{class:"upload-button",type:"button",onClick:E[0]||(E[0]=_=>{var A;return(A=e.value)==null?void 0:A.click()})},"Upload 2 SVGs"),U("input",{ref_key:"fileInput",ref:e,class:"file-input",type:"file",accept:".svg,image/svg+xml",multiple:"",onChange:u},null,544)]),i.value.length===0?(Re(),Le("div",fb,[E[4]||(E[4]=U("div",{class:"upload-mark"},"+",-1)),E[5]||(E[5]=U("h3",null,"Start with two patterns",-1)),E[6]||(E[6]=U("p",null,"Select exactly two SVG files to begin drawing connections.",-1)),U("button",{class:"primary-button",type:"button",onClick:E[1]||(E[1]=_=>{var A;return(A=e.value)==null?void 0:A.click()})},"Choose SVG files")])):(Re(),Le("div",{key:1,class:"svg-stage",ref_key:"stage",ref:t,onPointerdown:m,onPointermove:x,onPointerleave:M,onContextmenu:E[2]||(E[2]=Ia(()=>{},["prevent"]))},[(Re(!0),Le(Mt,null,qt(i.value,(_,A)=>(Re(),Le("div",{class:"svg-slot",key:_.name},[U("span",db,ke(A===0?"Pattern A":"Pattern B"),1),U("div",{class:"svg-content",innerHTML:_.content},null,8,hb)]))),128)),(Re(),Le("svg",{class:"line-layer",viewBox:`0 0 ${l.value.width} ${l.value.height}`,"aria-hidden":"true"},[(Re(!0),Le(Mt,null,qt(r.value,(_,A)=>(Re(),Le("line",{key:A,x1:_.start.x,y1:_.start.y,x2:_.end.x,y2:_.end.y,class:Mn(_.color)},null,10,mb))),128)),c.value?(Re(),Le("line",{key:0,x1:c.value.start.x,y1:c.value.start.y,x2:c.value.end.x,y2:c.value.end.y,class:"preview"},null,8,gb)):Jt("",!0),s.value?(Re(),Le("circle",{key:1,cx:s.value.x,cy:s.value.y,r:"7",class:"active-dot"},null,8,_b)):Jt("",!0)],8,pb))],544)),o.value?(Re(),Le("p",vb,ke(o.value),1)):i.value.length>0?(Re(),Le("p",xb,"Click a point on either pattern, then click a second point. Right-click creates a blue guide line.")):Jt("",!0)]),U("aside",Sb,[U("div",Mb,[E[7]||(E[7]=U("div",null,[U("p",{class:"eyebrow"},"Connections"),U("h2",null,"Defined lines")],-1)),U("span",bb,ke(r.value.length),1)]),U("div",yb,[U("button",{type:"button",class:"secondary-button",disabled:r.value.length===0,onClick:g},"Undo last",8,Eb),U("button",{type:"button",class:"danger-button",disabled:r.value.length===0,onClick:h},"Reset all",8,Tb)]),r.value.length?(Re(),Le("ol",Ab,[(Re(!0),Le(Mt,null,qt(r.value,(_,A)=>(Re(),Le("li",{key:A},[U("span",{class:Mn(["line-swatch",_.color])},null,2),U("span",null,[dn("Line "+ke(A+1),1),U("small",null,ke(_.color==="red"?"Primary connection":"Guide connection"),1)])]))),128))])):(Re(),Le("p",wb,"No lines defined yet."))])])])]))}}),Cb=an(Rb,[["__scopeId","data-v-81dae0a8"]]),Pb={class:"media-shell"},Db={key:0,class:"media-card random-card"},Ib={class:"movie-pick"},Lb={class:"rank"},Ub={class:"year"},Nb={key:1,class:"media-card imdb-card"},Fb={class:"movie-list"},Ob={class:"movie-rank"},Bb={key:0,class:"empty-message"},zb={key:2,class:"media-card got-card"},kb={class:"got-tabs"},Hb=["onClick"],Vb={key:0,class:"character-grid"},Gb=["onClick"],Wb={class:"sigil"},Xb={key:1,class:"quote-box"},qb={class:"quote-author"},$b={key:2,class:"character-detail"},Yb={key:3,class:"media-card potter-card"},Kb={class:"house-filter"},Zb=["onClick"],Jb={class:"wizard-grid"},Qb=["onClick"],jb={class:"wizard-mark"},ey={key:0,class:"wizard-detail"},ty=An({__name:"MediaDemos",setup(n){const e=window.location.pathname.replace(/\/+$/,""),t=e.endsWith("/random-movie-adviser")?"random-movie":e.endsWith("/imdb-top-250")?"imdb":e.endsWith("/game-of-thrones")?"got":"harry-potter",i=[{title:"The Shawshank Redemption",year:1994,rank:1},{title:"The Godfather",year:1972,rank:2},{title:"The Dark Knight",year:2008,rank:3},{title:"The Godfather Part II",year:1974,rank:4},{title:"12 Angry Men",year:1957,rank:5},{title:"Schindler's List",year:1993,rank:6},{title:"The Lord of the Rings: The Return of the King",year:2003,rank:7},{title:"Pulp Fiction",year:1994,rank:8},{title:"The Good, the Bad and the Ugly",year:1966,rank:9},{title:"The Lord of the Rings: The Fellowship of the Ring",year:2001,rank:10}],r=ot(null),s=ot(""),a=Yi(()=>i.filter(E=>E.title.toLowerCase().includes(s.value.toLowerCase()))),o=()=>{r.value=i[Math.floor(Math.random()*i.length)]},l=[{name:"Jon Snow",house:"House Stark",sigil:"ST",description:"The reluctant hero of the North, raised at Winterfell and bound by duty."},{name:"Daenerys Targaryen",house:"House Targaryen",sigil:"TG",description:"The Dragon Queen, determined to reclaim the throne of Westeros."},{name:"Tyrion Lannister",house:"House Lannister",sigil:"LI",description:"A sharp-minded strategist whose wit is as formidable as any sword."},{name:"Arya Stark",house:"House Stark",sigil:"ST",description:"A fiercely independent survivor trained to move unseen."}],c=ot("Characters"),u=ot(null),d=ot({text:"Winter is coming.",author:"Ned Stark"}),f=[{text:"Winter is coming.",author:"Ned Stark"},{text:"A mind needs books as a sword needs a whetstone.",author:"Tyrion Lannister"},{text:"The things we do for love.",author:"Jaime Lannister"},{text:"Not today.",author:"Arya Stark"}],m=()=>{d.value=f[Math.floor(Math.random()*f.length)]},x=[{name:"Harry Potter",house:"Gryffindor",sigil:"HP",description:"The Boy Who Lived, known for courage, loyalty, and a talent for finding trouble."},{name:"Hermione Granger",house:"Gryffindor",sigil:"HG",description:"A brilliant witch whose preparation and compassion repeatedly save the day."},{name:"Draco Malfoy",house:"Slytherin",sigil:"DM",description:"A Slytherin student shaped by family expectations and difficult choices."},{name:"Luna Lovegood",house:"Ravenclaw",sigil:"LL",description:"An original thinker with fierce loyalty and an unshakable sense of wonder."},{name:"Cedric Diggory",house:"Hufflepuff",sigil:"CD",description:"A fair-minded champion remembered for his generosity and integrity."}],M=["All","Gryffindor","Slytherin","Ravenclaw","Hufflepuff"],g=ot("All"),h=ot(null),y=Yi(()=>g.value==="All"?x:x.filter(E=>E.house===g.value));return(E,_)=>{var A;return Re(),Le("main",{class:Mn(["media-page",si(t)])},[U("div",Pb,[_[20]||(_[20]=U("a",{class:"back-link",href:"/"},"← Back to portfolio",-1)),si(t)==="random-movie"?(Re(),Le("section",Db,[_[1]||(_[1]=U("p",{class:"eyebrow"},"Project demo / React original",-1)),_[2]||(_[2]=U("h1",null,"Random Movie Adviser",-1)),_[3]||(_[3]=U("p",{class:"lead"},"Need something good to watch? Roll the dice for a title from the IMDb Top 250.",-1)),U("div",Ib,[U("p",Lb,ke(r.value?`Rank #${r.value.rank}`:"Ready when you are"),1),U("h2",null,ke(((A=r.value)==null?void 0:A.title)||"Your next movie"),1),U("p",Ub,ke(r.value?r.value.year:"A random recommendation awaits"),1)]),U("button",{class:"primary-button dice-button",type:"button",onClick:o},"Roll the dice"),_[4]||(_[4]=U("a",{class:"source-link",href:"https://github.com/behzadkazemi/Random-movie-adviser",target:"_blank",rel:"noopener noreferrer"},"View source on GitHub",-1))])):si(t)==="imdb"?(Re(),Le("section",Nb,[_[5]||(_[5]=U("p",{class:"eyebrow"},"Project demo / movie data",-1)),_[6]||(_[6]=U("h1",null,"IMDb Top 250",-1)),_[7]||(_[7]=U("p",{class:"lead"},"Browse a curated slice of the world's most highly ranked films.",-1)),_[8]||(_[8]=U("label",{class:"search-label",for:"movie-search"},"Search titles",-1)),ai(U("input",{id:"movie-search","onUpdate:modelValue":_[0]||(_[0]=T=>s.value=T),type:"search",placeholder:"Try The Godfather"},null,512),[[Ri,s.value]]),U("ol",Fb,[(Re(!0),Le(Mt,null,qt(a.value,T=>(Re(),Le("li",{key:T.rank},[U("span",Ob,ke(T.rank),1),U("span",null,[U("strong",null,ke(T.title),1),U("small",null,ke(T.year),1)])]))),128))]),a.value.length===0?(Re(),Le("p",Bb,"No matching titles.")):Jt("",!0),_[9]||(_[9]=U("a",{class:"source-link",href:"https://github.com/behzadkazemi/imdb-top-250",target:"_blank",rel:"noopener noreferrer"},"View source on GitHub",-1))])):si(t)==="got"?(Re(),Le("section",zb,[_[11]||(_[11]=U("p",{class:"eyebrow"},"Project demo / Westeros archive",-1)),_[12]||(_[12]=U("h1",null,"Game of Thrones",-1)),_[13]||(_[13]=U("p",{class:"lead"},"Explore a small character archive and summon a quote from the Seven Kingdoms.",-1)),U("div",kb,[(Re(),Le(Mt,null,qt(["Characters","Quote"],T=>U("button",{key:T,type:"button",class:Mn({active:c.value===T}),onClick:P=>c.value=T},ke(T),11,Hb)),64))]),c.value==="Characters"?(Re(),Le("div",Vb,[(Re(),Le(Mt,null,qt(l,T=>U("button",{key:T.name,type:"button",class:"character",onClick:P=>u.value=T},[U("span",Wb,ke(T.sigil),1),U("strong",null,ke(T.name),1),U("small",null,ke(T.house),1)],8,Gb)),64))])):(Re(),Le("div",Xb,[_[10]||(_[10]=U("p",{class:"quote-mark"},"“",-1)),U("blockquote",null,ke(d.value.text),1),U("p",qb,ke(d.value.author),1),U("button",{class:"primary-button",type:"button",onClick:m},"Fetch another quote")])),u.value&&c.value==="Characters"?(Re(),Le("div",$b,[U("strong",null,ke(u.value.name),1),U("span",null,ke(u.value.description),1)])):Jt("",!0),_[14]||(_[14]=U("a",{class:"source-link",href:"https://github.com/behzadkazemi/GOT",target:"_blank",rel:"noopener noreferrer"},"View source on GitHub",-1))])):(Re(),Le("section",Yb,[_[16]||(_[16]=U("p",{class:"eyebrow"},"Project demo / Ext JS original",-1)),_[17]||(_[17]=U("h1",null,"Harry Potter",-1)),_[18]||(_[18]=U("p",{class:"lead"},"Browse a compact character guide inspired by the original Ext JS training app.",-1)),U("div",Kb,[(Re(),Le(Mt,null,qt(M,T=>U("button",{key:T,type:"button",class:Mn({active:g.value===T}),onClick:P=>g.value=T},ke(T),11,Zb)),64))]),U("div",Jb,[(Re(!0),Le(Mt,null,qt(y.value,T=>(Re(),Le("button",{key:T.name,type:"button",class:"wizard",onClick:P=>h.value=T},[U("span",jb,ke(T.mark),1),U("strong",null,ke(T.name),1),U("small",null,ke(T.house),1)],8,Qb))),128))]),h.value?(Re(),Le("div",ey,[_[15]||(_[15]=U("span",{class:"eyebrow"},"Character profile",-1)),U("h2",null,ke(h.value.name),1),U("p",null,ke(h.value.description),1)])):Jt("",!0),_[19]||(_[19]=U("a",{class:"source-link",href:"https://github.com/behzadkazemi/HarryPotter",target:"_blank",rel:"noopener noreferrer"},"View source on GitHub",-1))]))])],2)}}}),ny=an(ty,[["__scopeId","data-v-13fe7865"]]),iy={key:4,id:"app",class:"app"},ry=An({__name:"App",setup(n){const e=window.location.pathname.replace(/\/+$/,""),t=e.endsWith("/bmi-calculator"),i=e.endsWith("/weather-app"),r=e.endsWith("/ito-ito-challenge"),s=["/random-movie-adviser","/imdb-top-250","/game-of-thrones","/harry-potter"].some(a=>e.endsWith(a));return(a,o)=>si(t)?(Re(),qr(WM,{key:0})):si(i)?(Re(),qr(sb,{key:1})):si(r)?(Re(),qr(Cb,{key:2})):si(s)?(Re(),qr(ny,{key:3})):(Re(),Le("div",iy,[Lt(xm),Lt(OS),Lt(HS),Lt(YS),Lt(cM),Lt(bM),Lt(IM),Lt(FM)]))}}),sy=an(ry,[["__scopeId","data-v-96ac2297"]]),ay=hm(sy);ay.mount("#app");
