...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:li,depthTest:!1,depthWrite:!1})}function Iu(){return new An({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Oa(),fragmentShader:`
		...
		`,blending:li,depthTest:!1,depthWrite:!1})}function Lu(){return new An({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Oa(),fragmentShader:`
...
`)}const Ux={[ad]:"Linear",[od]:"Reinhard",[ld]:"Cineon",[cd]:"ACESFilmic",[fd]:"AgX",[dd]:"Neutral",[ud]:"Custom"};function Nx(n,e){const t=Ux[e];return t===void 0?(qe("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const qs=new H;function Fx(){tt.getLuminanceCoefficients(qs);const n=qs.x.toFixed(4),e=qs.y.toFixed(4),t=qs.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+h);const E=y+g+a,x=y+h+o,A=ku(r,r.VERTEX_SHADER,E),M=ku(r,r.FRAGMENT_SHADER,x);r.attachShader(b,A),r.attachShader(b,M),t.index0AttributeName!==void 0?r.bindAttribLocation(b,0,t.index0AttributeName):t.hasPositionAttribute===!0&&r.bindAttribLocation(b,0,"position"),r.linkProgram(b);function C(L){if(n.debug.checkShaderErrors){const k=r.getProgramInfoLog(b)||"",te=r.getShaderInfoLog(A)||"",se=r.getShaderInfoLog(M)||"",V=k.trim(),J=te.trim(),z=se.trim();let Y=!0,le=!0;if(r.getProgramParameter(b,r.LINK_STATUS)===!1)if(Y=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,b,A,M);else{const ve=Vu(r,A,"vertex"),xe=Vu(r,M,"fragment");ot("WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(b,r.VALIDATE_STATUS)+`
...
}`,_S=[new H(1,0,0),new H(-1,0,0),new H(0,1,0),new H(0,-1,0),new H(0,0,1),new H(0,0,-1)],vS=[new H(0,-1,0),new H(0,-1,0),new H(0,0,1),new H(0,0,-1),new H(0,-1,0),new H(0,-1,0)],Zu=new Ct,Xr=new H,Do=new H;function xS(n,e,t){let i=new Rd;const r=new it,s=new it,a=new Et,o=new Lg,l=new Ug,c={},u=t.maxTextureSize,d={[Di]:jt,[jt]:Di,[ri]:ri},f=new An({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new it},radius:{value:4}},vertexShader:mS,fragmentShader:gS}),m=f.clone();m.defines.HORIZONTAL_PASS=1;const v=new $n;v.setAttribute("position",new Gn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const b=new qn(v,f),g=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Qs;let h=this.type;this.render=function(M,C,_){if(g.enabled===!1||g.autoUpdate===!1&&g.needsUpdate===!1||M.length===0)return;this.type===bm&&(qe("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=Qs);const w=n.getRenderTarget(),N=n.getActiveCubeFace(),L=n.getActiveMipmapLevel(),k=n.state;k.setBlending(li),k.buffers.depth.getReversed()===!0?k.buffers.color.setClear(0,0,0,0):k.buffers.color.setClear(1,1,1,1),k.buffers.depth.setTest(!0),k.setScissorTest(!1);const te=h!==this.type;te&&C.traverse(function(se){se.material&&(Array.isArray(se.material)?se.material.forEach(V=>V.needsUpdate=!0):se.material.needsUpdate=!0)});for(let se=0,V=M.length;se<V;se++){const J=M[se],z=J.shadow;if(z===void 0){qe("WebGLShadowMap:",J,"has no shadow.");continue}if(z.autoUpdate===!1&&z.needsUpdate===!1)continue;r.copy(z.mapSize);const Y=z.getFrameExtents();r.multiply(Y),s.copy(z.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/Y.x),r.x=s.x*Y.x,z.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/Y.y),r.y=s.y*Y.y,z.mapSize.y=s.y));const le=n.state.buffers.depth.getReversed();if(z.camera._reversedDepth=le,z.map===null||te===!0){if(z.map!==null&&(z.map.depthTexture!==null&&(z.map.depthTexture.dispose(),z.map.depthTexture=null),z.map.dispose()),this.type===Yr){if(J.isPointLight){qe("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}z.map=new Vn(r.x,r.y,{format:Ji,type:pi,minFilter:Vt,magFilter:Vt,generateMipmaps:!1}),z.map.texture.name=J.name+".shadowMap",z.map.depthTexture=new Dr(r.x,r.y,Bn),z.map.depthTexture.name=J.name+".shadowMapDepth",z.map.depthTexture.format=mi,z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=Nt,z.map.depthTexture.magFilter=Nt}else J.isPointLight?(z.map=new Fd(r.x),z.map.depthTexture=new wg(r.x,Xn)):(z.map=new Vn(r.x,r.y),z.map.depthTexture=new Dr(r.x,r.y,Xn)),z.map.depthTexture.name=J.name+".shadowMap",z.map.depthTexture.format=mi,this.type===Qs?(z.map.depthTexture.compareFunction=le?rc:ic,z.map.depthTexture.minFilter=Vt,z.map.depthTexture.magFilter=Vt):(z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=Nt,z.map.depthTexture.magFilter=Nt);z.camera.updateProjectionMatrix()}const ve=z.map.isWebGLCubeRenderTarget?6:1;for(let xe=0;xe<ve;xe++){if(z.map.isWebGLCubeRenderTarget)n.setRenderTarget(z.map,xe),n.clear();else{xe===0&&(n.setRenderTarget(z.map),n.clear());const Ae=z.getViewport(xe);a.set(s.x*Ae.x,s.y*Ae.y,s.x*Ae.z,s.y*Ae.w),k.viewport(a)}if(J.isPointLight){const Ae=z.camera,rt=z.matrix,Mt=J.distance||Ae.far;Mt!==Ae.far&&(Ae.far=Mt,Ae.updateProjectionMatrix()),Xr.setFromMatrixPosition(J.matrixWorld),Ae.position.copy(Xr),Do.copy(Ae.position),Do.add(_S[xe]),Ae.up.copy(vS[xe]),Ae.lookAt(Do),Ae.updateMatrixWorld(),rt.makeTranslation(-Xr.x,-Xr.y,-Xr.z),Zu.multiplyMatrices(Ae.projectionMatrix,Ae.matrixWorldInverse),z._frustum.setFromProjectionMatrix(Zu,Ae.coordinateSystem,Ae.reversedDepth)}else z.updateMatrices(J);i=z.getFrustum(),x(C,_,z.camera,J,this.type)}z.isPointLightShadow!==!0&&this.type===Yr&&y(z,_),z.needsUpdate=!1}h=this.type,g.needsUpdate=!1,n.setRenderTarget(w,N,L)};function y(M,C){const _=e.update(b);f.defines.VSM_SAMPLES!==M.blurSamples&&(f.defines.VSM_SAMPLES=M.blurSamples,m.defines.VSM_SAMPLES=M.blurSamples,f.needsUpdate=!0,m.needsUpdate=!0),M.mapPass===null&&(M.mapPass=new Vn(r.x,r.y,{format:Ji,type:pi})),f.uniforms.shadow_pass.value=M.map.depthTexture,f.uniforms.resolution.value=M.mapSize,f.uniforms.radius.value=M.radius,n.setRenderTarget(M.mapPass),n.clear(),n.renderBufferDirect(C,null,_,f,b,null),m.uniforms.shadow_pass.value=M.mapPass.texture,m.uniforms.resolution.value=M.mapSize,m.uniforms.radius.value=M.radius,n.setRenderTarget(M.map),n.clear(),n.renderBufferDirect(C,null,_,m,b,null)}function E(M,C,_,w){let N=null;const L=_.isPointLight===!0?M.customDistanceMaterial:M.customDepthMaterial;if(L!==void 0)N=L;else if(N=_.isPointLight===!0?l:o,n.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0||C.alphaToCoverage===!0){const k=N.uuid,te=C.uuid;let se=c[k];se===void 0&&(se={},c[k]=se);let V=se[te];V===void 0&&(V=N.clone(),se[te]=V,C.addEventListener("dispose",A)),N=V}if(N.visible=C.visible,N.wireframe=C.wireframe,w===Yr?N.side=C.shadowSide!==null?C.shadowSide:C.side:N.side=C.shadowSide!==null?C.shadowSide:d[C.side],N.alphaMap=C.alphaMap,N.alphaTest=C.alphaToCoverage===!0?.5:C.alphaTest,N.map=C.map,N.clipShadows=C.clipShadows,N.clippingPlanes=C.clippingPlanes,N.clipIntersection=C.clipIntersection,N.displacementMap=C.displacementMap,N.displacementScale=C.displacementScale,N.displacementBias=C.displacementBias,N.wireframeLinewidth=C.wireframeLinewidth,N.linewidth=C.linewidth,_.isPointLight===!0&&N.isMeshDistanceMaterial===!0){const k=n.properties.get(N);k.light=_}return N}function x(M,C,_,w,N){if(M.visible===!1)return;if(M.layers.test(C.layers)&&(M.isMesh||M.isLine||M.isPoints)&&(M.castShadow||M.receiveShadow&&N===Yr)&&(!M.frustumCulled||i.intersectsObject(M))){M.modelViewMatrix.multiplyMatrices(_.matrixWorldInverse,M.matrixWorld);const te=e.update(M),se=M.material;if(Array.isArray(se)){const V=te.groups;for(let J=0,z=V.length;J<z;J++){const Y=V[J],le=se[Y.materialIndex];if(le&&le.visible){const ve=E(M,le,w,N);M.onBeforeShadow(n,M,C,_,te,ve,Y),n.renderBufferDirect(_,null,te,ve,M,Y),M.onAfterShadow(n,M,C,_,te,ve,Y)}}}else if(se.visible){const V=E(M,se,w,N);M.onBeforeShadow(n,M,C,_,te,V,null),n.renderBufferDirect(_,null,te,V,M,null),M.onAfterShadow(n,M,C,_,te,V,null)}}const k=M.children;for(let te=0,se=k.length;te<se;te++)x(k[te],C,_,w,N)}function A(M){M.target.removeEventListener("dispose",A);for(const _ in c){const w=c[_],N=M.target.uuid;N in w&&(w[N].dispose(),delete w[N])}}}function SS(n,e){function t(){let F=!1;const Se=new Et;let re=null;const be=new Et(0,0,0,0);return{setMask:function(Ce){re!==Ce&&!F&&(n.colorMask(Ce,Ce,Ce,Ce),re=Ce)},setLocked:function(Ce){F=Ce},setClear:function(Ce,ae,Be,Ne,bt){bt===!0&&(Ce*=Ne,ae*=Ne,Be*=Ne),Se.set(Ce,ae,Be,Ne),be.equals(Se)===!1&&(n.clearColor(Ce,ae,Be,Ne),be.copy(Se))},reset:function(){F=!1,re=null,be.set(-1,0,0,0)}}}function i(){let F=!1,Se=!1,re=null,be=null,Ce=null;return{setReversed:function(ae){if(Se!==ae){const Be=e.get("EXT_clip_control");ae?Be.clipControlEXT(Be.LOWER_LEFT_EXT,Be.ZERO_TO_ONE_EXT):Be.clipControlEXT(Be.LOWER_LEFT_EXT,Be.NEGATIVE_ONE_TO_ONE_EXT),Se=ae;const Ne=Ce;Ce=null,this.setClear(Ne)}},getReversed:function(){return Se},setTest:function(ae){ae?fe(n.DEPTH_TEST):We(n.DEPTH_TEST)},setMask:function(ae){re!==ae&&!F&&(n.depthMask(ae),re=ae)},setFunc:function(ae){if(Se&&(ae=tg[ae]),be!==ae){switch(ae){case Wo:n.depthFunc(n.NEVER);break;case Xo:n.depthFunc(n.ALWAYS);break;case qo:n.depthFunc(n.LESS);break;case Cr:n.depthFunc(n.LEQUAL);break;case $o:n.depthFunc(n.EQUAL);break;case Yo:n.depthFunc(n.GEQUAL);break;case Ko:n.depthFunc(n.GREATER);break;case Zo:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}be=ae}},setLocked:function(ae){F=ae},setClear:function(ae){Ce!==ae&&(Ce=ae,Se&&(ae=1-ae),n.clearDepth(ae))},reset:function(){F=!1,re=null,be=null,Ce=null,Se=!1}}}function r(){let F=!1,Se=null,re=null,be=null,Ce=null,ae=null,Be=null,Ne=null,bt=null;return{setTest:function(vt){F||(vt?fe(n.STENCIL_TEST):We(n.STENCIL_TEST))},setMask:function(vt){Se!==vt&&!F&&(n.stencilMask(vt),Se=vt)},setFunc:function(vt,wn,Rn){(re!==vt||be!==wn||Ce!==Rn)&&(n.stencilFunc(vt,wn,Rn),re=vt,be=wn,Ce=Rn)},setOp:function(vt,wn,Rn){(ae!==vt||Be!==wn||Ne!==Rn)&&(n.stencilOp(vt,wn,Rn),ae=vt,Be=wn,Ne=Rn)},setLocked:function(vt){F=vt},setClear:function(vt){bt!==vt&&(n.clearStencil(vt),bt=vt)},reset:function(){F=!1,Se=null,re=null,be=null,Ce=null,ae=null,Be=null,Ne=null,bt=null}}}const s=new t,a=new i,o=new r,l=new WeakMap,c=new WeakMap;let u={},d={},f={},m=new WeakMap,v=[],b=null,g=!1,h=null,y=null,E=null,x=null,A=null,M=null,C=null,_=new ut(0,0,0),w=0,N=!1,L=null,k=null,te=null,se=null,V=null;const J=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let z=!1,Y=0;const le=n.getParameter(n.VERSION);le.indexOf("WebGL")!==-1?(Y=parseFloat(/^WebGL (\d)/.exec(le)[1]),z=Y>=1):le.indexOf("OpenGL ES")!==-1&&(Y=parseFloat(/^OpenGL ES (\d)/.exec(le)[1]),z=Y>=2);let ve=null,xe={};const Ae=n.getParameter(n.SCISSOR_BOX),rt=n.getParameter(n.VIEWPORT),Mt=new Et().fromArray(Ae),st=new Et().fromArray(rt);function ne(F,Se,re,be){const Ce=new Uint8Array(4),ae=n.createTexture();n.bindTexture(F,ae),n.texParameteri(F,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(F,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Be=0;Be<re;Be++)F===n.TEXTURE_3D||F===n.TEXTURE_2D_ARRAY?n.texImage3D(Se,0,n.RGBA,1,1,be,0,n.RGBA,n.UNSIGNED_BYTE,Ce):n.texImage2D(Se+Be,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,Ce);return ae}const me={};me[n.TEXTURE_2D]=ne(n.TEXTURE_2D,n.TEXTURE_2D,1),me[n.TEXTURE_CUBE_MAP]=ne(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),me[n.TEXTURE_2D_ARRAY]=ne(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),me[n.TEXTURE_3D]=ne(n.TEXTURE_3D,n.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),fe(n.DEPTH_TEST),a.setFunc(Cr),ee(!1),de(jc),fe(n.CULL_FACE),Q(li);function fe(F){u[F]!==!0&&(n.enable(F),u[F]=!0)}function We(F){u[F]!==!1&&(n.disable(F),u[F]=!1)}function Xe(F,Se){return f[F]!==Se?(n.bindFramebuffer(F,Se),f[F]=Se,F===n.DRAW_FRAMEBUFFER&&(f[n.FRAMEBUFFER]=Se),F===n.FRAMEBUFFER&&(f[n.DRAW_FRAMEBUFFER]=Se),!0):!1}function Ve(F,Se){let re=v,be=!1;if(F){re=m.get(Se),re===void 0&&(re=[],m.set(Se,re));const Ce=F.textures;if(re.length!==Ce.length||re[0]!==n.COLOR_ATTACHMENT0){for(let ae=0,Be=Ce.length;ae<Be;ae++)re[ae]=n.COLOR_ATTACHMENT0+ae;re.length=Ce.length,be=!0}}else re[0]!==n.BACK&&(re[0]=n.BACK,be=!0);be&&n.drawBuffers(re)}function P(F){return b!==F?(n.useProgram(F),b=F,!0):!1}const I={[Vi]:n.FUNC_ADD,[Em]:n.FUNC_SUBTRACT,[Tm]:n.FUNC_REVERSE_SUBTRACT};I[Am]=n.MIN,I[wm]=n.MAX;const W={[Rm]:n.ZERO,[Cm]:n.ONE,[Pm]:n.SRC_COLOR,[Vo]:n.SRC_ALPHA,[Fm]:n.SRC_ALPHA_SATURATE,[Um]:n.DST_COLOR,[Im]:n.DST_ALPHA,[Dm]:n.ONE_MINUS_SRC_COLOR,[Go]:n.ONE_MINUS_SRC_ALPHA,[Nm]:n.ONE_MINUS_DST_COLOR,[Lm]:n.ONE_MINUS_DST_ALPHA,[Om]:n.CONSTANT_COLOR,[Bm]:n.ONE_MINUS_CONSTANT_COLOR,[zm]:n.CONSTANT_ALPHA,[km]:n.ONE_MINUS_CONSTANT_ALPHA};function Q(F,Se,re,be,Ce,ae,Be,Ne,bt,vt){if(F===li){g===!0&&(We(n.BLEND),g=!1);return}if(g===!1&&(fe(n.BLEND),g=!0),F!==ym){if(F!==h||vt!==N){if((y!==Vi||A!==Vi)&&(n.blendEquation(n.FUNC_ADD),y=Vi,A=Vi),vt)switch(F){case Er:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case eu:n.blendFunc(n.ONE,n.ONE);break;case tu:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case nu:n.blendFuncSeparate(n.DST_COLOR,n.ONE_MINUS_SRC_ALPHA,n.ZERO,n.ONE);break;default:ot("WebGLState: Invalid blending: ",F);break}else switch(F){case Er:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case eu:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE,n.ONE,n.ONE);break;case tu:ot("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case nu:ot("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:ot("WebGLState: Invalid blending: ",F);break}E=null,x=null,M=null,C=null,_.set(0,0,0),w=0,h=F,N=vt}return}Ce=Ce||Se,ae=ae||re,Be=Be||be,(Se!==y||Ce!==A)&&(n.blendEquationSeparate(I[Se],I[Ce]),y=Se,A=Ce),(re!==E||be!==x||ae!==M||Be!==C)&&(n.blendFuncSeparate(W[re],W[be],W[ae],W[Be]),E=re,x=be,M=ae,C=Be),(Ne.equals(_)===!1||bt!==w)&&(n.blendColor(Ne.r,Ne.g,Ne.b,bt),_.copy(Ne),w=bt),h=F,N=!1}function K(F,Se){F.side===ri?We(n.CULL_FACE):fe(n.CULL_FACE);let re=F.side===jt;Se&&(re=!re),ee(re),F.blending===Er&&F.transparent===!1?Q(li):Q(F.blending,F.blendEquation,F.blendSrc,F.blendDst,F.blendEquationAlpha,F.blendSrcAlpha,F.blendDstAlpha,F.blendColor,F.blendAlpha,F.premultipliedAlpha),a.setFunc(F.depthFunc),a.setTest(F.depthTest),a.setMask(F.depthWrite),s.setMask(F.colorWrite);const be=F.stencilWrite;o.setTest(be),be&&(o.setMask(F.stencilWriteMask),o.setFunc(F.stencilFunc,F.stencilRef,F.stencilFuncMask),o.setOp(F.stencilFail,F.stencilZFail,F.stencilZPass)),oe(F.polygonOffset,F.polygonOffsetFactor,F.polygonOffsetUnits),F.alphaToCoverage===!0?fe(n.SAMPLE_ALPHA_TO_COVERAGE):We(n.SAMPLE_ALPHA_TO_COVERAGE)}function ee(F){L!==F&&(F?n.frontFace(n.CW):n.frontFace(n.CCW),L=F)}function de(F){F!==Sm?(fe(n.CULL_FACE),F!==k&&(F===jc?n.cullFace(n.BACK):F===Mm?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):We(n.CULL_FACE),k=F}function ce(F){F!==te&&(z&&n.lineWidth(F),te=F)}function oe(F,Se,re){F?(fe(n.POLYGON_OFFSET_FILL),(se!==Se||V!==re)&&(se=Se,V=re,a.getReversed()&&(Se=-Se),n.polygonOffset(Se,re))):We(n.POLYGON_OFFSET_FILL)}function j(F){F?fe(n.SCISSOR_TEST):We(n.SCISSOR_TEST)}function Pe(F){F===void 0&&(F=n.TEXTURE0+J-1),ve!==F&&(n.activeTexture(F),ve=F)}function R(F,Se,re){re===void 0&&(ve===null?re=n.TEXTURE0+J-1:re=ve);let be=xe[re];be===void 0&&(be={type:void 0,texture:void 0},xe[re]=be),(be.type!==F||be.texture!==Se)&&(ve!==re&&(n.activeTexture(re),ve=re),n.bindTexture(F,Se||me[F]),be.type=F,be.texture=Se)}function De(){const F=xe[ve];F!==void 0&&F.type!==void 0&&(n.bindTexture(F.type,null),F.type=void 0,F.texture=void 0)}function ye(){try{n.compressedTexImage2D(...arguments)}catch(F){ot("WebGLState:",F)}}function T(){try{n.compressedTexImage3D(...arguments)}catch(F){ot("WebGLState:",F)}}function p(){try{n.texSubImage2D(...arguments)}catch(F){ot("WebGLState:",F)}}function U(){try{n.texSubImage3D(...arguments)}catch(F){ot("WebGLState:",F)}}function B(){try{n.compressedTexSubImage2D(...arguments)}catch(F){ot("WebGLState:",F)}}function q(){try{n.compressedTexSubImage3D(...arguments)}catch(F){ot("WebGLState:",F)}}function ue(){try{n.texStorage2D(...arguments)}catch(F){ot("WebGLState:",F)}}function pe(){try{n.texStorage3D(...arguments)}catch(F){ot("WebGLState:",F)}}function Z(){try{n.texImage2D(...arguments)}catch(F){ot("WebGLState:",F)}}function ie(){try{n.texImage3D(...arguments)}catch(F){ot("WebGLState:",F)}}function he(F){return d[F]!==void 0?d[F]:n.getParameter(F)}function Ie(F,Se){d[F]!==Se&&(n.pixelStorei(F,Se),d[F]=Se)}function Me(F){Mt.equals(F)===!1&&(n.scissor(F.x,F.y,F.z,F.w),Mt.copy(F))}function _e(F){st.equals(F)===!1&&(n.viewport(F.x,F.y,F.z,F.w),st.copy(F))}function He(F,Se){let re=c.get(Se);re===void 0&&(re=new WeakMap,c.set(Se,re));let be=re.get(F);be===void 0&&(be=n.getUniformBlockIndex(Se,F.name),re.set(F,be))}function Ge(F,Se){const be=c.get(Se).get(F);l.get(Se)!==be&&(n.uniformBlockBinding(Se,be,F.__bindingPointIndex),l.set(Se,be))}function Ze(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),a.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),n.pixelStorei(n.PACK_ALIGNMENT,4),n.pixelStorei(n.UNPACK_ALIGNMENT,4),n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,!1),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,n.BROWSER_DEFAULT_WEBGL),n.pixelStorei(n.PACK_ROW_LENGTH,0),n.pixelStorei(n.PACK_SKIP_PIXELS,0),n.pixelStorei(n.PACK_SKIP_ROWS,0),n.pixelStorei(n.UNPACK_ROW_LENGTH,0),n.pixelStorei(n.UNPACK_IMAGE_HEIGHT,0),n.pixelStorei(n.UNPACK_SKIP_PIXELS,0),n.pixelStorei(n.UNPACK_SKIP_ROWS,0),n.pixelStorei(n.UNPACK_SKIP_IMAGES,0),u={},d={},ve=null,xe={},f={},m=new WeakMap,v=[],b=null,g=!1,h=null,y=null,E=null,x=null,A=null,M=null,C=null,_=new ut(0,0,0),w=0,N=!1,L=null,k=null,te=null,se=null,V=null,Mt.set(0,0,n.canvas.width,n.canvas.height),st.set(0,0,n.canvas.width,n.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:fe,disable:We,bindFramebuffer:Xe,drawBuffers:Ve,useProgram:P,setBlending:Q,setMaterial:K,setFlipSided:ee,setCullFace:de,setLineWidth:ce,setPolygonOffset:oe,setScissorTest:j,activeTexture:Pe,bindTexture:R,unbindTexture:De,compressedTexImage2D:ye,compressedTexImage3D:T,texImage2D:Z,texImage3D:ie,pixelStorei:Ie,getParameter:he,updateUBOMapping:He,uniformBlockBinding:Ge,texStorage2D:ue,texStorage3D:pe,texSubImage2D:p,texSubImage3D:U,compressedTexSubImage2D:B,compressedTexSubImage3D:q,scissor:Me,viewport:_e,reset:Ze}}function MS(n,e,t,i,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new it,u=new WeakMap,d=new Set;let f;const m=new WeakMap;let v=!1;try{v=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function b(T,p){return v?new OffscreenCanvas(T,p):va("canvas")}function g(T,p,U){let B=1;const q=ye(T);if((q.width>U||q.height>U)&&(B=U/Math.max(q.width,q.height)),B<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){const ue=Math.floor(B*q.width),pe=Math.floor(B*q.height);f===void 0&&(f=b(ue,pe));const Z=p?b(ue,pe):f;return Z.width=ue,Z.height=pe,Z.getContext("2d").drawImage(T,0,0,ue,pe),qe("WebGLRenderer: Texture has been resized from ("+q.width+"x"+q.height+") to ("+ue+"x"+pe+")."),Z}else return"data"in T&&qe("WebGLRenderer: Image in DataTexture is too big ("+q.width+"x"+q.height+")."),T;return T}function h(T){return T.generateMipmaps}function y(T){n.generateMipmap(T)}function E(T){return T.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:T.isWebGL3DRenderTarget?n.TEXTURE_3D:T.isWebGLArrayRenderTarget||T.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function x(T,p,U,B,q,ue=!1){if(T!==null){if(n[T]!==void 0)return n[T];qe("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let pe;B&&(pe=e.get("EXT_texture_norm16"),pe||qe("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let Z=p;if(p===n.RED&&(U===n.FLOAT&&(Z=n.R32F),U===n.HALF_FLOAT&&(Z=n.R16F),U===n.UNSIGNED_BYTE&&(Z=n.R8),U===n.UNSIGNED_SHORT&&pe&&(Z=pe.R16_EXT),U===n.SHORT&&pe&&(Z=pe.R16_SNORM_EXT)),p===n.RED_INTEGER&&(U===n.UNSIGNED_BYTE&&(Z=n.R8UI),U===n.UNSIGNED_SHORT&&(Z=n.R16UI),U===n.UNSIGNED_INT&&(Z=n.R32UI),U===n.BYTE&&(Z=n.R8I),U===n.SHORT&&(Z=n.R16I),U===n.INT&&(Z=n.R32I)),p===n.RG&&(U===n.FLOAT&&(Z=n.RG32F),U===n.HALF_FLOAT&&(Z=n.RG16F),U===n.UNSIGNED_BYTE&&(Z=n.RG8),U===n.UNSIGNED_SHORT&&pe&&(Z=pe.RG16_EXT),U===n.SHORT&&pe&&(Z=pe.RG16_SNORM_EXT)),p===n.RG_INTEGER&&(U===n.UNSIGNED_BYTE&&(Z=n.RG8UI),U===n.UNSIGNED_SHORT&&(Z=n.RG16UI),U===n.UNSIGNED_INT&&(Z=n.RG32UI),U===n.BYTE&&(Z=n.RG8I),U===n.SHORT&&(Z=n.RG16I),U===n.INT&&(Z=n.RG32I)),p===n.RGB_INTEGER&&(U===n.UNSIGNED_BYTE&&(Z=n.RGB8UI),U===n.UNSIGNED_SHORT&&(Z=n.RGB16UI),U===n.UNSIGNED_INT&&(Z=n.RGB32UI),U===n.BYTE&&(Z=n.RGB8I),U===n.SHORT&&(Z=n.RGB16I),U===n.INT&&(Z=n.RGB32I)),p===n.RGBA_INTEGER&&(U===n.UNSIGNED_BYTE&&(Z=n.RGBA8UI),U===n.UNSIGNED_SHORT&&(Z=n.RGBA16UI),U===n.UNSIGNED_INT&&(Z=n.RGBA32UI),U===n.BYTE&&(Z=n.RGBA8I),U===n.SHORT&&(Z=n.RGBA16I),U===n.INT&&(Z=n.RGBA32I)),p===n.RGB&&(U===n.UNSIGNED_SHORT&&pe&&(Z=pe.RGB16_EXT),U===n.SHORT&&pe&&(Z=pe.RGB16_SNORM_EXT),U===n.UNSIGNED_INT_5_9_9_9_REV&&(Z=n.RGB9_E5),U===n.UNSIGNED_INT_10F_11F_11F_REV&&(Z=n.R11F_G11F_B10F)),p===n.RGBA){const ie=ue?ga:tt.getTransfer(q);U===n.FLOAT&&(Z=n.RGBA32F),U===n.HALF_FLOAT&&(Z=n.RGBA16F),U===n.UNSIGNED_BYTE&&(Z=ie===ft?n.SRGB8_ALPHA8:n.RGBA8),U===n.UNSIGNED_SHORT&&pe&&(Z=pe.RGBA16_EXT),U===n.SHORT&&pe&&(Z=pe.RGBA16_SNORM_EXT),U===n.UNSIGNED_SHORT_4_4_4_4&&(Z=n.RGBA4),U===n.UNSIGNED_SHORT_5_5_5_1&&(Z=n.RGB5_A1)}return(Z===n.R16F||Z===n.R32F||Z===n.RG16F||Z===n.RG32F||Z===n.RGBA16F||Z===n.RGBA32F)&&e.get("EXT_color_buffer_float"),Z}function A(T,p){let U;return T?p===null||p===Xn||p===cs?U=n.DEPTH24_STENCIL8:p===Bn?U=n.DEPTH32F_STENCIL8:p===ls&&(U=n.DEPTH24_STENCIL8,qe("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):p===null||p===Xn||p===cs?U=n.DEPTH_COMPONENT24:p===Bn?U=n.DEPTH_COMPONENT32F:p===ls&&(U=n.DEPTH_COMPONENT16),U}function M(T,p){return h(T)===!0||T.isFramebufferTexture&&T.minFilter!==Nt&&T.minFilter!==Vt?Math.log2(Math.max(p.width,p.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?p.mipmaps.length:1}function C(T){const p=T.target;p.removeEventListener("dispose",C),w(p),p.isVideoTexture&&u.delete(p),p.isHTMLTexture&&d.delete(p)}function _(T){const p=T.target;p.removeEventListener("dispose",_),L(p)}function w(T){const p=i.get(T);if(p.__webglInit===void 0)return;const U=T.source,B=m.get(U);if(B){const q=B[p.__cacheKey];q.usedTimes--,q.usedTimes===0&&N(T),Object.keys(B).length===0&&m.delete(U)}i.remove(T)}function N(T){const p=i.get(T);n.deleteTexture(p.__webglTexture);const U=T.source,B=m.get(U);delete B[p.__cacheKey],a.memory.textures--}function L(T){const p=i.get(T);if(T.depthTexture&&(T.depthTexture.dispose(),i.remove(T.depthTexture)),T.isWebGLCubeRenderTarget)for(let B=0;B<6;B++){if(Array.isArray(p.__webglFramebuffer[B]))for(let q=0;q<p.__webglFramebuffer[B].length;q++)n.deleteFramebuffer(p.__webglFramebuffer[B][q]);else n.deleteFramebuffer(p.__webglFramebuffer[B]);p.__webglDepthbuffer&&n.deleteRenderbuffer(p.__webglDepthbuffer[B])}else{if(Array.isArray(p.__webglFramebuffer))for(let B=0;B<p.__webglFramebuffer.length;B++)n.deleteFramebuffer(p.__webglFramebuffer[B]);else n.deleteFramebuffer(p.__webglFramebuffer);if(p.__webglDepthbuffer&&n.deleteRenderbuffer(p.__webglDepthbuffer),p.__webglMultisampledFramebuffer&&n.deleteFramebuffer(p.__webglMultisampledFramebuffer),p.__webglColorRenderbuffer)for(let B=0;B<p.__webglColorRenderbuffer.length;B++)p.__webglColorRenderbuffer[B]&&n.deleteRenderbuffer(p.__webglColorRenderbuffer[B]);p.__webglDepthRenderbuffer&&n.deleteRenderbuffer(p.__webglDepthRenderbuffer)}const U=T.textures;for(let B=0,q=U.length;B<q;B++){const ue=i.get(U[B]);ue.__webglTexture&&(n.deleteTexture(ue.__webglTexture),a.memory.textures--),i.remove(U[B])}i.remove(T)}let k=0;function te(){k=0}function se(){return k}function V(T){k=T}function J(){const T=k;return T>=r.maxTextures&&qe("WebGLTextures: Trying to use "+T+" texture units while this GPU supports only "+r.maxTextures),k+=1,T}function z(T){const p=[];return p.push(T.wrapS),p.push(T.wrapT),p.push(T.wrapR||0),p.push(T.magFilter),p.push(T.minFilter),p.push(T.anisotropy),p.push(T.internalFormat),p.push(T.format),p.push(T.type),p.push(T.generateMipmaps),p.push(T.premultiplyAlpha),p.push(T.flipY),p.push(T.unpackAlignment),p.push(T.colorSpace),p.join()}function Y(T,p){const U=i.get(T);if(T.isVideoTexture&&R(T),T.isRenderTargetTexture===!1&&T.isExternalTexture!==!0&&T.version>0&&U.__version!==T.version){const B=T.image;if(B===null)qe("WebGLRenderer: Texture marked for update but no image data found.");else if(B.complete===!1)qe("WebGLRenderer: Texture marked for update but image is incomplete");else{We(U,T,p);return}}else T.isExternalTexture&&(U.__webglTexture=T.sourceTexture?T.sourceTexture:null);t.bindTexture(n.TEXTURE_2D,U.__webglTexture,n.TEXTURE0+p)}function le(T,p){const U=i.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&U.__version!==T.version){We(U,T,p);return}else T.isExternalTexture&&(U.__webglTexture=T.sourceTexture?T.sourceTexture:null);t.bindTexture(n.TEXTURE_2D_ARRAY,U.__webglTexture,n.TEXTURE0+p)}function ve(T,p){const U=i.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&U.__version!==T.version){We(U,T,p);return}t.bindTexture(n.TEXTURE_3D,U.__webglTexture,n.TEXTURE0+p)}function xe(T,p){const U=i.get(T);if(T.isCubeDepthTexture!==!0&&T.version>0&&U.__version!==T.version){Xe(U,T,p);return}t.bindTexture(n.TEXTURE_CUBE_MAP,U.__webglTexture,n.TEXTURE0+p)}const Ae={[Jo]:n.REPEAT,[oi]:n.CLAMP_TO_EDGE,[Qo]:n.MIRRORED_REPEAT},rt={[Nt]:n.NEAREST,[Gm]:n.NEAREST_MIPMAP_NEAREST,[Es]:n.NEAREST_MIPMAP_LINEAR,[Vt]:n.LINEAR,[eo]:n.LINEAR_MIPMAP_NEAREST,[Wi]:n.LINEAR_MIPMAP_LINEAR},Mt={[qm]:n.NEVER,[Jm]:n.ALWAYS,[$m]:n.LESS,[ic]:n.LEQUAL,[Ym]:n.EQUAL,[rc]:n.GEQUAL,[Km]:n.GREATER,[Zm]:n.NOTEQUAL};function st(T,p){if(p.type===Bn&&e.has("OES_texture_float_linear")===!1&&(p.magFilter===Vt||p.magFilter===eo||p.magFilter===Es||p.magFilter===Wi||p.minFilter===Vt||p.minFilter===eo||p.minFilter===Es||p.minFilter===Wi)&&qe("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(T,n.TEXTURE_WRAP_S,Ae[p.wrapS]),n.texParameteri(T,n.TEXTURE_WRAP_T,Ae[p.wrapT]),(T===n.TEXTURE_3D||T===n.TEXTURE_2D_ARRAY)&&n.texParameteri(T,n.TEXTURE_WRAP_R,Ae[p.wrapR]),n.texParameteri(T,n.TEXTURE_MAG_FILTER,rt[p.magFilter]),n.texParameteri(T,n.TEXTURE_MIN_FILTER,rt[p.minFilter]),p.compareFunction&&(n.texParameteri(T,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(T,n.TEXTURE_COMPARE_FUNC,Mt[p.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(p.magFilter===Nt||p.minFilter!==Es&&p.minFilter!==Wi||p.type===Bn&&e.has("OES_texture_float_linear")===!1)return;if(p.anisotropy>1||i.get(p).__currentAnisotropy){const U=e.get("EXT_texture_filter_anisotropic");n.texParameterf(T,U.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(p.anisotropy,r.getMaxAnisotropy())),i.get(p).__currentAnisotropy=p.anisotropy}}}function ne(T,p){let U=!1;T.__webglInit===void 0&&(T.__webglInit=!0,p.addEventListener("dispose",C));const B=p.source;let q=m.get(B);q===void 0&&(q={},m.set(B,q));const ue=z(p);if(ue!==T.__cacheKey){q[ue]===void 0&&(q[ue]={texture:n.createTexture(),usedTimes:0},a.memory.textures++,U=!0),q[ue].usedTimes++;const pe=q[T.__cacheKey];pe!==void 0&&(q[T.__cacheKey].usedTimes--,pe.usedTimes===0&&N(p)),T.__cacheKey=ue,T.__webglTexture=q[ue].texture}return U}function me(T,p,U){return Math.floor(Math.floor(T/U)/p)}function fe(T,p,U,B){const ue=T.updateRanges;if(ue.length===0)t.texSubImage2D(n.TEXTURE_2D,0,0,0,p.width,p.height,U,B,p.data);else{ue.sort((Ie,Me)=>Ie.start-Me.start);let pe=0;for(let Ie=1;Ie<ue.length;Ie++){const Me=ue[pe],_e=ue[Ie],He=Me.start+Me.count,Ge=me(_e.start,p.width,4),Ze=me(Me.start,p.width,4);_e.start<=He+1&&Ge===Ze&&me(_e.start+_e.count-1,p.width,4)===Ge?Me.count=Math.max(Me.count,_e.start+_e.count-Me.start):(++pe,ue[pe]=_e)}ue.length=pe+1;const Z=t.getParameter(n.UNPACK_ROW_LENGTH),ie=t.getParameter(n.UNPACK_SKIP_PIXELS),he=t.getParameter(n.UNPACK_SKIP_ROWS);t.pixelStorei(n.UNPACK_ROW_LENGTH,p.width);for(let Ie=0,Me=ue.length;Ie<Me;Ie++){const _e=ue[Ie],He=Math.floor(_e.start/4),Ge=Math.ceil(_e.count/4),Ze=He%p.width,F=Math.floor(He/p.width),Se=Ge,re=1;t.pixelStorei(n.UNPACK_SKIP_PIXELS,Ze),t.pixelStorei(n.UNPACK_SKIP_ROWS,F),t.texSubImage2D(n.TEXTURE_2D,0,Ze,F,Se,re,U,B,p.data)}T.clearUpdateRanges(),t.pixelStorei(n.UNPACK_ROW_LENGTH,Z),t.pixelStorei(n.UNPACK_SKIP_PIXELS,ie),t.pixelStorei(n.UNPACK_SKIP_ROWS,he)}}function We(T,p,U){let B=n.TEXTURE_2D;(p.isDataArrayTexture||p.isCompressedArrayTexture)&&(B=n.TEXTURE_2D_ARRAY),p.isData3DTexture&&(B=n.TEXTURE_3D);const q=ne(T,p),ue=p.source;t.bindTexture(B,T.__webglTexture,n.TEXTURE0+U);const pe=i.get(ue);if(ue.version!==pe.__version||q===!0){if(t.activeTexture(n.TEXTURE0+U),(typeof ImageBitmap<"u"&&p.image instanceof ImageBitmap)===!1){const re=tt.getPrimaries(tt.workingColorSpace),be=p.colorSpace===wi?null:tt.getPrimaries(p.colorSpace),Ce=p.colorSpace===wi||re===be?n.NONE:n.BROWSER_DEFAULT_WEBGL;t.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,p.flipY),t.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,p.premultiplyAlpha),t.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ce)}t.pixelStorei(n.UNPACK_ALIGNMENT,p.unpackAlignment);let ie=g(p.image,!1,r.maxTextureSize);ie=De(p,ie);const he=s.convert(p.format,p.colorSpace),Ie=s.convert(p.type);let Me=x(p.internalFormat,he,Ie,p.normalized,p.colorSpace,p.isVideoTexture);st(B,p);let _e;const He=p.mipmaps,Ge=p.isVideoTexture!==!0,Ze=pe.__version===void 0||q===!0,F=ue.dataReady,Se=M(p,ie);if(p.isDepthTexture)Me=A(p.format===Xi,p.type),Ze&&(Ge?t.texStorage2D(n.TEXTURE_2D,1,Me,ie.width,ie.height):t.texImage2D(n.TEXTURE_2D,0,Me,ie.width,ie.height,0,he,Ie,null));else if(p.isDataTexture)if(He.length>0){Ge&&Ze&&t.texStorage2D(n.TEXTURE_2D,Se,Me,He[0].width,He[0].height);for(let re=0,be=He.length;re<be;re++)_e=He[re],Ge?F&&t.texSubImage2D(n.TEXTURE_2D,re,0,0,_e.width,_e.height,he,Ie,_e.data):t.texImage2D(n.TEXTURE_2D,re,Me,_e.width,_e.height,0,he,Ie,_e.data);p.generateMipmaps=!1}else Ge?(Ze&&t.texStorage2D(n.TEXTURE_2D,Se,Me,ie.width,ie.height),F&&fe(p,ie,he,Ie)):t.texImage2D(n.TEXTURE_2D,0,Me,ie.width,ie.height,0,he,Ie,ie.data);else if(p.isCompressedTexture)if(p.isCompressedArrayTexture){Ge&&Ze&&t.texStorage3D(n.TEXTURE_2D_ARRAY,Se,Me,He[0].width,He[0].height,ie.depth);for(let re=0,be=He.length;re<be;re++)if(_e=He[re],p.format!==Mn)if(he!==null)if(Ge){if(F)if(p.layerUpdates.size>0){const Ce=wu(_e.width,_e.height,p.format,p.type);for(const ae of p.layerUpdates){const Be=_e.data.subarray(ae*Ce/_e.data.BYTES_PER_ELEMENT,(ae+1)*Ce/_e.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,re,0,0,ae,_e.width,_e.height,1,he,Be)}p.clearLayerUpdates()}else t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,re,0,0,0,_e.width,_e.height,ie.depth,he,_e.data)}else t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,re,Me,_e.width,_e.height,ie.depth,0,_e.data,0,0);else qe("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ge?F&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,re,0,0,0,_e.width,_e.height,ie.depth,he,Ie,_e.data):t.texImage3D(n.TEXTURE_2D_ARRAY,re,Me,_e.width,_e.height,ie.depth,0,he,Ie,_e.data)}else{Ge&&Ze&&t.texStorage2D(n.TEXTURE_2D,Se,Me,He[0].width,He[0].height);for(let re=0,be=He.length;re<be;re++)_e=He[re],p.format!==Mn?he!==null?Ge?F&&t.compressedTexSubImage2D(n.TEXTURE_2D,re,0,0,_e.width,_e.height,he,_e.data):t.compressedTexImage2D(n.TEXTURE_2D,re,Me,_e.width,_e.height,0,_e.data):qe("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ge?F&&t.texSubImage2D(n.TEXTURE_2D,re,0,0,_e.width,_e.height,he,Ie,_e.data):t.texImage2D(n.TEXTURE_2D,re,Me,_e.width,_e.height,0,he,Ie,_e.data)}else if(p.isDataArrayTexture)if(Ge){if(Ze&&t.texStorage3D(n.TEXTURE_2D_ARRAY,Se,Me,ie.width,ie.height,ie.depth),F)if(p.layerUpdates.size>0){const re=wu(ie.width,ie.height,p.format,p.type);for(const be of p.layerUpdates){const Ce=ie.data.subarray(be*re/ie.data.BYTES_PER_ELEMENT,(be+1)*re/ie.data.BYTES_PER_ELEMENT);t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,be,ie.width,ie.height,1,he,Ie,Ce)}p.clearLayerUpdates()}else t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,ie.width,ie.height,ie.depth,he,Ie,ie.data)}else t.texImage3D(n.TEXTURE_2D_ARRAY,0,Me,ie.width,ie.height,ie.depth,0,he,Ie,ie.data);else if(p.isData3DTexture)Ge?(Ze&&t.texStorage3D(n.TEXTURE_3D,Se,Me,ie.width,ie.height,ie.depth),F&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,ie.width,ie.height,ie.depth,he,Ie,ie.data)):t.texImage3D(n.TEXTURE_3D,0,Me,ie.width,ie.height,ie.depth,0,he,Ie,ie.data);else if(p.isFramebufferTexture){if(Ze)if(Ge)t.texStorage2D(n.TEXTURE_2D,Se,Me,ie.width,ie.height);else{let re=ie.width,be=ie.height;for(let Ce=0;Ce<Se;Ce++)t.texImage2D(n.TEXTURE_2D,Ce,Me,re,be,0,he,Ie,null),re>>=1,be>>=1}}else if(p.isHTMLTexture){if("texElementImage2D"in n){const re=n.canvas;if(re.hasAttribute("layoutsubtree")||re.setAttribute("layoutsubtree","true"),ie.parentNode!==re){re.appendChild(ie),d.add(p),re.onpaint=be=>{const Ce=be.changedElements;for(const ae of d)Ce.includes(ae.image)&&(ae.needsUpdate=!0)},re.requestPaint();return}if(n.texElementImage2D.length===3)n.texElementImage2D(n.TEXTURE_2D,n.RGBA8,ie);else{const Ce=n.RGBA,ae=n.RGBA,Be=n.UNSIGNED_BYTE;n.texElementImage2D(n.TEXTURE_2D,0,Ce,ae,Be,ie)}n.texParameteri(n.TEXTURE_2D,n.TEXTURE_MIN_FILTER,n.LINEAR),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_WRAP_S,n.CLAMP_TO_EDGE),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_WRAP_T,n.CLAMP_TO_EDGE)}}else if(He.length>0){if(Ge&&Ze){const re=ye(He[0]);t.texStorage2D(n.TEXTURE_2D,Se,Me,re.width,re.height)}for(let re=0,be=He.length;re<be;re++)_e=He[re],Ge?F&&t.texSubImage2D(n.TEXTURE_2D,re,0,0,he,Ie,_e):t.texImage2D(n.TEXTURE_2D,re,Me,he,Ie,_e);p.generateMipmaps=!1}else if(Ge){if(Ze){const re=ye(ie);t.texStorage2D(n.TEXTURE_2D,Se,Me,re.width,re.height)}F&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,he,Ie,ie)}else t.texImage2D(n.TEXTURE_2D,0,Me,he,Ie,ie);h(p)&&y(B),pe.__version=ue.version,p.onUpdate&&p.onUpdate(p)}T.__version=p.version}function Xe(T,p,U){if(p.image.length!==6)return;const B=ne(T,p),q=p.source;t.bindTexture(n.TEXTURE_CUBE_MAP,T.__webglTexture,n.TEXTURE0+U);const ue=i.get(q);if(q.version!==ue.__version||B===!0){t.activeTexture(n.TEXTURE0+U);const pe=tt.getPrimaries(tt.workingColorSpace),Z=p.colorSpace===wi?null:tt.getPrimaries(p.colorSpace),ie=p.colorSpace===wi||pe===Z?n.NONE:n.BROWSER_DEFAULT_WEBGL;t.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,p.flipY),t.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,p.premultiplyAlpha),t.pixelStorei(n.UNPACK_ALIGNMENT,p.unpackAlignment),t.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,ie);const he=p.isCompressedTexture||p.image[0].isCompressedTexture,Ie=p.image[0]&&p.image[0].isDataTexture,Me=[];for(let ae=0;ae<6;ae++)!he&&!Ie?Me[ae]=g(p.image[ae],!0,r.maxCubemapSize):Me[ae]=Ie?p.image[ae].image:p.image[ae],Me[ae]=De(p,Me[ae]);const _e=Me[0],He=s.convert(p.format,p.colorSpace),Ge=s.convert(p.type),Ze=x(p.internalFormat,He,Ge,p.normalized,p.colorSpace),F=p.isVideoTexture!==!0,Se=ue.__version===void 0||B===!0,re=q.dataReady;let be=M(p,_e);st(n.TEXTURE_CUBE_MAP,p);let Ce;if(he){F&&Se&&t.texStorage2D(n.TEXTURE_CUBE_MAP,be,Ze,_e.width,_e.height);for(let ae=0;ae<6;ae++){Ce=Me[ae].mipmaps;for(let Be=0;Be<Ce.length;Be++){const Ne=Ce[Be];p.format!==Mn?He!==null?F?re&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Be,0,0,Ne.width,Ne.height,He,Ne.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Be,Ze,Ne.width,Ne.height,0,Ne.data):qe("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):F?re&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Be,0,0,Ne.width,Ne.height,He,Ge,Ne.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Be,Ze,Ne.width,Ne.height,0,He,Ge,Ne.data)}}}else{if(Ce=p.mipmaps,F&&Se){Ce.length>0&&be++;const ae=ye(Me[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,be,Ze,ae.width,ae.height)}for(let ae=0;ae<6;ae++)if(Ie){F?re&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0,0,0,Me[ae].width,Me[ae].height,He,Ge,Me[ae].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0,Ze,Me[ae].width,Me[ae].height,0,He,Ge,Me[ae].data);for(let Be=0;Be<Ce.length;Be++){const bt=Ce[Be].image[ae].image;F?re&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Be+1,0,0,bt.width,bt.height,He,Ge,bt.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Be+1,Ze,bt.width,bt.height,0,He,Ge,bt.data)}}else{F?re&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0,0,0,He,Ge,Me[ae]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0,Ze,He,Ge,Me[ae]);for(let Be=0;Be<Ce.length;Be++){const Ne=Ce[Be];F?re&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Be+1,0,0,He,Ge,Ne.image[ae]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Be+1,Ze,He,Ge,Ne.image[ae])}}}h(p)&&y(n.TEXTURE_CUBE_MAP),ue.__version=q.version,p.onUpdate&&p.onUpdate(p)}T.__version=p.version}function Ve(T,p,U,B,q,ue){const pe=s.convert(U.format,U.colorSpace),Z=s.convert(U.type),ie=x(U.internalFormat,pe,Z,U.normalized,U.colorSpace),he=i.get(p),Ie=i.get(U);if(Ie.__renderTarget=p,!he.__hasExternalTextures){const Me=Math.max(1,p.width>>ue),_e=Math.max(1,p.height>>ue);q===n.TEXTURE_3D||q===n.TEXTURE_2D_ARRAY?t.texImage3D(q,ue,ie,Me,_e,p.depth,0,pe,Z,null):t.texImage2D(q,ue,ie,Me,_e,0,pe,Z,null)}t.bindFramebuffer(n.FRAMEBUFFER,T),Pe(p)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,B,q,Ie.__webglTexture,0,j(p)):(q===n.TEXTURE_2D||q>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&q<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,B,q,Ie.__webglTexture,ue),t.bindFramebuffer(n.FRAMEBUFFER,null)}function P(T,p,U){if(n.bindRenderbuffer(n.RENDERBUFFER,T),p.depthBuffer){const B=p.depthTexture,q=B&&B.isDepthTexture?B.type:null,ue=A(p.stencilBuffer,q),pe=p.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;Pe(p)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,j(p),ue,p.width,p.height):U?n.renderbufferStorageMultisample(n.RENDERBUFFER,j(p),ue,p.width,p.height):n.renderbufferStorage(n.RENDERBUFFER,ue,p.width,p.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,pe,n.RENDERBUFFER,T)}else{const B=p.textures;for(let q=0;q<B.length;q++){const ue=B[q],pe=s.convert(ue.format,ue.colorSpace),Z=s.convert(ue.type),ie=x(ue.internalFormat,pe,Z,ue.normalized,ue.colorSpace);Pe(p)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,j(p),ie,p.width,p.height):U?n.renderbufferStorageMultisample(n.RENDERBUFFER,j(p),ie,p.width,p.height):n.renderbufferStorage(n.RENDERBUFFER,ie,p.width,p.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function I(T,p,U){const B=p.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(n.FRAMEBUFFER,T),!(p.depthTexture&&p.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");const q=i.get(p.depthTexture);if(q.__renderTarget=p,(!q.__webglTexture||p.depthTexture.image.width!==p.width||p.depthTexture.image.height!==p.height)&&(p.depthTexture.image.width=p.width,p.depthTexture.image.height=p.height,p.depthTexture.needsUpdate=!0),B){if(q.__webglInit===void 0&&(q.__webglInit=!0,p.depthTexture.addEventListener("dispose",C)),q.__webglTexture===void 0){q.__webglTexture=n.createTexture(),t.bindTexture(n.TEXTURE_CUBE_MAP,q.__webglTexture),st(n.TEXTURE_CUBE_MAP,p.depthTexture);const he=s.convert(p.depthTexture.format),Ie=s.convert(p.depthTexture.type);let Me;p.depthTexture.format===mi?Me=n.DEPTH_COMPONENT24:p.depthTexture.format===Xi&&(Me=n.DEPTH24_STENCIL8);for(let _e=0;_e<6;_e++)n.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+_e,0,Me,p.width,p.height,0,he,Ie,null)}}else Y(p.depthTexture,0);const ue=q.__webglTexture,pe=j(p),Z=B?n.TEXTURE_CUBE_MAP_POSITIVE_X+U:n.TEXTURE_2D,ie=p.depthTexture.format===Xi?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;if(p.depthTexture.format===mi)Pe(p)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,ie,Z,ue,0,pe):n.framebufferTexture2D(n.FRAMEBUFFER,ie,Z,ue,0);else if(p.depthTexture.format===Xi)Pe(p)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,ie,Z,ue,0,pe):n.framebufferTexture2D(n.FRAMEBUFFER,ie,Z,ue,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function W(T){const p=i.get(T),U=T.isWebGLCubeRenderTarget===!0;if(p.__boundDepthTexture!==T.depthTexture){const B=T.depthTexture;if(p.__depthDisposeCallback&&p.__depthDisposeCallback(),B){const q=()=>{delete p.__boundDepthTexture,delete p.__depthDisposeCallback,B.removeEventListener("dispose",q)};B.addEventListener("dispose",q),p.__depthDisposeCallback=q}p.__boundDepthTexture=B}if(T.depthTexture&&!p.__autoAllocateDepthBuffer)if(U)for(let B=0;B<6;B++)I(p.__webglFramebuffer[B],T,B);else{const B=T.texture.mipmaps;B&&B.length>0?I(p.__webglFramebuffer[0],T,0):I(p.__webglFramebuffer,T,0)}else if(U){p.__webglDepthbuffer=[];for(let B=0;B<6;B++)if(t.bindFramebuffer(n.FRAMEBUFFER,p.__webglFramebuffer[B]),p.__webglDepthbuffer[B]===void 0)p.__webglDepthbuffer[B]=n.createRenderbuffer(),P(p.__webglDepthbuffer[B],T,!1);else{const q=T.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ue=p.__webglDepthbuffer[B];n.bindRenderbuffer(n.RENDERBUFFER,ue),n.framebufferRenderbuffer(n.FRAMEBUFFER,q,n.RENDERBUFFER,ue)}}else{const B=T.texture.mipmaps;if(B&&B.length>0?t.bindFramebuffer(n.FRAMEBUFFER,p.__webglFramebuffer[0]):t.bindFramebuffer(n.FRAMEBUFFER,p.__webglFramebuffer),p.__webglDepthbuffer===void 0)p.__webglDepthbuffer=n.createRenderbuffer(),P(p.__webglDepthbuffer,T,!1);else{const q=T.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ue=p.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,ue),n.framebufferRenderbuffer(n.FRAMEBUFFER,q,n.RENDERBUFFER,ue)}}t.bindFramebuffer(n.FRAMEBUFFER,null)}function Q(T,p,U){const B=i.get(T);p!==void 0&&Ve(B.__webglFramebuffer,T,T.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),U!==void 0&&W(T)}function K(T){const p=T.texture,U=i.get(T),B=i.get(p);T.addEventListener("dispose",_);const q=T.textures,ue=T.isWebGLCubeRenderTarget===!0,pe=q.length>1;if(pe||(B.__webglTexture===void 0&&(B.__webglTexture=n.createTexture()),B.__version=p.version,a.memory.textures++),ue){U.__webglFramebuffer=[];for(let Z=0;Z<6;Z++)if(p.mipmaps&&p.mipmaps.length>0){U.__webglFramebuffer[Z]=[];for(let ie=0;ie<p.mipmaps.length;ie++)U.__webglFramebuffer[Z][ie]=n.createFramebuffer()}else U.__webglFramebuffer[Z]=n.createFramebuffer()}else{if(p.mipmaps&&p.mipmaps.length>0){U.__webglFramebuffer=[];for(let Z=0;Z<p.mipmaps.length;Z++)U.__webglFramebuffer[Z]=n.createFramebuffer()}else U.__webglFramebuffer=n.createFramebuffer();if(pe)for(let Z=0,ie=q.length;Z<ie;Z++){const he=i.get(q[Z]);he.__webglTexture===void 0&&(he.__webglTexture=n.createTexture(),a.memory.textures++)}if(T.samples>0&&Pe(T)===!1){U.__webglMultisampledFramebuffer=n.createFramebuffer(),U.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,U.__webglMultisampledFramebuffer);for(let Z=0;Z<q.length;Z++){const ie=q[Z];U.__webglColorRenderbuffer[Z]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,U.__webglColorRenderbuffer[Z]);const he=s.convert(ie.format,ie.colorSpace),Ie=s.convert(ie.type),Me=x(ie.internalFormat,he,Ie,ie.normalized,ie.colorSpace,T.isXRRenderTarget===!0),_e=j(T);n.renderbufferStorageMultisample(n.RENDERBUFFER,_e,Me,T.width,T.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Z,n.RENDERBUFFER,U.__webglColorRenderbuffer[Z])}n.bindRenderbuffer(n.RENDERBUFFER,null),T.depthBuffer&&(U.__webglDepthRenderbuffer=n.createRenderbuffer(),P(U.__webglDepthRenderbuffer,T,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(ue){t.bindTexture(n.TEXTURE_CUBE_MAP,B.__webglTexture),st(n.TEXTURE_CUBE_MAP,p);for(let Z=0;Z<6;Z++)if(p.mipmaps&&p.mipmaps.length>0)for(let ie=0;ie<p.mipmaps.length;ie++)Ve(U.__webglFramebuffer[Z][ie],T,p,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ie);else Ve(U.__webglFramebuffer[Z],T,p,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0);h(p)&&y(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(pe){for(let Z=0,ie=q.length;Z<ie;Z++){const he=q[Z],Ie=i.get(he);let Me=n.TEXTURE_2D;(T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(Me=T.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(Me,Ie.__webglTexture),st(Me,he),Ve(U.__webglFramebuffer,T,he,n.COLOR_ATTACHMENT0+Z,Me,0),h(he)&&y(Me)}t.unbindTexture()}else{let Z=n.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(Z=T.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(Z,B.__webglTexture),st(Z,p),p.mipmaps&&p.mipmaps.length>0)for(let ie=0;ie<p.mipmaps.length;ie++)Ve(U.__webglFramebuffer[ie],T,p,n.COLOR_ATTACHMENT0,Z,ie);else Ve(U.__webglFramebuffer,T,p,n.COLOR_ATTACHMENT0,Z,0);h(p)&&y(Z),t.unbindTexture()}T.depthBuffer&&W(T)}function ee(T){const p=T.textures;for(let U=0,B=p.length;U<B;U++){const q=p[U];if(h(q)){const ue=E(T),pe=i.get(q).__webglTexture;t.bindTexture(ue,pe),y(ue),t.unbindTexture()}}}const de=[],ce=[];function oe(T){if(T.samples>0){if(Pe(T)===!1){const p=T.textures,U=T.width,B=T.height;let q=n.COLOR_BUFFER_BIT;const ue=T.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,pe=i.get(T),Z=p.length>1;if(Z)for(let he=0;he<p.length;he++)t.bindFramebuffer(n.FRAMEBUFFER,pe.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+he,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,pe.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+he,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,pe.__webglMultisampledFramebuffer);const ie=T.texture.mipmaps;ie&&ie.length>0?t.bindFramebuffer(n.DRAW_FRAMEBUFFER,pe.__webglFramebuffer[0]):t.bindFramebuffer(n.DRAW_FRAMEBUFFER,pe.__webglFramebuffer);for(let he=0;he<p.length;he++){if(T.resolveDepthBuffer&&(T.depthBuffer&&(q|=n.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&(q|=n.STENCIL_BUFFER_BIT)),Z){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,pe.__webglColorRenderbuffer[he]);const Ie=i.get(p[he]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,Ie,0)}n.blitFramebuffer(0,0,U,B,0,0,U,B,q,n.NEAREST),l===!0&&(de.length=0,ce.length=0,de.push(n.COLOR_ATTACHMENT0+he),T.depthBuffer&&T.resolveDepthBuffer===!1&&(de.push(ue),ce.push(ue),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,ce)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,de))}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),Z)for(let he=0;he<p.length;he++){t.bindFramebuffer(n.FRAMEBUFFER,pe.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+he,n.RENDERBUFFER,pe.__webglColorRenderbuffer[he]);const Ie=i.get(p[he]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,pe.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+he,n.TEXTURE_2D,Ie,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,pe.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.resolveDepthBuffer===!1&&l){const p=T.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[p])}}}function j(T){return Math.min(r.maxSamples,T.samples)}function Pe(T){const p=i.get(T);return T.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&p.__useRenderToTexture!==!1}function R(T){const p=a.render.frame;u.get(T)!==p&&(u.set(T,p),T.update())}function De(T,p){const U=T.colorSpace,B=T.format,q=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||U!==ma&&U!==wi&&(tt.getTransfer(U)===ft?(B!==Mn||q!==dn)&&qe("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):ot("WebGLTextures: Unsupported texture color space:",U)),p}function ye(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(c.width=T.naturalWidth||T.width,c.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(c.width=T.displayWidth,c.height=T.displayHeight):(c.width=T.width,c.height=T.height),c}this.allocateTextureUnit=J,this.resetTextureUnits=te,this.getTextureUnits=se,this.setTextureUnits=V,this.setTexture2D=Y,this.setTexture2DArray=le,this.setTexture3D=ve,this.setTextureCube=xe,this.rebindTextures=Q,this.setupRenderTarget=K,this.updateRenderTargetMipmap=ee,this.updateMultisampleRenderTarget=oe,this.setupDepthRenderbuffer=W,this.setupFrameBufferTexture=Ve,this.useMultisampledRTT=Pe,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function bS(n,e){function t(i,r=wi){let s;const a=tt.getTransfer(r);if(i===dn)return n.UNSIGNED_BYTE;if(i===Ql)return n.UNSIGNED_SHORT_4_4_4_4;if(i===jl)return n.UNSIGNED_SHORT_5_5_5_1;if(i===gd)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===_d)return n.UNSIGNED_INT_10F_11F_11F_REV;if(i===pd)return n.BYTE;if(i===md)return n.SHORT;if(i===ls)return n.UNSIGNED_SHORT;if(i===Jl)return n.INT;if(i===Xn)return n.UNSIGNED_INT;if(i===Bn)return n.FLOAT;if(i===pi)return n.HALF_FLOAT;if(i===vd)return n.ALPHA;if(i===xd)return n.RGB;if(i===Mn)return n.RGBA;if(i===mi)return n.DEPTH_COMPONENT;if(i===Xi)return n.DEPTH_STENCIL;if(i===Sd)return n.RED;if(i===ec)return n.RED_INTEGER;if(i===Ji)return n.RG;if(i===tc)return n.RG_INTEGER;if(i===nc)return n.RGBA_INTEGER;if(i===js||i===ea||i===ta||i===na)if(a===ft)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===js)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===ea)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===ta)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===na)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===js)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===ea)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===ta)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===na)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===jo||i===el||i===tl||i===nl)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===jo)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===el)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===tl)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===nl)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===il||i===rl||i===sl||i===al||i===ol||i===ha||i===ll)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===il||i===rl)return a===ft?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===sl)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(i===al)return s.COMPRESSED_R11_EAC;if(i===ol)return s.COMPRESSED_SIGNED_R11_EAC;if(i===ha)return s.COMPRESSED_RG11_EAC;if(i===ll)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===cl||i===ul||i===fl||i===dl||i===hl||i===pl||i===ml||i===gl||i===_l||i===vl||i===xl||i===Sl||i===Ml||i===bl)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===cl)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===ul)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===fl)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===dl)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===hl)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===pl)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===ml)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===gl)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===_l)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===vl)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===xl)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Sl)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Ml)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===bl)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===yl||i===El||i===Tl)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===yl)return a===ft?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===El)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Tl)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===Al||i===wl||i===pa||i===Rl)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===Al)return s.COMPRESSED_RED_RGTC1_EXT;if(i===wl)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===pa)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Rl)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===cs?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:t}}const yS=`
void main() {
...
void main() {
    ...
    `}),u=new qn(l,c);s.add(u);const d=()=>{if(!e.value||!t)return;const{clientWidth:v,clientHeight:b}=e.value;a.aspect=v/b,a.updateProjectionMatrix(),t.setSize(v,b,!1)},f=v=>{if(!e.value)return;const b=e.value.getBoundingClientRect();o.uPointer.value.set(((v.clientX-b.left)/b.width-.5)*2,-((v.clientY-b.top)/b.height-.5)*2)},m=v=>{o.uTime.value=v*.001,u.rotation.y=v*12e-5,u.rotation.x=Math.sin(v*25e-5)*.12,t==null||t.render(s,a),i=requestAnimationFrame(m)};d(),window.addEventListener("resize",d),e.value.addEventListener("pointermove",f),i=requestAnimationFrame(m),r=()=>{var v;cancelAnimationFrame(i),window.removeEventListener("resize",d),(v=e.value)==null||v.removeEventListener("pointermove",f),l.dispose(),c.dispose(),t==null||t.dispose(),t==null||t.domElement.remove(),t=null}}),Lf(()=>r==null?void 0:r()),(s,a)=>(ge(),Te("section",LS,[D("div",US,[a[1]||(a[1]=Lr('<div class="hero-content fade-in-up" data-v-50e234d5><h1 data-v-50e234d5>Hi, I&#39;m Behzad Kazemi</h1><p class="subtitle" data-v-50e234d5>Frontend Developer | Software Engineer</p><p class="description" data-v-50e234d5> I build beautiful and functional web applications using modern technologies like Vue.js, React, and TypeScript. Based in Berlin 🇩🇪, I&#39;m passionate about creating seamless user experiences and clean code. </p><div class="hero-buttons" data-v-50e234d5><a href="#contact" class="btn-primary" data-v-50e234d5>Get In Touch</a><a href="https://github.com/behzadkazemi" target="_blank" rel="noopener noreferrer" class="btn-secondary" data-v-50e234d5> View My Work </a></div></div>',1)),D("div",NS,[D("div",{ref_key:"sceneHost",ref:e,class:"liquid-scene","aria-hidden":"true"},null,512),a[0]||(a[0]=D("div",{class:"scene-caption"},"Creative systems / Berlin",-1))])])]))}}),OS=Zt(FS,[["__scopeId","data-v-50e234d5"]]),BS={},zS={class:"about",id:"about"};function kS(n,e){return ge(),Te("section",zS,[...e[0]||(e[0]=[Lr('<div class="container" data-v-0ace5747><div class="section-title" data-v-0ace5747><h2 data-v-0ace5747>About Me</h2></div><div class="about-content grid grid-2" data-v-0ace5747><div class="about-text fade-in-up" data-v-0ace5747><p data-v-0ace5747> I&#39;m a Software Engineer with a Master&#39;s degree in IT, based in Berlin with a passion for building elegant digital solutions. Beyond coding, I&#39;m also a professional badminton player and a passionate santoor musician, which keeps me creative and focused. </p><p data-v-0ace5747> At <strong data-v-0ace5747>a&amp;o Hostels</strong>, I&#39;m working as a Frontend Developer, creating responsive and intuitive web interfaces. Previously, I contributed to innovative projects at <strong data-v-0ace5747>Avodaq</strong> and gained diverse experience at <strong data-v-0ace5747>Teleperformance</strong>. </p><p data-v-0ace5747> I thrive in collaborative environments, constantly learning new technologies and pushing the boundaries of what&#39;s possible with modern web technologies. My goal is to create meaningful digital experiences that make a difference. </p><div class="quick-facts" data-v-0ace5747><div class="fact" data-v-0ace5747><span class="fact-label" data-v-0ace5747>Location</span><span class="fact-value" data-v-0ace5747>Berlin, Germany 🇩🇪</span></div><div class="fact" data-v-0ace5747><span class="fact-label" data-v-0ace5747>Current Role</span><span class="fact-value" data-v-0ace5747>Frontend Developer at a&amp;o Hostels</span></div><div class="fact" data-v-0ace5747><span class="fact-label" data-v-0ace5747>Education</span><span class="fact-value" data-v-0ace5747>Master&#39;s in IT</span></div><div class="fact" data-v-0ace5747><span class="fact-label" data-v-0ace5747>Interests</span><span class="fact-value" data-v-0ace5747>Web Dev, Badminton, Music 🎵</span></div></div></div><div class="about-stats fade-in-up" data-v-0ace5747><div class="stat-card" data-v-0ace5747><div class="stat-number" data-v-0ace5747>5+</div><div class="stat-label" data-v-0ace5747>Years of Experience</div><p data-v-0ace5747>Building modern web applications with cutting-edge technologies</p></div><div class="stat-card" data-v-0ace5747><div class="stat-number" data-v-0ace5747>10+</div><div class="stat-label" data-v-0ace5747>Projects Completed</div><p data-v-0ace5747>From startups to established companies, diverse and impactful work</p></div><div class="stat-card" data-v-0ace5747><div class="stat-number" data-v-0ace5747>500+</div><div class="stat-label" data-v-0ace5747>Professional Network</div><p data-v-0ace5747>Connected with talented professionals and tech enthusiasts</p></div></div></div></div>',1)])])}const HS=Zt(BS,[["render",kS],["__scopeId","data-v-0ace5747"]]),VS={class:"skills",id:"skills"},GS={class:"container"},WS={class:"skills-grid"},XS={class:"category-title"},qS={class:"skills-list"},$S=ln({__name:"Skills",setup(n){const e=et([{name:"Frontend Frameworks",skills:["Vue.js","React","AngularJS","Vite","Next.js"]},{name:"Languages",skills:["JavaScript","TypeScript","HTML5","CSS3","Python"]},{name:"Styling",skills:["Tailwind CSS","SCSS/SASS","CSS Modules","Styled Components","Bootstrap"]},{name:"Tools & Platforms",skills:["Git","GitHub","npm","Yarn","Docker","Linux"]},{name:"Development",skills:["REST APIs","Web Components","Responsive Design","Performance Optimization","Testing"]},{name:"Other Skills",skills:["Problem Solving","Team Collaboration","Communication","Learning Mindset","Agile/Scrum"]}]);return(t,i)=>(ge(),Te("section",VS,[D("div",GS,[i[0]||(i[0]=D("div",{class:"section-title"},[D("h2",null,"Skills & Technologies")],-1)),D("div",WS,[(ge(!0),Te(_t,null,Ht(e.value,(r,s)=>(ge(),Te("div",{class:"skill-category fade-in-up",key:s,style:Ii({animationDelay:`${s*.1}s`})},[D("h3",XS,Fe(r.name),1),D("div",qS,[(ge(!0),Te(_t,null,Ht(r.skills,a=>(ge(),Te("span",{class:"skill-badge",key:a},Fe(a),1))),128))])],4))),128))])])]))}}),YS=Zt($S,[["__scopeId","data-v-936a22af"]]),KS={class:"experience",id:"experience"},ZS={class:"container"},JS={class:"timeline"},QS={class:"timeline-content"},jS={class:"job-header"},eM={class:"job-title"},tM={class:"company"},nM={class:"job-period"},iM={class:"period"},rM={class:"duration"},sM={class:"job-location"},aM={class:"job-description"},oM={class:"job-tags"},lM=ln({__name:"Experience",setup(n){const e=et([{title:"Frontend Developer",company:"a&o Hostels",period:"Oct 2025 – Present",duration:"11 months",location:"Berlin, Deutschland",type:"Hybrid",description:["Develop responsive and user-friendly frontend interfaces for the a&o Hostels web platform","Collaborate with cross-functional teams to translate design requirements into functional code","Optimize application performance and ensure compatibility across browsers and devices"],technologies:["Vue.js","TypeScript","CSS3","REST APIs"]},{title:"Software Developer (Frontend)",company:"Avodaq AG",period:"Jan 2024 – Sept 2025",duration:"1 year 9 months",location:"Berlin, Deutschland",type:"Remote",description:["Developed and innovated an internal portal for customers, enhancing functionality and usability","Built responsive components using modern frontend technologies","Improved application performance and user experience through optimization techniques","Participated in code reviews and maintained high code quality standards"],technologies:["React","TypeScript","JavaScript","SCSS","API Integration"]},{title:"Web Content Developer",company:"Teleperformance",period:"Dec 2022 – Jan 2024",duration:"1 year 2 months",location:"Berlin, Deutschland",type:"On-site",description:["Supported team in analyzing data and web content","Gained foundational experience in web development and content management","First professional role in Germany, building strong technical foundation"],technologies:["HTML","CSS","JavaScript","Web Analysis"]}]);return(t,i)=>(ge(),Te("section",KS,[D("div",ZS,[i[1]||(i[1]=D("div",{class:"section-title"},[D("h2",null,"Work Experience")],-1)),D("div",JS,[(ge(!0),Te(_t,null,Ht(e.value,(r,s)=>(ge(),Te("div",{class:"timeline-item fade-in-up",key:s,style:Ii({animationDelay:`${s*.15}s`})},[i[0]||(i[0]=D("div",{class:"timeline-marker"},null,-1)),D("div",QS,[D("div",jS,[D("div",eM,[D("h3",null,Fe(r.title),1),D("p",tM,Fe(r.company),1)]),D("div",nM,[D("span",iM,Fe(r.period),1),D("span",rM,Fe(r.duration),1)])]),D("p",sM,"📍 "+Fe(r.location)+" · "+Fe(r.type),1),D("div",aM,[(ge(!0),Te(_t,null,Ht(r.description,(a,o)=>(ge(),Te("p",{key:o},Fe(a),1))),128))]),D("div",oM,[(ge(!0),Te(_t,null,Ht(r.technologies,a=>(ge(),Te("span",{class:"tag",key:a},Fe(a),1))),128))])])],4))),128))])])]))}}),cM=Zt(lM,[["__scopeId","data-v-ef1012e9"]]),uM=["src","alt"],fM={key:1},dM={class:"preview-label"},hM=ln({__name:"LiquidPreview",props:{title:{},index:{},characters:{}},setup(n){var o;const e=n,t=et(null),i=et([{id:1,baseX:16,baseY:26,size:44,palette:1,offsetX:0,offsetY:0,scale:1},{id:2,baseX:38,baseY:66,size:30,palette:2,offsetX:0,offsetY:0,scale:1},{id:3,baseX:58,baseY:27,size:62,palette:3,offsetX:0,offsetY:0,scale:1},{id:4,baseX:78,baseY:67,size:39,palette:4,offsetX:0,offsetY:0,scale:1},{id:5,baseX:87,baseY:24,size:24,palette:5,offsetX:0,offsetY:0,scale:1},{id:6,baseX:25,baseY:82,size:20,palette:3,offsetX:0,offsetY:0,scale:1},{id:7,baseX:67,baseY:79,size:25,palette:1,offsetX:0,offsetY:0,scale:1}]);(o=e.characters)!=null&&o.length&&i.value.forEach(l=>{l.character=e.characters[Math.floor(Math.random()*e.characters.length)]});const r=l=>({left:`${l.baseX+l.offsetX}%`,top:`${l.baseY+l.offsetY}%`,width:`${l.size}px`,height:`${l.size}px`,transform:`translate(-50%, -50%) scale(${l.scale})`}),s=l=>{if(!t.value)return;const c=t.value.getBoundingClientRect(),u=(l.clientX-c.left)/c.width*100,d=(l.clientY-c.top)/c.height*100;i.value.forEach(f=>{const m=f.baseX-u,v=f.baseY-d,b=Math.sqrt(m**2+v**2),g=Math.max(0,1-b/28);if(g>0){const h=m||-1,y=v||-1,E=Math.sqrt(h**2+y**2);f.offsetX=h/E*g*18,f.offsetY=y/E*g*18,f.scale=1+g*.18}else f.offsetX=0,f.offsetY=0,f.scale=1})},a=()=>{i.value.forEach(l=>{l.offsetX=0,l.offsetY=0,l.scale=1})};return(l,c)=>(ge(),Te("div",{ref_key:"preview",ref:t,class:"liquid-preview","aria-hidden":"true",onPointermove:s,onPointerleave:a},[c[1]||(c[1]=D("div",{class:"liquid-grid"},null,-1)),(ge(!0),Te(_t,null,Ht(i.value,u=>(ge(),Te("div",{key:u.id,class:sn(["liquid-bubble",`bubble-${u.palette}`]),style:Ii(r(u))},[c[0]||(c[0]=D("span",null,null,-1)),u.character?(ge(),Te("img",{key:0,src:u.character.image,alt:`${u.character.name} portrait`},null,8,uM)):Wt("",!0),u.character?(ge(),Te("strong",fM,Fe(u.character.name),1)):Wt("",!0)],6))),128)),D("div",dM,Fe(n.title),1)],544))}}),pM=Zt(hM,[["__scopeId","data-v-a4bb72d0"]]),mM={class:"projects",id:"projects"},gM={class:"container"},_M={class:"projects-grid"},vM={class:"project-image"},xM={class:"project-content"},SM={class:"project-description"},MM={class:"project-tech"},bM={class:"project-links"},yM=["href"],EM=["href","target","rel"],TM=ln({__name:"Projects",setup(n){const e=r=>/^https?:\/\//.test(r),i=et([{title:"BMI Calculator",description:"Interactive Body Mass Index calculator. Enter weight and height to get your BMI and category, then use the live demo without leaving this site.",icon:"⚖️",technologies:["React","TypeScript","Tailwind CSS","Vite"],github:"https://github.com/behzadkazemi/BMI-Calculator",live:"/bmi-calculator/"},{title:"Weather App",description:"A weather application for checking current conditions and forecasts through a focused, responsive interface.",icon:"☁️",technologies:["JavaScript","Weather API","CSS3"],github:"https://github.com/behzadkazemi/WeatherApp",live:"/weather-app/"},{title:"Ito-Ito Code Challenge",description:"A coding challenge project demonstrating practical frontend problem-solving and interactive user interface work.",icon:"🧩",technologies:["JavaScript","HTML5","CSS3"],github:"https://github.com/behzadkazemi/behzad-itoito-code-challengee",live:"/ito-ito-challenge/"},{title:"Color Challenge",description:"An interactive color-based challenge built around quick decisions, visual feedback, and playful browser interactions.",icon:"🎨",technologies:["JavaScript","HTML5","CSS3"],github:"https://github.com/behzadkazemi/Color-Challenge",live:"https://behzadkazemi.github.io/Color-Challenge/"},{title:"Income Tracker",description:"A practical browser tool for recording income and keeping personal financial information organized.",icon:"📈",technologies:["JavaScript","HTML5","CSS3"],github:"https://github.com/behzadkazemi/IncomeTracker",live:"https://behzadkazemi.github.io/IncomeTracker/"},{title:"Queen Burger",description:"A restaurant website concept with an engaging menu experience and responsive presentation for burger lovers.",icon:"🍔",technologies:["JavaScript","HTML5","CSS3"],github:"https://github.com/behzadkazemi/queenBurger",live:"https://behzadkazemi.github.io/queenBurger/"},{title:"Berlin Budget Secrets",description:"A city-focused project exploring useful budget ideas and accessible information for life in Berlin.",icon:"🏙️",technologies:["JavaScript","HTML5","CSS3"],github:"https://github.com/behzadkazemi/BerlinBudgetSecrets",live:"https://behzadkazemi.github.io/BerlinBudgetSecrets/"},{title:"MultiLanguage Form",description:"A multilingual form experience designed to make data entry clearer and more accessible across languages.",icon:"🌍",technologies:["JavaScript","HTML5","CSS3"],github:"https://github.com/behzadkazemi/MultiLanguage-From",live:"https://behzadkazemi.github.io/MultiLanguage-From/"},{title:"To-Do List",description:"A simple task management application for adding, organizing, and completing everyday tasks.",icon:"✅",technologies:["JavaScript","HTML5","CSS3"],github:"https://github.com/behzadkazemi/to-do-list",live:"https://behzadkazemi.github.io/to-do-list/"},{title:"Game of Thrones",description:"A themed project inspired by Game of Thrones, showcasing content presentation and interactive frontend work.",icon:"🐉",technologies:["JavaScript","HTML5","CSS3"],github:"https://github.com/behzadkazemi/GOT",live:"/game-of-thrones/"},{title:"Harry Potter",description:"A themed Harry Potter project demonstrating creative interface design and responsive web presentation.",icon:"⚡",technologies:["JavaScript","HTML5","CSS3"],github:"https://github.com/behzadkazemi/HarryPotter",live:"/harry-potter/",previewCharacters:[{name:"Harry Potter",image:"https://ik.imagekit.io/hpapi/harry.jpg"},{name:"Hermione Granger",image:"https://ik.imagekit.io/hpapi/hermione.jpeg"},{name:"Draco Malfoy",image:"https://ik.imagekit.io/hpapi/draco.jpg"},{name:"Luna Lovegood",image:"https://ik.imagekit.io/hpapi/luna.jpg"},{name:"Cedric Diggory",image:"https://ik.imagekit.io/hpapi/cedric.png"}]},{title:"Ext JS Training",description:"Training work exploring Ext JS components, layouts, and application patterns.",icon:"🛠️",technologies:["Ext JS","JavaScript","HTML5"],github:"https://github.com/behzadkazemi/ExtJsTraining",live:"https://behzadkazemi.github.io/ExtJsTraining/"},{title:"Question Answering Tool",description:"A question-and-answer interface focused on presenting information through a clear and direct workflow.",icon:"❓",technologies:["JavaScript","HTML5","CSS3"],github:"https://github.com/behzadkazemi/Question-Answering-Tool",live:"https://behzadkazemi.github.io/Question-Answering-Tool/"},{title:"Random Movie Adviser",description:"A lightweight movie discovery tool that suggests a random film for the next viewing session.",icon:"🎬",technologies:["JavaScript","HTML5","CSS3"],github:"https://github.com/behzadkazemi/Random-movie-adviser",live:"/random-movie-adviser/"},{title:"IMDb Top 250",description:"A movie browsing project presenting titles from IMDb's highly rated Top 250 collection.",icon:"🏆",technologies:["JavaScript","HTML5","CSS3"],github:"https://github.com/behzadkazemi/imdb-top-250",live:"/imdb-top-250/"},{title:"Personal Portfolio",description:"A modern, responsive portfolio website built with Vue 3 and TypeScript. Showcases projects, skills, and experience with a smooth, animated user interface.",icon:"💼",technologies:["Vue 3","TypeScript","Vite","CSS3"],github:"https://github.com/behzadkazemi/behzadkazemi.github.io",live:"https://behzadkazemi.github.io"},{title:"a&o Hostels Portal",description:"Internal customer portal featuring responsive design and enhanced functionality. Built with modern web technologies to improve user experience and performance.",icon:"🏨",technologies:["Vue.js","TypeScript","REST API","SCSS"],github:"",live:""},{title:"Avodaq Internal Portal",description:"Innovative internal portal for a software development company, featuring complex data visualization and real-time updates. Optimized for performance and usability.",icon:"⚙️",technologies:["React","TypeScript","Redux","API Integration"],github:"",live:""},{title:"Web Development Projects",description:"Collection of web projects demonstrating proficiency in HTML5, CSS3, and JavaScript. Includes responsive design implementations and interactive features.",icon:"🌐",technologies:["HTML5","CSS3","JavaScript","Responsive Design"],github:"https://github.com/behzadkazemi",live:""}]);return(r,s)=>(ge(),Te("section",mM,[D("div",gM,[s[2]||(s[2]=D("div",{class:"section-title"},[D("h2",null,"Featured Projects")],-1)),D("div",_M,[(ge(!0),Te(_t,null,Ht(i.value,(a,o)=>(ge(),Te("div",{class:"project-card fade-in-up",key:o,style:Ii({animationDelay:`${o*.15}s`})},[D("div",vM,[Pt(pM,{title:a.title,index:o,characters:a.previewCharacters},null,8,["title","index","characters"])]),D("div",xM,[D("h3",null,Fe(a.title),1),D("p",SM,Fe(a.description),1),D("div",MM,[(ge(!0),Te(_t,null,Ht(a.technologies,l=>(ge(),Te("span",{class:"tech-badge",key:l},Fe(l),1))),128))]),D("div",bM,[a.github?(ge(),Te("a",{key:0,href:a.github,target:"_blank",rel:"noopener noreferrer",class:"project-link"},[...s[0]||(s[0]=[D("svg",{class:"icon",viewBox:"0 0 24 24",fill:"currentColor"},[D("path",{d:"M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"})],-1),pn(" Code ",-1)])],8,yM)):Wt("",!0),a.live?(ge(),Te("a",{key:1,href:a.live,target:e(a.live)?"_blank":void 0,rel:e(a.live)?"noopener noreferrer":void 0,class:"project-link live"},[...s[1]||(s[1]=[D("svg",{class:"icon",viewBox:"0 0 24 24",fill:"currentColor"},[D("path",{d:"M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"})],-1),pn(" Live ",-1)])],8,EM)):Wt("",!0)])])],4))),128))]),s[3]||(s[3]=D("div",{class:"more-projects"},[D("p",null,[pn("Interested in more? Check out my "),D("a",{href:"https://github.com/behzadkazemi",target:"_blank",rel:"noopener noreferrer"},"GitHub profile"),pn(" for additional projects.")])],-1))])]))}}),AM=Zt(TM,[["__scopeId","data-v-f81f6d20"]]),wM={class:"contact",id:"contact"},RM={class:"container"},CM={class:"contact-content"},PM={class:"contact-form fade-in-up"},DM={class:"form-group"},IM={class:"form-group"},LM={class:"form-group"},UM={class:"form-group"},NM=ln({__name:"Contact",setup(n){const e=et({name:"",email:"",subject:"",message:""}),t=et(null),i=async()=>{try{console.log("Form submitted:",e.value),t.value={type:"success",message:"Message sent successfully! I'll get back to you soon."},e.value={name:"",email:"",subject:"",message:""},setTimeout(()=>{t.value=null},5e3)}catch{t.value={type:"error",message:"Failed to send message. Please try again or email me directly."}}};return(r,s)=>(ge(),Te("section",wM,[D("div",RM,[s[10]||(s[10]=D("div",{class:"section-title"},[D("h2",null,"Get In Touch")],-1)),D("div",CM,[s[9]||(s[9]=Lr('<div class="contact-text fade-in-up" data-v-efac7281><p data-v-efac7281> I&#39;m always interested in hearing about new opportunities and collaborative projects. Whether you&#39;d like to discuss a potential project, have a question, or just want to say hello, feel free to reach out! </p><p data-v-efac7281> I&#39;ll do my best to respond as quickly as possible. </p><div class="contact-methods" style="background-color:rgba(13, 29, 22, 0.86);" data-v-efac7281><div class="contact-method" data-v-efac7281><div class="method-icon" data-v-efac7281>✉️</div><div class="method-info" data-v-efac7281><h4 data-v-efac7281>Email</h4><a href="mailto:bkazemi1994@gmail.com" data-v-efac7281>bkazemi1994@gmail.com</a></div></div><div class="contact-method" data-v-efac7281><div class="method-icon" data-v-efac7281>💼</div><div class="method-info" data-v-efac7281><h4 data-v-efac7281>LinkedIn</h4><a href="https://linkedin.com/in/behzadkazemi" target="_blank" rel="noopener noreferrer" data-v-efac7281>linkedin.com/in/behzadkazemi</a></div></div><div class="contact-method" data-v-efac7281><div class="method-icon" data-v-efac7281>💻</div><div class="method-info" data-v-efac7281><h4 data-v-efac7281>GitHub</h4><a href="https://github.com/behzadkazemi" target="_blank" rel="noopener noreferrer" data-v-efac7281>github.com/behzadkazemi</a></div></div><div class="contact-method" data-v-efac7281><div class="method-icon" data-v-efac7281>📍</div><div class="method-info" data-v-efac7281><h4 data-v-efac7281>Location</h4><p data-v-efac7281>Berlin, Germany 🇩🇪</p></div></div></div></div>',1)),D("div",PM,[D("form",{onSubmit:La(i,["prevent"])},[D("div",DM,[s[4]||(s[4]=D("label",{for:"name"},"Name",-1)),ai(D("input",{type:"text",id:"name","onUpdate:modelValue":s[0]||(s[0]=a=>e.value.name=a),required:"",placeholder:"Your name"},null,512),[[Ri,e.value.name]])]),D("div",IM,[s[5]||(s[5]=D("label",{for:"email"},"Email",-1)),ai(D("input",{type:"email",id:"email","onUpdate:modelValue":s[1]||(s[1]=a=>e.value.email=a),required:"",placeholder:"your@email.com"},null,512),[[Ri,e.value.email]])]),D("div",LM,[s[6]||(s[6]=D("label",{for:"subject"},"Subject",-1)),ai(D("input",{type:"text",id:"subject","onUpdate:modelValue":s[2]||(s[2]=a=>e.value.subject=a),required:"",placeholder:"Subject of your message"},null,512),[[Ri,e.value.subject]])]),D("div",UM,[s[7]||(s[7]=D("label",{for:"message"},"Message",-1)),ai(D("textarea",{id:"message","onUpdate:modelValue":s[3]||(s[3]=a=>e.value.message=a),required:"",placeholder:"Your message...",rows:"6"},null,512),[[Ri,e.value.message]])]),s[8]||(s[8]=D("button",{type:"submit",class:"btn-primary",style:{"background-color":"rgba(17, 39, 28, 0.9)"}},"Send Message",-1)),t.value?(ge(),Te("p",{key:0,class:sn(["form-status",t.value.type])},Fe(t.value.message),3)):Wt("",!0)],32)])])])]))}}),FM=Zt(NM,[["__scopeId","data-v-efac7281"]]),OM={},BM={class:"footer"};function zM(n,e){return ge(),Te("footer",BM,[...e[0]||(e[0]=[Lr('<div class="container footer-content" data-v-5d5b0fbf><div class="footer-section" data-v-5d5b0fbf><h3 data-v-5d5b0fbf>Behzad Kazemi</h3><p data-v-5d5b0fbf>Frontend Developer &amp; Software Engineer based in Berlin</p></div><div class="footer-section" data-v-5d5b0fbf><h4 data-v-5d5b0fbf>Quick Links</h4><ul data-v-5d5b0fbf><li data-v-5d5b0fbf><a href="#about" data-v-5d5b0fbf>About</a></li><li data-v-5d5b0fbf><a href="#skills" data-v-5d5b0fbf>Skills</a></li><li data-v-5d5b0fbf><a href="#experience" data-v-5d5b0fbf>Experience</a></li><li data-v-5d5b0fbf><a href="#projects" data-v-5d5b0fbf>Projects</a></li><li data-v-5d5b0fbf><a href="#contact" data-v-5d5b0fbf>Contact</a></li></ul></div><div class="footer-section" data-v-5d5b0fbf><h4 data-v-5d5b0fbf>Social</h4><div class="social-links" data-v-5d5b0fbf><a href="https://github.com/behzadkazemi" target="_blank" rel="noopener noreferrer" title="GitHub" data-v-5d5b0fbf><svg class="icon" viewBox="0 0 24 24" fill="currentColor" data-v-5d5b0fbf><path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z" data-v-5d5b0fbf></path></svg></a><a href="https://linkedin.com/in/behzadkazemi" target="_blank" rel="noopener noreferrer" title="LinkedIn" data-v-5d5b0fbf><svg class="icon" viewBox="0 0 24 24" fill="currentColor" data-v-5d5b0fbf><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.225 0z" data-v-5d5b0fbf></path></svg></a></div></div></div><div class="footer-bottom" data-v-5d5b0fbf><p data-v-5d5b0fbf>© 2026 Behzad Kazemi. All rights reserved. Built with Vue 3 + TypeScript.</p></div>',2)])])}const kM=Zt(OM,[["render",zM],["__scopeId","data-v-5d5b0fbf"]]),HM={class:"bmi-page"},VM={class:"container"},GM={class:"bmi-card fade-in-up"},WM={key:0,class:"error"},XM={class:"result-value"},qM={class:"result-status"},$M=ln({__name:"BmiCalculator",setup(n){const e=et(""),t=et(""),i=et(null),r=et(""),s=et(""),a=Ki(()=>r.value.toLowerCase().replace(/\s+/g,"-")),o=()=>{const c=parseFloat(e.value),u=parseFloat(t.value);if(!Number.isFinite(c)||!Number.isFinite(u)||c<=0||u<=0){s.value="Please enter a valid weight and height.",i.value=null,r.value="";return}const d=u/100,f=c/(d*d);s.value="",i.value=f,f<18.5?r.value="Underweight":f<24.9?r.value="Normal weight":f<29.9?r.value="Overweight":r.value="Obesity"},l=()=>{e.value="",t.value="",i.value=null,r.value="",s.value=""};return(c,u)=>(ge(),Te("section",HM,[D("div",VM,[u[10]||(u[10]=D("a",{class:"back-link",href:"/"},"← Back to portfolio",-1)),D("div",GM,[u[6]||(u[6]=D("p",{class:"eyebrow"},"Project demo",-1)),u[7]||(u[7]=D("h1",null,"BMI Calculator",-1)),u[8]||(u[8]=D("p",{class:"intro"},[pn(" Enter your weight and height to calculate Body Mass Index, using the same formula as my "),D("a",{href:"https://github.com/behzadkazemi/BMI-Calculator",target:"_blank",rel:"noopener noreferrer"},"BMI-Calculator"),pn(" repository. ")],-1)),D("form",{class:"bmi-form",onSubmit:La(o,["prevent"])},[D("label",null,[u[2]||(u[2]=pn(" Weight (kg) ",-1)),ai(D("input",{"onUpdate:modelValue":u[0]||(u[0]=d=>e.value=d),type:"number",min:"1",max:"400",step:"0.1",inputmode:"decimal",placeholder:"e.g. 70",required:""},null,512),[[Ri,e.value]])]),D("label",null,[u[3]||(u[3]=pn(" Height (cm) ",-1)),ai(D("input",{"onUpdate:modelValue":u[1]||(u[1]=d=>t.value=d),type:"number",min:"50",max:"250",step:"0.1",inputmode:"decimal",placeholder:"e.g. 175",required:""},null,512),[[Ri,t.value]])]),s.value?(ge(),Te("p",WM,Fe(s.value),1)):Wt("",!0),D("div",{class:"actions"},[u[4]||(u[4]=D("button",{type:"submit",class:"btn-primary"},"Calculate BMI",-1)),D("button",{type:"button",class:"btn-secondary",onClick:l},"Reset")])],32),i.value!==null?(ge(),Te("div",{key:0,class:sn(["result",a.value])},[u[5]||(u[5]=D("p",{class:"result-label"},"Your BMI is",-1)),D("p",XM,Fe(i.value.toFixed(1)),1),D("p",qM,Fe(r.value),1)],2)):Wt("",!0),u[9]||(u[9]=Lr('<ul class="legend" data-v-6625fd8e><li data-v-6625fd8e><span class="dot underweight" data-v-6625fd8e></span> Underweight: below 18.5</li><li data-v-6625fd8e><span class="dot normal" data-v-6625fd8e></span> Normal weight: 18.5 – 24.8</li><li data-v-6625fd8e><span class="dot overweight" data-v-6625fd8e></span> Overweight: 24.9 – 29.8</li><li data-v-6625fd8e><span class="dot obesity" data-v-6625fd8e></span> Obesity: 29.9 and above</li></ul><p class="disclaimer" data-v-6625fd8e> BMI is a screening estimate, not a medical diagnosis. Talk to a healthcare professional for personal advice. </p>',2))])])]))}}),YM=Zt($M,[["__scopeId","data-v-6625fd8e"]]),KM={class:"weather-page"},ZM={class:"weather-shell"},JM={class:"weather-card","aria-live":"polite"},QM={class:"search-row"},jM=["disabled"],eb={key:0,class:"message error"},tb={key:1,class:"message"},nb={key:2,class:"weather-result"},ib={class:"date"},rb={class:"weather-icon","aria-hidden":"true"},sb={class:"temperature"},ab={class:"condition"},ob={class:"details"},lb=ln({__name:"WeatherDemo",setup(n){const e=et("Berlin"),t=et(null),i=et(""),r=et(!1),s=Ki(()=>new Intl.DateTimeFormat("en-US",{month:"long",day:"numeric",year:"numeric"}).format(new Date)),a=Ki(()=>{var u,d;const c=(d=(u=t.value)==null?void 0:u.weather[0])==null?void 0:d.main;return c==="Clear"?"☀️":c==="Rain"?"🌧️":c==="Snow"?"❄️":c==="Haze"?"🌫️":"☁️"}),o=async()=>{var u;const c=e.value.trim();if(c){r.value=!0,i.value="";try{const d=await fetch(`https://geocoding-api.open-meteo.com/v1/search?name=${encodeURIComponent(c)}&count=1&language=en&format=json`),f=await d.json();if(!d.ok||!((u=f.results)!=null&&u.length))throw new Error("City not found. Try another city.");const m=f.results[0],v=await fetch(`https://api.open-meteo.com/v1/forecast?latitude=${m.latitude}&longitude=${m.longitude}&current=temperature_2m,relative_humidity_2m,apparent_temperature,weather_code&timezone=auto`),b=await v.json();if(!v.ok)throw new Error("Weather data is unavailable right now.");t.value={name:m.name,country:m.country_code,main:{temp:b.current.temperature_2m,feels_like:b.current.apparent_temperature,humidity:b.current.relative_humidity_2m},weather:[{main:l(b.current.weather_code)}]}}catch(d){t.value=null,i.value=d instanceof Error?d.message:"Unable to load weather right now."}finally{r.value=!1}}};Ca(o);const l=c=>c===0?"Clear":c<=3?"Clouds":c<=67||c>=80&&c<=82?"Rain":c<=77||c>=85?"Snow":"Haze";return(c,u)=>(ge(),Te("main",KM,[D("div",ZM,[u[5]||(u[5]=D("a",{class:"back-link",href:"/"},"← Back to portfolio",-1)),D("section",JM,[u[2]||(u[2]=D("p",{class:"eyebrow"},"Project demo",-1)),u[3]||(u[3]=D("h1",null,"Weather App",-1)),u[4]||(u[4]=D("p",{class:"intro"},[pn(" Search for a city to see its current weather, just like the original "),D("a",{href:"https://github.com/behzadkazemi/WeatherApp",target:"_blank",rel:"noopener noreferrer"},"React project"),pn(". ")],-1)),D("form",{class:"search-form",onSubmit:La(o,["prevent"])},[u[1]||(u[1]=D("label",{for:"city"},"City",-1)),D("div",QM,[ai(D("input",{id:"city","onUpdate:modelValue":u[0]||(u[0]=d=>e.value=d),type:"search",placeholder:"Enter city name",required:""},null,512),[[Ri,e.value]]),D("button",{type:"submit",disabled:r.value},Fe(r.value?"Searching...":"Search"),9,jM)])],32),i.value?(ge(),Te("p",eb,Fe(i.value),1)):r.value?(ge(),Te("p",tb,"Loading weather for "+Fe(e.value)+"...",1)):Wt("",!0),t.value?(ge(),Te("div",nb,[D("p",ib,Fe(s.value),1),D("h2",null,Fe(t.value.name)+", "+Fe(t.value.country),1),D("div",rb,Fe(a.value),1),D("p",sb,Fe(Math.round(t.value.main.temp))+"°C",1),D("p",ab,Fe(t.value.weather[0].main),1),D("div",ob,[D("span",null,"Feels like "+Fe(Math.round(t.value.main.feels_like))+"°C",1),D("span",null,"Humidity "+Fe(t.value.main.humidity)+"%",1)])])):Wt("",!0)])])]))}}),cb=Zt(lb,[["__scopeId","data-v-04551de3"]]),ub={class:"ito-page"},fb={class:"ito-shell"},db={class:"workspace"},hb={class:"patterns-panel"},pb={class:"panel-heading"},mb={key:0,class:"empty-state"},gb={class:"slot-label"},_b=["innerHTML"],vb=["viewBox"],xb=["x1","y1","x2","y2"],Sb=["x1","y1","x2","y2"],Mb=["cx","cy"],bb={key:2,class:"error-message"},yb={key:3,class:"hint"},Eb={class:"lines-panel"},Tb={class:"panel-heading compact"},Ab={class:"line-count"},wb={class:"controls"},Rb=["disabled"],Cb=["disabled"],Pb={key:0,class:"line-list"},Db={key:1,class:"no-lines"},Ib=ln({__name:"ItoItoDemo",setup(n){const e=et(null),t=et(null),i=et([]),r=et([]),s=et(null),a=et(null),o=et(""),l=et({width:1e3,height:600}),c=Ki(()=>!s.value||!a.value?null:{start:s.value,end:a.value}),u=async y=>{const E=y.target,x=Array.from(E.files||[]);if(x.length!==2){o.value="Please select exactly two SVG files.";return}i.value=await Promise.all(x.map(async A=>({name:A.name,content:await A.text()}))),r.value=[],s.value=null,a.value=null,o.value="",await yf(),d()},d=()=>{if(!t.value)return;const y=t.value.getBoundingClientRect();l.value={width:y.width,height:y.height}},f=y=>{if(!t.value)return null;const E=t.value.getBoundingClientRect();return{x:y.clientX-E.left,y:y.clientY-E.top}},m=y=>{const E=f(y);if(E){if(!s.value){s.value=E,a.value=E;return}r.value.push({start:s.value,end:E,color:y.button===2?"blue":"red"}),s.value=null,a.value=null}},v=y=>{s.value&&(a.value=f(y))},b=()=>{s.value=null,a.value=null},g=()=>r.value.pop(),h=()=>{r.value=[],b()};return(y,E)=>(ge(),Te("main",ub,[D("div",fb,[E[8]||(E[8]=D("a",{class:"back-link",href:"/"},"← Back to portfolio",-1)),E[9]||(E[9]=D("section",{class:"ito-header"},[D("div",null,[D("p",{class:"eyebrow"},"Project demo"),D("h1",null,"SVG Pattern Connector"),D("p",null,"Upload two SVG patterns, then connect matching points with colored lines.")]),D("a",{class:"source-link",href:"https://github.com/behzadkazemi/behzad-itoito-code-challengee",target:"_blank",rel:"noopener noreferrer"},"View React source")],-1)),D("section",db,[D("div",hb,[D("div",pb,[E[3]||(E[3]=D("div",null,[D("p",{class:"eyebrow"},"Pattern workspace"),D("h2",null,"Two SVG files")],-1)),D("button",{class:"upload-button",type:"button",onClick:E[0]||(E[0]=x=>{var A;return(A=e.value)==null?void 0:A.click()})},"Upload 2 SVGs"),D("input",{ref_key:"fileInput",ref:e,class:"file-input",type:"file",accept:".svg,image/svg+xml",multiple:"",onChange:u},null,544)]),i.value.length===0?(ge(),Te("div",mb,[E[4]||(E[4]=D("div",{class:"upload-mark"},"+",-1)),E[5]||(E[5]=D("h3",null,"Start with two patterns",-1)),E[6]||(E[6]=D("p",null,"Select exactly two SVG files to begin drawing connections.",-1)),D("button",{class:"primary-button",type:"button",onClick:E[1]||(E[1]=x=>{var A;return(A=e.value)==null?void 0:A.click()})},"Choose SVG files")])):(ge(),Te("div",{key:1,class:"svg-stage",ref_key:"stage",ref:t,onPointerdown:m,onPointermove:v,onPointerleave:b,onContextmenu:E[2]||(E[2]=La(()=>{},["prevent"]))},[(ge(!0),Te(_t,null,Ht(i.value,(x,A)=>(ge(),Te("div",{class:"svg-slot",key:x.name},[D("span",gb,Fe(A===0?"Pattern A":"Pattern B"),1),D("div",{class:"svg-content",innerHTML:x.content},null,8,_b)]))),128)),(ge(),Te("svg",{class:"line-layer",viewBox:`0 0 ${l.value.width} ${l.value.height}`,"aria-hidden":"true"},[(ge(!0),Te(_t,null,Ht(r.value,(x,A)=>(ge(),Te("line",{key:A,x1:x.start.x,y1:x.start.y,x2:x.end.x,y2:x.end.y,class:sn(x.color)},null,10,xb))),128)),c.value?(ge(),Te("line",{key:0,x1:c.value.start.x,y1:c.value.start.y,x2:c.value.end.x,y2:c.value.end.y,class:"preview"},null,8,Sb)):Wt("",!0),s.value?(ge(),Te("circle",{key:1,cx:s.value.x,cy:s.value.y,r:"7",class:"active-dot"},null,8,Mb)):Wt("",!0)],8,vb))],544)),o.value?(ge(),Te("p",bb,Fe(o.value),1)):i.value.length>0?(ge(),Te("p",yb,"Click a point on either pattern, then click a second point. Right-click creates a blue guide line.")):Wt("",!0)]),D("aside",Eb,[D("div",Tb,[E[7]||(E[7]=D("div",null,[D("p",{class:"eyebrow"},"Connections"),D("h2",null,"Defined lines")],-1)),D("span",Ab,Fe(r.value.length),1)]),D("div",wb,[D("button",{type:"button",class:"secondary-button",disabled:r.value.length===0,onClick:g},"Undo last",8,Rb),D("button",{type:"button",class:"danger-button",disabled:r.value.length===0,onClick:h},"Reset all",8,Cb)]),r.value.length?(ge(),Te("ol",Pb,[(ge(!0),Te(_t,null,Ht(r.value,(x,A)=>(ge(),Te("li",{key:A},[D("span",{class:sn(["line-swatch",x.color])},null,2),D("span",null,[pn("Line "+Fe(A+1),1),D("small",null,Fe(x.color==="red"?"Primary connection":"Guide connection"),1)])]))),128))])):(ge(),Te("p",Db,"No lines defined yet."))])])])]))}}),Lb=Zt(Ib,[["__scopeId","data-v-81dae0a8"]]),Ub=["aria-label","onClick"],Nb=["src","alt"],Fb=ln({__name:"WizardBubbleField",props:{characters:{}},emits:["select"],setup(n){const e=n,t=et(null),i=et([]);Ks(()=>e.characters,()=>{const a=e.characters.length?e.characters:[];i.value=Array.from({length:Math.max(1,a.length*2)},(o,l)=>({id:l,character:a[l%a.length],x:12+Math.random()*76,y:18+Math.random()*64,size:88+Math.random()*44,offsetX:0,offsetY:0,scale:1,depth:.86+Math.random()*.22}))},{immediate:!0});const s=a=>({left:`${a.x+a.offsetX}%`,top:`${a.y+a.offsetY}%`,width:`${a.size}px`,height:`${a.size}px`,zIndex:Math.round(a.depth*10),transform:`translate(-50%, -50%) scale(${a.scale})`,"--depth":a.depth});return(a,o)=>(ge(),Te("div",{ref_key:"field",ref:t,class:"wizard-field","aria-label":"Harry Potter character bubbles"},[(ge(!0),Te(_t,null,Ht(i.value,l=>(ge(),Te("button",{key:l.id,type:"button",class:"wizard-bubble",style:Ii(s(l)),"aria-label":`View details for ${l.character.name}`,onClick:c=>a.$emit("select",l.character)},[D("img",{src:l.character.image,alt:`${l.character.name} portrait`},null,8,Nb),D("span",null,Fe(l.character.name),1)],12,Ub))),128)),o[0]||(o[0]=D("p",{class:"field-caption"},"Move across the field. Choose a character.",-1))],512))}}),Ob=Zt(Fb,[["__scopeId","data-v-361d3746"]]),Bb={class:"media-shell"},zb={key:0,class:"media-card random-card"},kb=["src","alt"],Hb={class:"movie-details"},Vb={class:"rank"},Gb={class:"year"},Wb=["href"],Xb={key:1,class:"media-card imdb-card"},qb={class:"movie-list"},$b={class:"movie-rank"},Yb={key:0,class:"empty-message"},Kb={key:2,class:"media-card got-card"},Zb={class:"got-tabs"},Jb=["onClick"],Qb={key:0,class:"character-grid"},jb=["onClick"],ey=["src","alt"],ty={class:"character-copy"},ny={key:1,class:"quote-box"},iy={class:"quote-author"},ry={key:2,class:"character-detail"},sy=["src","alt"],ay={key:3,class:"media-card potter-card"},oy={class:"house-filter"},ly=["onClick"],cy={key:0,class:"wizard-detail"},uy=["src","alt"],fy=ln({__name:"MediaDemos",setup(n){const e=window.location.pathname.replace(/\/+$/,""),t=e.endsWith("/random-movie-adviser")?"random-movie":e.endsWith("/imdb-top-250")?"imdb":e.endsWith("/game-of-thrones")?"got":"harry-potter",i=[{title:"The Shawshank Redemption",year:1994,rank:1,imdbId:"tt0111161"},{title:"The Godfather",year:1972,rank:2,imdbId:"tt0068646"},{title:"The Dark Knight",year:2008,rank:3,imdbId:"tt0468569"},{title:"The Godfather Part II",year:1974,rank:4,imdbId:"tt0071562"},{title:"12 Angry Men",year:1957,rank:5,imdbId:"tt0050083"},{title:"Schindler's List",year:1993,rank:6,imdbId:"tt0108052"},{title:"The Lord of the Rings: The Return of the King",year:2003,rank:7,imdbId:"tt0167260"},{title:"Pulp Fiction",year:1994,rank:8,imdbId:"tt0110912"},{title:"The Good, the Bad and the Ugly",year:1966,rank:9,imdbId:"tt0060196"},{title:"The Lord of the Rings: The Fellowship of the Ring",year:2001,rank:10,imdbId:"tt0120737"}],r=et(null),s=et(""),a=Ki(()=>i.filter(A=>A.title.toLowerCase().includes(s.value.toLowerCase()))),o=()=>{r.value=i[Math.floor(Math.random()*i.length)]},l=A=>`https://images.metahub.space/poster/medium/${A.imdbId}/img`,c=A=>{A.target.style.visibility="hidden"},u=[{name:"Jon Snow",house:"House Stark",sigil:"ST",image:"https://upload.wikimedia.org/wikipedia/commons/5/56/Jon_Snow_White_cosplayer_%2835678959046%29.jpg",actor:"Kit Harington",region:"The North",status:"King in the North",description:"The reluctant hero of the North, raised at Winterfell and bound by duty."},{name:"Daenerys Targaryen",house:"House Targaryen",sigil:"TG",image:"https://upload.wikimedia.org/wikipedia/commons/5/56/Daenerys.jpg",actor:"Emilia Clarke",region:"Dragonstone",status:"Queen claimant",description:"The Dragon Queen, determined to reclaim the throne of Westeros."},{name:"Tyrion Lannister",house:"House Lannister",sigil:"LI",image:"https://ui-avatars.com/api/?name=Tyrion+Lannister&size=700&background=6b2737&color=fff&bold=true",actor:"Peter Dinklage",region:"The Westerlands",status:"Hand of the King",description:"A sharp-minded strategist whose wit is as formidable as any sword."},{name:"Arya Stark",house:"House Stark",sigil:"ST",image:"https://upload.wikimedia.org/wikipedia/commons/3/36/Arya_Stark_in_MultiVersus_1.png",actor:"Maisie Williams",region:"The North",status:"Faceless assassin",description:"A fiercely independent survivor trained to move unseen."}],d=et("Characters"),f=et(null),m=et({text:"Winter is coming.",author:"Ned Stark"}),v=[{text:"Winter is coming.",author:"Ned Stark"},{text:"A mind needs books as a sword needs a whetstone.",author:"Tyrion Lannister"},{text:"The things we do for love.",author:"Jaime Lannister"},{text:"Not today.",author:"Arya Stark"}],b=()=>{m.value=v[Math.floor(Math.random()*v.length)]},g=[{name:"Harry Potter",house:"Gryffindor",sigil:"HP",image:"https://ik.imagekit.io/hpapi/harry.jpg",role:"Auror",wand:"Holly, phoenix feather, 11 inches",patronus:"Stag",description:"The Boy Who Lived, known for courage, loyalty, and a talent for finding trouble."},{name:"Hermione Granger",house:"Gryffindor",sigil:"HG",image:"https://ik.imagekit.io/hpapi/hermione.jpeg",role:"Minister for Magic",wand:"Vine, dragon heartstring, 10¾ inches",patronus:"Otter",description:"A brilliant witch whose preparation and compassion repeatedly save the day."},{name:"Draco Malfoy",house:"Slytherin",sigil:"DM",image:"https://ik.imagekit.io/hpapi/draco.jpg",role:"Slytherin student",wand:"Hawthorn, unicorn hair, 10 inches",patronus:"Unknown",description:"A Slytherin student shaped by family expectations and difficult choices."},{name:"Luna Lovegood",house:"Ravenclaw",sigil:"LL",image:"https://ik.imagekit.io/hpapi/luna.jpg",role:"Magizoologist",wand:"Unknown",patronus:"Hare",description:"An original thinker with fierce loyalty and an unshakable sense of wonder."},{name:"Cedric Diggory",house:"Hufflepuff",sigil:"CD",image:"https://ik.imagekit.io/hpapi/cedric.png",role:"Triwizard champion",wand:"Ash, unicorn hair, 12¼ inches",patronus:"Unknown",description:"A fair-minded champion remembered for his generosity and integrity."}],h=["All","Gryffindor","Slytherin","Ravenclaw","Hufflepuff"],y=et("All"),E=et(null),x=Ki(()=>y.value==="All"?g:g.filter(A=>A.house===y.value));return(A,M)=>(ge(),Te("main",{class:sn(["media-page",si(t)])},[D("div",Bb,[M[33]||(M[33]=D("a",{class:"back-link",href:"/"},"← Back to portfolio",-1)),si(t)==="random-movie"?(ge(),Te("section",zb,[M[5]||(M[5]=D("p",{class:"eyebrow"},"Project demo / React original",-1)),M[6]||(M[6]=D("h1",null,"Random Movie Adviser",-1)),M[7]||(M[7]=D("p",{class:"lead"},"Need something good to watch? Roll the dice for a title from the IMDb Top 250.",-1)),D("div",{class:sn(["movie-pick",{empty:!r.value}])},[r.value?(ge(),Te(_t,{key:0},[D("img",{class:"movie-poster",src:l(r.value),alt:`${r.value.title} poster`,onError:c},null,40,kb),D("div",Hb,[D("p",Vb,"Rank #"+Fe(r.value.rank),1),D("h2",null,Fe(r.value.title),1),D("p",Gb,"Released "+Fe(r.value.year),1),M[2]||(M[2]=D("p",{class:"detail-copy"},"A highly rated classic selected from the IMDb Top 250 collection.",-1)),D("a",{class:"imdb-link",href:`https://www.imdb.com/title/${r.value.imdbId}/`,target:"_blank",rel:"noopener noreferrer"},"View IMDb details →",8,Wb)])],64)):(ge(),Te(_t,{key:1},[M[3]||(M[3]=D("div",{class:"empty-poster"},"?",-1)),M[4]||(M[4]=D("div",{class:"movie-details"},[D("p",{class:"rank"},"Ready when you are"),D("h2",null,"Your next movie"),D("p",{class:"year"},"A random recommendation awaits")],-1))],64))],2),D("button",{class:"primary-button dice-button",type:"button",onClick:o},"Roll the dice"),M[8]||(M[8]=D("a",{class:"source-link",href:"https://github.com/behzadkazemi/Random-movie-adviser",target:"_blank",rel:"noopener noreferrer"},"View source on GitHub",-1))])):si(t)==="imdb"?(ge(),Te("section",Xb,[M[9]||(M[9]=D("p",{class:"eyebrow"},"Project demo / movie data",-1)),M[10]||(M[10]=D("h1",null,"IMDb Top 250",-1)),M[11]||(M[11]=D("p",{class:"lead"},"Browse a curated slice of the world's most highly ranked films.",-1)),M[12]||(M[12]=D("label",{class:"search-label",for:"movie-search"},"Search titles",-1)),ai(D("input",{id:"movie-search","onUpdate:modelValue":M[0]||(M[0]=C=>s.value=C),type:"search",placeholder:"Try The Godfather"},null,512),[[Ri,s.value]]),D("ol",qb,[(ge(!0),Te(_t,null,Ht(a.value,C=>(ge(),Te("li",{key:C.rank},[D("span",$b,Fe(C.rank),1),D("span",null,[D("strong",null,Fe(C.title),1),D("small",null,Fe(C.year),1)])]))),128))]),a.value.length===0?(ge(),Te("p",Yb,"No matching titles.")):Wt("",!0),M[13]||(M[13]=D("a",{class:"source-link",href:"https://github.com/behzadkazemi/imdb-top-250",target:"_blank",rel:"noopener noreferrer"},"View source on GitHub",-1))])):si(t)==="got"?(ge(),Te("section",Kb,[M[20]||(M[20]=D("p",{class:"eyebrow"},"Project demo / Westeros archive",-1)),M[21]||(M[21]=D("h1",null,"Game of Thrones",-1)),M[22]||(M[22]=D("p",{class:"lead"},"Explore a small character archive and summon a quote from the Seven Kingdoms.",-1)),D("div",Zb,[(ge(),Te(_t,null,Ht(["Characters","Quote"],C=>D("button",{key:C,type:"button",class:sn({active:d.value===C}),onClick:_=>d.value=C},Fe(C),11,Jb)),64))]),d.value==="Characters"?(ge(),Te("div",Qb,[(ge(),Te(_t,null,Ht(u,C=>D("button",{key:C.name,type:"button",class:"character",onClick:_=>f.value=C},[D("img",{src:C.image,alt:`${C.name} portrait`},null,8,ey),D("span",ty,[D("strong",null,Fe(C.name),1),D("small",null,Fe(C.house),1)])],8,jb)),64))])):(ge(),Te("div",ny,[M[14]||(M[14]=D("p",{class:"quote-mark"},"“",-1)),D("blockquote",null,Fe(m.value.text),1),D("p",iy,Fe(m.value.author),1),D("button",{class:"primary-button",type:"button",onClick:b},"Fetch another quote")])),f.value&&d.value==="Characters"?(ge(),Te("div",ry,[D("img",{src:f.value.image,alt:`${f.value.name} portrait`},null,8,sy),D("div",null,[M[19]||(M[19]=D("span",{class:"eyebrow"},"Character profile",-1)),D("h2",null,Fe(f.value.name),1),D("p",null,Fe(f.value.description),1),D("dl",null,[D("div",null,[M[15]||(M[15]=D("dt",null,"House",-1)),D("dd",null,Fe(f.value.house),1)]),D("div",null,[M[16]||(M[16]=D("dt",null,"Played by",-1)),D("dd",null,Fe(f.value.actor),1)]),D("div",null,[M[17]||(M[17]=D("dt",null,"Region",-1)),D("dd",null,Fe(f.value.region),1)]),D("div",null,[M[18]||(M[18]=D("dt",null,"Status",-1)),D("dd",null,Fe(f.value.status),1)])])])])):Wt("",!0),M[23]||(M[23]=D("a",{class:"source-link",href:"https://github.com/behzadkazemi/GOT",target:"_blank",rel:"noopener noreferrer"},"View source on GitHub",-1))])):(ge(),Te("section",ay,[M[29]||(M[29]=D("p",{class:"eyebrow"},"Project demo / Ext JS original",-1)),M[30]||(M[30]=D("h1",null,"Harry Potter",-1)),M[31]||(M[31]=D("p",{class:"lead"},"Browse a compact character guide inspired by the original Ext JS training app.",-1)),D("div",oy,[(ge(),Te(_t,null,Ht(h,C=>D("button",{key:C,type:"button",class:sn({active:y.value===C}),onClick:_=>y.value=C},Fe(C),11,ly)),64))]),(ge(),Sr(Ob,{key:y.value,characters:x.value,onSelect:M[1]||(M[1]=C=>E.value=C)},null,8,["characters"])),E.value?(ge(),Te("div",cy,[D("img",{src:E.value.image,alt:`${E.value.name} portrait`},null,8,uy),D("div",null,[M[28]||(M[28]=D("span",{class:"eyebrow"},"Character profile",-1)),D("h2",null,Fe(E.value.name),1),D("p",null,Fe(E.value.description),1),D("dl",null,[D("div",null,[M[24]||(M[24]=D("dt",null,"House",-1)),D("dd",null,Fe(E.value.house),1)]),D("div",null,[M[25]||(M[25]=D("dt",null,"Role",-1)),D("dd",null,Fe(E.value.role),1)]),D("div",null,[M[26]||(M[26]=D("dt",null,"Wand",-1)),D("dd",null,Fe(E.value.wand),1)]),D("div",null,[M[27]||(M[27]=D("dt",null,"Patronus",-1)),D("dd",null,Fe(E.value.patronus),1)])])])])):Wt("",!0),M[32]||(M[32]=D("a",{class:"source-link",href:"https://github.com/behzadkazemi/HarryPotter",target:"_blank",rel:"noopener noreferrer"},"View source on GitHub",-1))]))])],2))}}),dy=Zt(fy,[["__scopeId","data-v-5489987d"]]),hy={key:4,id:"app",class:"app"},py=ln({__name:"App",setup(n){const e=window.location.pathname.replace(/\/+$/,""),t=e.endsWith("/bmi-calculator"),i=e.endsWith("/weather-app"),r=e.endsWith("/ito-ito-challenge"),s=["/random-movie-adviser","/imdb-top-250","/game-of-thrones","/harry-potter"].some(a=>e.endsWith(a));return(a,o)=>si(t)?(ge(),Sr(YM,{key:0})):si(i)?(ge(),Sr(cb,{key:1})):si(r)?(ge(),Sr(Lb,{key:2})):si(s)?(ge(),Sr(dy,{key:3})):(ge(),Te("div",hy,[Pt(xm),Pt(OS),Pt(HS),Pt(YS),Pt(cM),Pt(AM),Pt(FM),Pt(kM)]))}}),my=Zt(py,[["__scopeId","data-v-96ac2297"]]),gy=hm(my);gy.mount("#app");
